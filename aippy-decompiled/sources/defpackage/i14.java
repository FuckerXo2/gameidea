...
public final class i14 extends e14 implements ur3.d.c {
    public final h92 b;
    public final PrivateKey c;
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i14(@NotNull h92 state, @NotNull PrivateKey key, @NotNull String hashAlgorithmName) {
        super(key);
    ...
    public h signatureGenerator() {
        ...
        try {
            ...
            return mo1060signatureGenerator6q1zMKY(br.b.m749getBytesM1VWhS4(digestLength));
        } catch (Throwable th) {
            nj3VarMessageDigest.c(objA);
            throw th;
        }
    ...
    @Override // ur3.d.c
    @NotNull
    /* JADX INFO: renamed from: signatureGenerator-6q1zMKY, reason: not valid java name */
    public h mo1060signatureGenerator6q1zMKY(int i) {
        return new ma2(this.b, this.c, "RSASSA-PSS", new PSSParameterSpec(this.d, "MGF1", new MGF1ParameterSpec(this.d), br.m739getInBytesimpl(i), 1));
    }
}
