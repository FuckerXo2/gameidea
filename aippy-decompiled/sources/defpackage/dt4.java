...
public class dt4 {
    public static final pa1 f = new pa1();
    public final pa1 a;
    public final ct4 b;
    public final yd c;
    ...
    public dt4(List list, ct4 ct4Var, yd ydVar, ContentResolver contentResolver) {
        this(list, f, ct4Var, ydVar, contentResolver);
    }
    ...
    */
    private java.lang.String getPath(@androidx.annotation.NonNull android.net.Uri r7) throws java.lang.Throwable {
        /*
            ...
            r1 = 0
            ct4 r2 = r6.b     // Catch: java.lang.Throwable -> L25 java.lang.SecurityException -> L27
        ...
        L4f:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dt4.getPath(android.net.Uri):java.lang.String");
    }

    private boolean isValid(File file) {
        return this.a.exists(file) && 0 < this.a.length(file);
    }
    ...
    public int a(Uri uri) {
        ...
        try {
            try {
                ...
                int orientation = a.getOrientation((List<ImageHeaderParser>) this.e, inputStreamOpenInputStream, this.c);
    ...
    public dt4(List list, pa1 pa1Var, ct4 ct4Var, yd ydVar, ContentResolver contentResolver) {
        this.a = pa1Var;
        this.b = ct4Var;
        this.c = ydVar;
