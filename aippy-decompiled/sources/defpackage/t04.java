...
public final class t04 extends f14 {
    public final String c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public t04(@NotNull h92 state, @NotNull String hashAlgorithmName) {
        super(state);
    ...
    public ur3.b.c convert(PrivateKey privateKey) {
        Intrinsics.checkNotNullParameter(privateKey, "<this>");
        return new s04(c(), privateKey, this.c);
    }
