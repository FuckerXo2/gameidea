...
public final class y22 {
    ...
    public static final int[] c = {3, 31, TypedValues.AttributesType.TYPE_PATH_ROTATE, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE};
    ...
    public static int checkedAdd(int i, int i2) {
        ...
        int i3 = (int) j;
        dt2.a(j == ((long) i3), "checkedAdd", i, i2);
        return i3;
    }
    ...
    public static int checkedMultiply(int i, int i2) {
        long j = ((long) i) * ((long) i2);
        int i3 = (int) j;
        dt2.a(j == ((long) i3), "checkedMultiply", i, i2);
        return i3;
    }
    ...
    public static int checkedPow(int i, int i2) {
        ...
        while (i2 != 0) {
            ...
            i2 >>= 1;
            if (i2 > 0) {
                dt2.a((-46340 <= i) & (i <= 46340), "checkedPow", i, i2);
                i *= i;
            }
        }
    ...
    public static int checkedSubtract(int i, int i2) {
        long j = ((long) i) - ((long) i2);
        int i3 = (int) j;
        dt2.a(j == ((long) i3), "checkedSubtract", i, i2);
        return i3;
    }
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        ...
        switch (a.a[roundingMode.ordinal()]) {
            ...
            case 4:
            case 5:
                iA = a(iSqrtFloor * iSqrtFloor, i);
                break;
            case 6:
            case 7:
            case 8:
                iA = a((iSqrtFloor * iSqrtFloor) + iSqrtFloor, i);
                break;
            default:
                throw new AssertionError();
        }
