...
public interface mx1 extends IInterface {
    ...
    public static abstract class a extends Binder implements mx1 {
        ...
        /* JADX INFO: renamed from: mx1$a$a, reason: collision with other inner class name */
        public static class C0184a implements mx1 {
            public IBinder a;
        ...
        public static mx1 asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof mx1)) ? new C0184a(iBinder) : (mx1) iInterfaceQueryLocalInterface;
        }
