...
public final class q82 extends p92 implements AES.b.InterfaceC0123b {
    public final h92 b;
    ...
    public q82(@NotNull h92 state, @NotNull SecretKey key) {
        super(key);
    ...
    @Override // dev.whyoleg.cryptography.algorithms.AES.b.InterfaceC0123b
    @NotNull
    public AES.h cipher() {
        return new JdkAesIvCipher(this.b, this.c, 16, "AES/CTR/NoPadding");
    }
