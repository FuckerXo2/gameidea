...
public final class b14 extends f14 {
    public final String c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b14(@NotNull h92 state, @NotNull String hashAlgorithmName) {
        super(state);
    ...
    public ur3.c.InterfaceC0197c convert(PrivateKey privateKey) {
        Intrinsics.checkNotNullParameter(privateKey, "<this>");
        return new a14(c(), privateKey, this.c);
    }
