...
public final class z04 extends x92 {
    public final RSAKeyGenParameterSpec c;
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z04(@NotNull h92 state, @NotNull RSAKeyGenParameterSpec keyGenParameters, @NotNull String hashAlgorithmName) {
        super(state, "RSA");
    ...
    public ur3.c.b convert(KeyPair keyPair) {
        Intrinsics.checkNotNullParameter(keyPair, "<this>");
        return new y04(a(), keyPair, this.d);
    }
