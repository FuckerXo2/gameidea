...
public final class hf5 extends zzg {
    public final WeakReference a;
    public final ResultReceiver b;

    public /* synthetic */ hf5(WeakReference weakReference, ResultReceiver resultReceiver, gf5 gf5Var) {
    ...
    public final void zza(Bundle bundle) throws RemoteException {
        ...
        if (iZzb != 0) {
            zzb.zzk("BillingClient", "Unable to launch intent for alternative billing only dialog" + iZzb);
        ...
        try {
            ...
            bundle2.putString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS", String.format("%s: %s", e.getClass().getName(), zzab.zzb(e.getMessage())));
