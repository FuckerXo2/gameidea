...
public final class r14 extends x92 {
    public final RSAKeyGenParameterSpec c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r14(@NotNull h92 state, @NotNull RSAKeyGenParameterSpec keyGenParameters) {
        super(state, "RSA");
    ...
    public ur3.g.b convert(KeyPair keyPair) {
        Intrinsics.checkNotNullParameter(keyPair, "<this>");
        return new q14(a(), keyPair);
    }
