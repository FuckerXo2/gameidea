...
public final class jr implements Cloneable {
    ...
    public void appendBitArray(jr jrVar) {
        int i = jrVar.b;
        ensureCapacity(this.b + i);
        for (int i2 = 0; i2 < i; i2++) {
            appendBit(jrVar.get(i2));
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        jr jrVar = (jr) obj;
        return this.b == jrVar.b && Arrays.equals(this.a, jrVar.a);
    }
    ...
    public void xor(jr jrVar) {
        ...
        while (true) {
            ...
            iArr[i] = iArr[i] ^ jrVar.a[i];
            i++;
        }
    }

    public jr clone() {
        return new jr((int[]) this.a.clone(), this.b);
    }
