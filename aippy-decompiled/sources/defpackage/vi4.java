...
public class vi4 implements Interpolator {
    ...
    static {
        ...
        e = fViscousFluid;
        f = 1.0f - (fViscousFluid * viscousFluid(1.0f));
    }
    ...
    public float getInterpolation(float f2) {
        ...
        float fViscousFluid = e * viscousFluid(f2);
        return fViscousFluid > 0.0f ? fViscousFluid + f : fViscousFluid;
    }
}
