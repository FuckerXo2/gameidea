...
public class oo0 {
    ...
    public oo0(Context context, j53 j53Var) {
    ...
    private boolean processTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int iB = j35.b(motionEvent.getAction());
    ...
    public class a implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            oo0.this.j.onScale(scaleFactor, scaleGestureDetector.getFocusX(), scaleGestureDetector.getFocusY());
            return true;
        }
