...
public final class c14 extends m14 implements ur3.c.d {
    public final h92 b;
    public final PublicKey c;
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c14(@NotNull h92 state, @NotNull PublicKey key, @NotNull String hashAlgorithmName) {
        super(key);
    ...
    @NotNull
    public d encryptor() {
        return new x04(this.b, this.c);
    }

    @Override // ur3.c.d
    @NotNull
    public yg4 signatureVerifier() {
        return new na2(this.b, this.c, this.d + "withRSA", null);
    }
}
