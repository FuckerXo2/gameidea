...
public final class l14 extends n14 {
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l14(@NotNull h92 state, @NotNull String hashAlgorithmName) {
        super(state);
    ...
    public ur3.d.InterfaceC0198d convert(PublicKey publicKey) {
        Intrinsics.checkNotNullParameter(publicKey, "<this>");
        return new k14(c(), publicKey, this.d);
    }
