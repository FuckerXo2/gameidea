...
public final class v04 extends n14 {
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v04(@NotNull h92 state, @NotNull String hashAlgorithmName) {
        super(state);
    ...
    public ur3.b.d convert(PublicKey publicKey) {
        Intrinsics.checkNotNullParameter(publicKey, "<this>");
        return new u04(c(), publicKey, this.d);
    }
