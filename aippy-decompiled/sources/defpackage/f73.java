...
public abstract class f73 implements fb5 {
    ...
    private static lr renderResult(boolean[] zArr, int i, int i2, int i3) {
    ...
    public final lr encode(String str, BarcodeFormat barcodeFormat, int i, int i2) throws WriterException {
