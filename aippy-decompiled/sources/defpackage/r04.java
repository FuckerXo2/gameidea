...
public final class r04 extends x92 {
    public final RSAKeyGenParameterSpec c;
    public final String d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r04(@NotNull h92 state, @NotNull RSAKeyGenParameterSpec keyGenParameters, @NotNull String hashAlgorithmName) {
        super(state, "RSA");
    ...
    public ur3.b.InterfaceC0196b convert(KeyPair keyPair) {
        Intrinsics.checkNotNullParameter(keyPair, "<this>");
        return new q04(a(), keyPair, this.d);
    }
