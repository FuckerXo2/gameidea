...
public class gi4 extends AbstractList implements RandomAccess {
    public int a;
    public Object b;
    ...
    public class c extends d {
        ...
        public c() {
            super();
            this.b = ((AbstractList) gi4.this).modCount;
        }

        @Override // gi4.d
        public void a() {
            if (((AbstractList) gi4.this).modCount == this.b) {
                return;
            }
            throw new ConcurrentModificationException("ModCount: " + ((AbstractList) gi4.this).modCount + "; expected: " + this.b);
        }
