...
public final class q31 {
    ...
    public static String encodeECC200(String str, mo4 mo4Var) {
        if (str.length() != mo4Var.getDataCapacity()) {
            throw new IllegalArgumentException("The number of codewords does not match the selected symbol");
        }
        StringBuilder sb = new StringBuilder(mo4Var.getDataCapacity() + mo4Var.getErrorCodewords());
        sb.append(str);
        int interleavedBlockCount = mo4Var.getInterleavedBlockCount();
        if (interleavedBlockCount == 1) {
            sb.append(createECCBlock(str, mo4Var.getErrorCodewords()));
        } else {
            ...
            while (i < interleavedBlockCount) {
                int i2 = i + 1;
                iArr[i] = mo4Var.getDataLengthForInterleavedBlock(i2);
                iArr2[i] = mo4Var.getErrorLengthForInterleavedBlock(i2);
                iArr3[i] = 0;
                if (i > 0) {
            ...
            for (int i3 = 0; i3 < interleavedBlockCount; i3++) {
                ...
                for (int i4 = i3; i4 < mo4Var.getDataCapacity(); i4 += interleavedBlockCount) {
                ...
                while (i5 < iArr2[i3] * interleavedBlockCount) {
                    sb.setCharAt(mo4Var.getDataCapacity() + i5, strCreateECCBlock.charAt(i6));
