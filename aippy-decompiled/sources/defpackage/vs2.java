...
public final class vs2 {
    ...
    public static int a(aw awVar) {
        return applyMaskPenaltyRule1Internal(awVar, true) + applyMaskPenaltyRule1Internal(awVar, false);
    }

    private static int applyMaskPenaltyRule1Internal(aw awVar, boolean z) {
        int height = z ? awVar.getHeight() : awVar.getWidth();
        int width = z ? awVar.getWidth() : awVar.getHeight();
        byte[][] array = awVar.getArray();
        int i = 0;
    ...
    public static int d(aw awVar) {
        ...
        int height2 = awVar.getHeight() * awVar.getWidth();
    ...
    */
    public static boolean e(int r1, int r2, int r3) {
        /*
            r0 = 1
            switch(r1) {
                case 0: goto L30;
        ...
        L3d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vs2.e(int, int, int):boolean");
    }
