...
public final class ProtoBuf$VersionRequirement extends GeneratedMessageLite implements yp3 {
    ...
    public static final class b extends GeneratedMessageLite.b implements yp3 {
        public int b;
        public int c;
        public int d;
        public int f;
        ...
        public ProtoBuf$VersionRequirement build() {
            ...
            throw a.AbstractC0162a.a(protoBuf$VersionRequirementBuildPartial);
        }
        ...
        */
        public kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$VersionRequirement.b mergeFrom(kotlin.reflect.jvm.internal.impl.protobuf.c r3, kotlin.reflect.jvm.internal.impl.protobuf.d r4) throws java.lang.Throwable {
            /*
                r2 = this;
                r0 = 0
                qa3 r1 = kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$VersionRequirement.PARSER     // Catch: java.lang.Throwable -> Lf kotlin.reflect.jvm.internal.impl.protobuf.InvalidProtocolBufferException -> L11
    ...
    private ProtoBuf$VersionRequirement(c cVar, d dVar) throws InvalidProtocolBufferException {
        this.memoizedIsInitialized = (byte) -1;
        this.memoizedSerializedSize = -1;
        initFields();
            ...
            try {
                try {
                    ...
                    if (tag != 0) {
                        if (tag == 8) {
                            this.bitField0_ |= 1;
                            this.version_ = cVar.readInt32();
                        } else if (tag == 16) {
                            this.bitField0_ |= 2;
                            this.versionFull_ = cVar.readInt32();
                        } else if (tag == 24) {
                            int i = cVar.readEnum();
                            ...
                            this.bitField0_ |= 8;
                            this.errorCode_ = cVar.readInt32();
                        } else if (tag == 40) {
                            this.bitField0_ |= 16;
                            this.message_ = cVar.readInt32();
                        } else if (tag != 48) {
