...
public abstract class Random {
    ...
    public static final Random a = ki3.a.defaultPlatformRandom();
    ...
    public static final class Companion extends Random implements Serializable {
        ...
        public int nextBits(int bitCount) {
            return Random.a.nextBits(bitCount);
        }
        ...
        public byte[] nextBytes(int size) {
            return Random.a.nextBytes(size);
        }

        @Override // kotlin.random.Random
        public double nextDouble(double until) {
            return Random.a.nextDouble(until);
        }

        @Override // kotlin.random.Random
        public int nextInt(int until) {
            return Random.a.nextInt(until);
        }

        @Override // kotlin.random.Random
        public long nextLong(long until) {
            return Random.a.nextLong(until);
        }
        ...
        public byte[] nextBytes(@NotNull byte[] array, int fromIndex, int toIndex) {
            Intrinsics.checkNotNullParameter(array, "array");
            return Random.a.nextBytes(array, fromIndex, toIndex);
        }

        @Override // kotlin.random.Random
        public double nextDouble(double from, double until) {
            return Random.a.nextDouble(from, until);
        }

        @Override // kotlin.random.Random
        public int nextInt(int from, int until) {
            return Random.a.nextInt(from, until);
        }

        @Override // kotlin.random.Random
        public long nextLong(long from, long until) {
            return Random.a.nextLong(from, until);
        }
    }
    ...
    public double nextDouble(double from, double until) {
        double dNextDouble;
        ks3.checkRangeBounds(from, until);
        double d = until - from;
    ...
    public int nextInt(int from, int until) {
        ...
        if (i2 > 0 || i2 == Integer.MIN_VALUE) {
            if (((-i2) & i2) == i2) {
                iNextBits = nextBits(ks3.fastLog2(i2));
            } else {
                do {
                    iNextInt = nextInt() >>> 1;
                    i = iNextInt % i2;
    ...
    public long nextLong(long from, long until) {
        ...
        if (j2 > 0) {
            if (((-j2) & j2) == j2) {
                ...
                int i2 = (int) (j2 >>> 32);
                if (i != 0) {
                    iNextInt = nextBits(ks3.fastLog2(i));
                } else if (i2 == 1) {
                    iNextInt = nextInt();
                } else {
                    jNextBits = (((long) nextBits(ks3.fastLog2(i2))) << 32) + (4294967295L & ((long) nextInt()));
                }
