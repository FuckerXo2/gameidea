...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public final class ChunkedSource extends AbstractSource {
        ...
        private final void readChunkSize() throws IOException {
            ...
            try {
                ...
                String string = wm4.trim((CharSequence) this.this$0.source.readUtf8LineStrict()).toString();
                if (this.bytesRemainingInChunk < 0 || (string.length() > 0 && !j.startsWith$default(string, ";", false, 2, null))) {
    ...
    private final boolean isChunked(Response response) {
        return j.equals("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true);
    }
    ...
    private final boolean isChunked(Request request) {
        return j.equals("chunked", request.header("Transfer-Encoding"), true);
    }
}
