...
public final class AndroidLog {
    ...
    private final String loggerTag(String loggerName) {
        ...
        return str == null ? p.take(loggerName, 23) : str;
    }

    public final void androidLog$okhttp(@NotNull String loggerName, int logLevel, @NotNull String message, Throwable t) {
        int iMin;
        ...
        if (Log.isLoggable(strLoggerTag, logLevel)) {
            ...
            int i = 0;
            while (i < length) {
                int iIndexOf$default = wm4.indexOf$default((CharSequence) str, '\n', i, false, 4, (Object) null);
