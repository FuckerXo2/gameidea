...
public final class HostnamesKt {
    private static final boolean containsInvalidHostnameAsciiCodes(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (Intrinsics.compare((int) cCharAt, 31) <= 0 || Intrinsics.compare((int) cCharAt, 127) >= 0 || wm4.indexOf$default((CharSequence) " #%/:?@[\\]", cCharAt, 0, false, 6, (Object) null) != -1) {
                return true;
            }
        }
        return false;
    ...
    */
    private static final java.net.InetAddress decodeIpv6(java.lang.String r16, int r17, int r18) {
        ...
        L13:
            ...
            r3 = 0
            r0 = r16
            boolean r1 = kotlin.text.j.startsWith$default(r0, r1, r2, r3, r4, r5)
            if (r1 == 0) goto L33
            if (r12 == r10) goto L27
            return r14
        L27:
    ...
    public static final String toCanonicalHost(@NotNull String str) {
        ...
        if (!wm4.contains$default((CharSequence) str, (CharSequence) ":", false, 2, (Object) null)) {
            try {
        ...
        InetAddress inetAddressDecodeIpv6 = (j.startsWith$default(str, "[", false, 2, null) && j.endsWith$default(str, "]", false, 2, null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
