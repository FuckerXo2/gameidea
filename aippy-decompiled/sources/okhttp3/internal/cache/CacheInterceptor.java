    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!j.equals("Warning", strName, true) || !j.startsWith$default(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return j.equals("Content-Length", fieldName, true) || j.equals("Content-Encoding", fieldName, true) || j.equals("Content-Type", fieldName, true);
        }

        private final boolean isEndToEnd(String fieldName) {
            return (j.equals("Connection", fieldName, true) || j.equals("Keep-Alive", fieldName, true) || j.equals("Proxy-Authenticate", fieldName, true) || j.equals("Proxy-Authorization", fieldName, true) || j.equals("TE", fieldName, true) || j.equals("Trailers", fieldName, true) || j.equals("Transfer-Encoding", fieldName, true) || j.equals("Upgrade", fieldName, true)) ? false : true;
        }
