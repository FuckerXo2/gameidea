...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public static final class AnonymousClass1 implements Iterator<Snapshot>, uf2 {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        int iIndexOf$default2 = wm4.indexOf$default((CharSequence) line, ' ', i, false, 4, (Object) null);
        if (iIndexOf$default2 == -1) {
            strSubstring = line.substring(i);
            Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
            String str = REMOVE;
            if (iIndexOf$default == str.length() && j.startsWith$default(line, str, false, 2, null)) {
        ...
        if (iIndexOf$default2 != -1) {
            String str2 = CLEAN;
            if (iIndexOf$default == str2.length() && j.startsWith$default(line, str2, false, 2, null)) {
                String strSubstring2 = line.substring(iIndexOf$default2 + 1);
                Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                List<String> listSplit$default = wm4.split$default((CharSequence) strSubstring2, new char[]{' '}, false, 0, 6, (Object) null);
        ...
        if (iIndexOf$default2 == -1) {
            String str3 = DIRTY;
            if (iIndexOf$default == str3.length() && j.startsWith$default(line, str3, false, 2, null)) {
        ...
        if (iIndexOf$default2 == -1) {
            String str4 = READ;
            if (iIndexOf$default == str4.length() && j.startsWith$default(line, str4, false, 2, null)) {
                return;
            }
        }
        throw new IOException("unexpected journal line: " + line);
