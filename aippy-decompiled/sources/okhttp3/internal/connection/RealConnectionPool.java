...
public final class RealConnectionPool {
    ...
    */
    public final boolean callAcquirePooledConnection(@org.jetbrains.annotations.NotNull okhttp3.Address r4, @org.jetbrains.annotations.NotNull okhttp3.internal.connection.RealCall r5, java.util.List<okhttp3.Route> r6, boolean r7) {
        /*
            r3 = this;
    ...
    public final int idleConnectionCount() {
        ...
        int i = 0;
        if (z43.a(concurrentLinkedQueue) && concurrentLinkedQueue.isEmpty()) {
            return 0;
        }
