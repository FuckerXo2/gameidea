    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(@NotNull Headers responseHeaders) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                if (j.equals(responseHeaders.name(i), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION, true)) {
                    ...
                    while (i2 < strValue.length()) {
                        ...
                        if (j.equals(strTrimSubstring, "permessage-deflate", true)) {
                            if (!z) {
                                z4 = true;
                                while (i4 < iDelimiterOffset$default) {
                                    ...
                                    String strRemoveSurrounding = iDelimiterOffset3 < iDelimiterOffset2 ? wm4.removeSurrounding(Util.trimSubstring(strValue, iDelimiterOffset3 + 1, iDelimiterOffset2), (CharSequence) "\"") : null;
                                    int i5 = iDelimiterOffset2 + 1;
                                    if (j.equals(strTrimSubstring2, "client_max_window_bits", true)) {
                                        if (intOrNull != null) {
                                            z4 = true;
                                        }
                                        intOrNull = strRemoveSurrounding != null ? i.toIntOrNull(strRemoveSurrounding) : null;
                                        i4 = intOrNull == null ? i5 : i5;
                                    } else if (j.equals(strTrimSubstring2, "client_no_context_takeover", true)) {
                                        if (z2) {
                                            z4 = true;
                                        }
                                        ...
                                        i4 = i5;
                                        z2 = true;
                                    } else if (j.equals(strTrimSubstring2, "server_max_window_bits", true)) {
                                        if (intOrNull2 != null) {
                                            z4 = true;
                                        }
                                        intOrNull2 = strRemoveSurrounding != null ? i.toIntOrNull(strRemoveSurrounding) : null;
                                        if (intOrNull2 == null) {
                                        }
                                    } else if (j.equals(strTrimSubstring2, "server_no_context_takeover", true)) {
                                        if (z3) {
                                            z4 = true;
                                        }
                                        if (strRemoveSurrounding != null) {
