...
public final class HttpHeaders {
    ...
    public static final List<Challenge> parseChallenges(@NotNull Headers headers, @NotNull String headerName) {
        ...
        for (int i = 0; i < size; i++) {
            if (j.equals(headerName, headers.name(i), true)) {
                try {
    ...
    public static final boolean promisesBody(@NotNull Response response) {
        ...
        if (Intrinsics.areEqual(response.request().method(), HttpMethods.HEAD)) {
            return false;
        }
        int iCode = response.code();
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && Util.headersContentLength(response) == -1 && !j.equals("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
    ...
    */
    private static final void readChallengeHeader(okio.Buffer r7, java.util.List<okhttp3.Challenge> r8) throws java.io.EOFException {
        ...
        L42:
            ...
            r4.append(r3)
            java.lang.String r3 = "="
            java.lang.String r3 = kotlin.text.j.repeat(r3, r5)
            r4.append(r3)
