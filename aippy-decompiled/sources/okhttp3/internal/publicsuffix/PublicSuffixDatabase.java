...
public final class PublicSuffixDatabase {
    ...
    @NotNull
    private static final List<String> PREVAILING_RULE = n30.listOf("*");
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) {
        ...
        if (str != null) {
            return wm4.split$default((CharSequence) (EXCEPTION_MARKER + str), new char[]{'.'}, false, 0, 6, (Object) null);
        }
        if (strBinarySearch == null && str2 == null) {
            return PREVAILING_RULE;
        }
        if (strBinarySearch == null || (listEmptyList = wm4.split$default((CharSequence) strBinarySearch, new char[]{'.'}, false, 0, 6, (Object) null)) == null) {
            listEmptyList = o30.emptyList();
        }
        if (str2 == null || (listEmptyList2 = wm4.split$default((CharSequence) str2, new char[]{'.'}, false, 0, 6, (Object) null)) == null) {
            listEmptyList2 = o30.emptyList();
        }
    ...
    private final List<String> splitDomain(String domain) {
        List<String> listSplit$default = wm4.split$default((CharSequence) domain, new char[]{'.'}, false, 0, 6, (Object) null);
        return Intrinsics.areEqual(y30.last((List) listSplit$default), "") ? y30.dropLast(listSplit$default, 1) : listSplit$default;
    }
    ...
    public final String getEffectiveTldPlusOne(@NotNull String domain) {
        ...
        return SequencesKt___SequencesKt.joinToString$default(SequencesKt___SequencesKt.drop(y30.asSequence(splitDomain(domain)), size - size2), TRouterMap.DOT, null, null, 0, null, null, 62, null);
    }
