...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m1737addInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m1738addNetworkInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder protocols(@NotNull List<? extends Protocol> protocols) {
            ...
            List mutableList = y30.toMutableList((Collection) protocols);
        ...
        public Builder(@NotNull OkHttpClient okHttpClient) {
            ...
            t30.addAll(this.interceptors, okHttpClient.interceptors());
            t30.addAll(this.networkInterceptors, okHttpClient.networkInterceptors());
    ...
    public OkHttpClient(@NotNull Builder builder) throws NoSuchAlgorithmException, KeyStoreException {
        ...
        if (z43.a(connectionSpecs$okhttp) && connectionSpecs$okhttp.isEmpty()) {
    ...
    public final List<ConnectionSpec> m1717deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Interceptor> m1725deprecated_interceptors() {
        return this.interceptors;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1726deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final SSLSocketFactory m1735deprecated_sslSocketFactory() {
