...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, j80.naturalOrder());
        } else {
    ...
    public final List<CipherSuite> m1654deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1656deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(@NotNull SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), j80.naturalOrder())) {
            return false;
        }
