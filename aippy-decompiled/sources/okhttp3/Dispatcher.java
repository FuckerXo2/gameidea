...
public final class Dispatcher {
    ...
    public final ExecutorService m1666deprecated_executorService() {
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(p30.collectionSizeOrDefault(arrayDeque, 10));
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(p30.collectionSizeOrDefault(arrayDeque2, 10));
            Iterator<T> it2 = arrayDeque2.iterator();
            while (it2.hasNext()) {
                arrayList.add(((RealCall.AsyncCall) it2.next()).getThis$0());
            }
            listUnmodifiableList = Collections.unmodifiableList(y30.plus((Collection) arrayDeque, (Iterable) arrayList));
