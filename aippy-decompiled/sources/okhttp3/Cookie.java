...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        public final Builder name(@NotNull String name) {
            ...
            if (!Intrinsics.areEqual(wm4.trim((CharSequence) name).toString(), name)) {
        ...
        public final Builder value(@NotNull String value) {
            ...
            if (!Intrinsics.areEqual(wm4.trim((CharSequence) value).toString(), value)) {
    ...
    public static final class Companion {
        ...
        public final boolean domainMatch(String urlHost, String domain) {
            ...
            return j.endsWith$default(urlHost, domain, false, 2, null) && urlHost.charAt((urlHost.length() - domain.length()) - 1) == '.' && !Util.canParseAsIpAddress(urlHost);
        }

        private final String parseDomain(String s) {
            if (j.endsWith$default(s, TRouterMap.DOT, false, 2, null)) {
                throw new IllegalArgumentException("Failed requirement.");
            }
            String canonicalHost = HostnamesKt.toCanonicalHost(wm4.removePrefix(s, (CharSequence) TRouterMap.DOT));
            if (canonicalHost != null) {
        ...
        private final long parseExpires(String s, int pos, int limit) {
            ...
            while (iDateCharacterOffset < limit) {
                ...
                if (i2 == -1 && matcher.usePattern(Cookie.TIME_PATTERN).matches()) {
                    ...
                    iIndexOf$default = wm4.indexOf$default((CharSequence) strPattern, lowerCase, 0, false, 6, (Object) null) / 4;
        ...
        private final long parseMaxAge(String s) {
            try {
                ...
                if (j.startsWith$default(s, "-", false, 2, null)) {
                    return Long.MIN_VALUE;
                }
        ...
        public final boolean pathMatch(HttpUrl url, String path) {
            ...
            return j.startsWith$default(strEncodedPath, path, false, 2, null) && (j.endsWith$default(path, "/", false, 2, null) || strEncodedPath.charAt(path.length()) == '/');
        }
        ...
        public final Cookie parse$okhttp(long currentTimeMillis, @NotNull HttpUrl url, @NotNull String setCookie) {
            ...
            while (i < length) {
                ...
                if (j.equals(strTrimSubstring2, "expires", true)) {
                    try {
                        expires = parseExpires(strTrimSubstring3, 0, strTrimSubstring3.length());
                        z2 = true;
                    } catch (NumberFormatException | IllegalArgumentException unused) {
                    }
                } else if (j.equals(strTrimSubstring2, "max-age", true)) {
                    maxAge = parseMaxAge(strTrimSubstring3);
                    z2 = true;
                } else if (j.equals(strTrimSubstring2, "domain", true)) {
                    domain = parseDomain(strTrimSubstring3);
                    z4 = false;
                } else if (j.equals(strTrimSubstring2, "path", true)) {
                    str = strTrimSubstring3;
                } else if (j.equals(strTrimSubstring2, "secure", true)) {
                    z3 = true;
                } else if (j.equals(strTrimSubstring2, "httponly", true)) {
                    z = true;
                }
            ...
            if (maxAge == Long.MIN_VALUE) {
                ...
                long j2 = currentTimeMillis + (maxAge <= 9223372036854775L ? maxAge * ((long) 1000) : LocationRequestCompat.PASSIVE_INTERVAL);
            ...
            String strSubstring = "/";
            if (str == null || !j.startsWith$default(str, "/", false, 2, cookie3)) {
                String strEncodedPath = url.encodedPath();
                int iLastIndexOf$default = wm4.lastIndexOf$default((CharSequence) strEncodedPath, '/', 0, false, 6, (Object) null);
    ...
    public int hashCode() {
        return ((((((((((((((((527 + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + vd1.a(this.expiresAt)) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + sh.a(this.secure)) * 31) + sh.a(this.httpOnly)) * 31) + sh.a(this.persistent)) * 31) + sh.a(this.hostOnly);
    }
