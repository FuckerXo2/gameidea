...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, rf2 {
    ...
    public static final class Builder {
        ...
        public final Builder add(@NotNull String line) {
            ...
            int iIndexOf$default = wm4.indexOf$default((CharSequence) line, ':', 0, false, 6, (Object) null);
        ...
        public final Builder addLenient$okhttp(@NotNull String line) {
            Intrinsics.checkNotNullParameter(line, "line");
            int iIndexOf$default = wm4.indexOf$default((CharSequence) line, ':', 1, false, 4, (Object) null);
            if (iIndexOf$default != -1) {
                String strSubstring = line.substring(0, iIndexOf$default);
                Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String…ing(startIndex, endIndex)");
                String strSubstring2 = line.substring(iIndexOf$default + 1);
        ...
        public final String get(@NotNull String name) {
            ...
            while (!j.equals(name, this.namesAndValues.get(size), true)) {
        ...
        public final Builder removeAll(@NotNull String name) {
            ...
            while (i < this.namesAndValues.size()) {
                if (j.equals(name, this.namesAndValues.get(i), true)) {
        ...
        public final Builder addLenient$okhttp(@NotNull String name, @NotNull String value) {
            ...
            this.namesAndValues.add(wm4.trim((CharSequence) value).toString());
            return this;
        }
    ...
    public static final class Companion {
        ...
        public final String get(String[] namesAndValues, String name) {
            ...
            int progressionLastElement = ao3.getProgressionLastElement(length, 0, -2);
            if (progressionLastElement > length) {
                return null;
            }
            while (!j.equals(name, namesAndValues[length], true)) {
        ...
        public final Headers m1677deprecated_of(@NotNull String... namesAndValues) {
        ...
        public final Headers of(@NotNull String... namesAndValues) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                strArr[i2] = wm4.trim((CharSequence) str).toString();
            }
            int progressionLastElement = ao3.getProgressionLastElement(0, strArr.length - 1, 2);
        ...
        @NotNull
        /* JADX INFO: renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m1676deprecated_of(@NotNull Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
        ...
        public final Headers of(@NotNull Map<String, String> map) {
            ...
            for (Map.Entry<String, String> entry : map.entrySet()) {
                ...
                String string = wm4.trim((CharSequence) key).toString();
                String string2 = wm4.trim((CharSequence) value).toString();
                checkName(string);
    ...
    public final int m1675deprecated_size() {
        return size();
    }
    ...
    public Iterator<Pair<? extends String, ? extends String>> iterator() {
        ...
        for (int i = 0; i < size; i++) {
            pairArr[i] = fv4.to(name(i), value(i));
        }
        return td.iterator(pairArr);
    }
    ...
    public final Builder newBuilder() {
        ...
        t30.addAll(builder.getNamesAndValues$okhttp(), this.namesAndValues);
        return builder;
    }
    ...
    public final Map<String, List<String>> toMultimap() {
        TreeMap treeMap = new TreeMap(j.getCASE_INSENSITIVE_ORDER(km4.a));
        int size = size();
        for (int i = 0; i < size; i++) {
