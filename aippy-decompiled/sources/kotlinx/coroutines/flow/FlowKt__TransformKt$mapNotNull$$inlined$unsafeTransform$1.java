...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1 implements Flow {
    ...
    public static final class AnonymousClass2 implements fe1 {
        ...
        @jp0(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", f = "Transform.kt", i = {0}, l = {50, ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_TAG}, m = "emit", n = {"$this$mapNotNull_u24lambda_u246"}, s = {"L$0"})
        ...
        */
        public final java.lang.Object emit(java.lang.Object r7, defpackage.kd0<? super kotlin.Unit> r8) throws java.lang.Throwable {
            ...
            L60:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2.emit(java.lang.Object, kd0):java.lang.Object");
        }
        ...
        public final Object emit$$forInline(Object obj, kd0 kd0Var) {
            ...
            q12.mark(5);
            fe1 fe1Var = this.a;
            Object objInvoke = this.b.invoke(obj, kd0Var);
            if (objInvoke != null) {
                q12.mark(0);
                fe1Var.emit(objInvoke, kd0Var);
                q12.mark(1);
            }
            return Unit.a;
        }
    ...
    public Object collect$$forInline(fe1 fe1Var, kd0 kd0Var) {
        q12.mark(4);
        new ContinuationImpl(kd0Var) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.1
            int label;
            /* synthetic */ Object result;
