...
public final class FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 implements Flow {
    ...
    @jp0(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1", f = "Transform.kt", i = {0, 0, 0}, l = {110, 111}, m = "collect", n = {"this", "$this$runningFold_u24lambda_u249", "accumulator"}, s = {"L$0", "L$1", "L$2"})
    ...
    public FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1(Object obj, Flow flow, uh1 uh1Var) {
        this.a = obj;
        this.b = flow;
        this.c = uh1Var;
    }
    ...
    */
    public java.lang.Object collect(defpackage.fe1 r7, defpackage.kd0<? super kotlin.Unit> r8) throws java.lang.Throwable {
        ...
        L7b:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1.collect(fe1, kd0):java.lang.Object");
    }
}
