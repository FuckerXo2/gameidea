...
public abstract class AbstractFlow implements Flow, tx {

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.AbstractFlow$collect$1, reason: invalid class name */
    @jp0(c = "kotlinx.coroutines.flow.AbstractFlow", f = "Flow.kt", i = {0}, l = {226}, m = "collect", n = {"safeCollector"}, s = {"L$0"})
    ...
    */
    public final java.lang.Object collect(@org.jetbrains.annotations.NotNull defpackage.fe1 r6, @org.jetbrains.annotations.NotNull defpackage.kd0<? super kotlin.Unit> r7) throws java.lang.Throwable {
        /*
            r5 = this;
        ...
        L18:
            ...
            kotlin.c.throwOnFailure(r7)     // Catch: java.lang.Throwable -> L2d
            goto L4f
        L2d:
            r7 = move-exception
            goto L59
        ...
        L59:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.AbstractFlow.collect(fe1, kd0):java.lang.Object");
    }

    public abstract Object collectSafely(@NotNull fe1 fe1Var, @NotNull kd0<? super Unit> kd0Var);
}
