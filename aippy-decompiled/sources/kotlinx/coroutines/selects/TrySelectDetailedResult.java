...
public final class TrySelectDetailedResult {
    public static final /* synthetic */ TrySelectDetailedResult[] a;
    ...
    static {
        ...
        a = trySelectDetailedResultArr$values;
        b = kotlin.enums.a.enumEntries(trySelectDetailedResultArr$values);
    }
    ...
    public static TrySelectDetailedResult[] values() {
        return (TrySelectDetailedResult[]) a.clone();
    }
}
