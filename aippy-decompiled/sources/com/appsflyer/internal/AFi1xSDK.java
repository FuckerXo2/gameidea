...
public abstract class AFi1xSDK {
    ...
    public final AFi1wSDK AFInAppEventType() {
        ...
        return new AFi1wSDK(valueOf(), networkOperatorName, simOperatorName, values());
    }
