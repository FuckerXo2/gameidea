...
public final class AFg1hSDK extends AFg1fSDK {
    ...
    private final void values(AFLogger.LogLevel p0, AFg1aSDK p1, String p2, Throwable p3) {
        if (AFInAppEventType(p0)) {
            String strValues = values(p2, p1);
            int i = AFa1zSDK.AFKeystoreWrapper[p0.ordinal()];
            if (i == 1) {
                Log.d("AppsFlyer_6.14.0", strValues);
                return;
            }
            if (i == 2) {
                Log.i("AppsFlyer_6.14.0", strValues);
                return;
            }
            if (i == 3) {
                Log.w("AppsFlyer_6.14.0", strValues);
            } else if (i == 4) {
                Log.v("AppsFlyer_6.14.0", strValues);
            } else {
                if (i != 5) {
                    return;
                }
                Log.e("AppsFlyer_6.14.0", strValues, p3);
            }
        }
    }
