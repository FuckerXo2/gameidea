...
final class AFd1ySDK implements Application.ActivityLifecycleCallbacks {
    ...
    public static final void AFInAppEventType(final AFd1ySDK aFd1ySDK) {
        ...
        try {
            ...
            Runnable runnable = new Runnable() { // from class: com.appsflyer.internal.q
                @Override // java.lang.Runnable
                public final void run() {
                    AFd1ySDK.values(this.a);
                }
            };
    ...
    public final void onActivityPaused(Activity activity) {
        Intrinsics.checkNotNullParameter(activity, "");
        this.AFInAppEventParameterName.execute(new Runnable() { // from class: com.appsflyer.internal.p
            @Override // java.lang.Runnable
            public final void run() {
                AFd1ySDK.AFInAppEventType(this.a);
            }
        });
    }
    ...
    public final void onActivityResumed(Activity activity) {
        ...
        this.AFInAppEventParameterName.execute(new Runnable() { // from class: com.appsflyer.internal.o
            @Override // java.lang.Runnable
            public final void run() {
                AFd1ySDK.AFInAppEventParameterName(this.a, aFh1xSDK);
            }
        });
    }
