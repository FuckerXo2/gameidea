...
public final class AFh1hSDK {
    ...
    public final boolean equals(Object p0) {
        ...
        if (!Intrinsics.areEqual(AFh1hSDK.class, p0 != null ? p0.getClass() : null)) {
            return false;
        }
        if (p0 == null) {
    ...
    public final int hashCode() {
        return (((((((((vd1.a(this.unregisterClient) * 31) + Float.floatToIntBits(this.AFInAppEventType)) * 31) + this.d.hashCode()) * 31) + this.AFInAppEventParameterName) * 31) + this.valueOf.hashCode()) * 31) + this.AFKeystoreWrapper.hashCode();
    }
}
