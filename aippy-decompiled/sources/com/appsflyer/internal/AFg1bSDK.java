...
public final class AFg1bSDK extends AFg1fSDK {
    ...
    public final void e(AFg1aSDK aFg1aSDK, String str, Throwable th, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            this.valueOf.v().AFKeystoreWrapper(ExifInterface.LONGITUDE_EAST, values(str, aFg1aSDK));
        }
        if (z4) {
    ...
    public final void v(AFg1aSDK aFg1aSDK, String str, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(str, "");
        if (z) {
            this.valueOf.v().AFKeystoreWrapper(ExifInterface.GPS_MEASUREMENT_INTERRUPTED, values(str, aFg1aSDK));
        }
    }
    ...
    public final void w(AFg1aSDK aFg1aSDK, String str, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(str, "");
        if (z) {
            this.valueOf.v().AFKeystoreWrapper(ExifInterface.LONGITUDE_WEST, values(str, aFg1aSDK));
        }
    }
}
