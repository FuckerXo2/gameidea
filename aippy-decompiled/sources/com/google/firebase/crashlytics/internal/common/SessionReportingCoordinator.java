...
public class SessionReportingCoordinator {
    ...
    public static /* synthetic */ void a(SessionReportingCoordinator sessionReportingCoordinator, CrashlyticsReport.Session.Event event, EventMetadata eventMetadata, boolean z) {
    ...
    private ApplicationExitInfo findRelevantApplicationExitInfo(String str, List<ApplicationExitInfo> list) {
        ...
        while (it2.hasNext()) {
            ApplicationExitInfo applicationExitInfoA = vf1.a(it2.next());
    ...
    private static List<CrashlyticsReport.CustomAttribute> getSortedCustomAttributes(@NonNull Map<String, String> map) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: bc4
    ...
    private void persistEvent(@NonNull Throwable th, @NonNull Thread thread, @NonNull String str, @NonNull final EventMetadata eventMetadata, boolean z) {
        ...
        if (z) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: ac4
                @Override // java.lang.Runnable
                public final void run() {
                    SessionReportingCoordinator.a(this.a, eventAddMetaDataToEvent, eventMetadata, zEquals);
                }
            });
        }
    }
    ...
    public Task<Void> sendReports(@NonNull Executor executor, @Nullable String str) {
        ...
        for (CrashlyticsReportWithSessionId crashlyticsReportWithSessionId : listLoadFinalizedReports) {
            if (str == null || str.equals(crashlyticsReportWithSessionId.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(ensureHasFid(crashlyticsReportWithSessionId), str != null).continueWith(executor, new Continuation() { // from class: zb4
