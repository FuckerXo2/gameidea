...
public class CrashlyticsCore {
    ...
    private void checkForPreviousCrash() {
        try {
            this.didCrashOnPreviousExecution = Boolean.TRUE.equals((Boolean) this.crashlyticsWorkers.common.getExecutor().submit(new Callable() { // from class: kf0
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return Boolean.valueOf(this.a.controller.didCrashOnPreviousExecution());
                }
    ...
    public void doBackgroundInitialization(SettingsProvider settingsProvider) {
        ...
        try {
            try {
                this.breadcrumbSource.registerBreadcrumbHandler(new BreadcrumbHandler() { // from class: df0
    ...
    private void finishInitSynchronously(final SettingsProvider settingsProvider) {
        Future<?> futureSubmit = this.crashlyticsWorkers.common.getExecutor().submit(new Runnable() { // from class: cf0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.doBackgroundInitialization(settingsProvider);
            }
        });
    ...
    public static boolean isBuildIdValid(String str, boolean z) {
        ...
        Log.e(Logger.TAG, TRouterMap.DOT);
        Log.e(Logger.TAG, ".     |  | ");
        Log.e(Logger.TAG, ".     |  |");
        Log.e(Logger.TAG, ".     |  |");
        Log.e(Logger.TAG, ".   \\ |  | /");
    ...
    public Task<Void> doBackgroundInitializationAsync(final SettingsProvider settingsProvider) {
        return this.crashlyticsWorkers.common.submit(new Runnable() { // from class: af0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.doBackgroundInitialization(settingsProvider);
            }
    ...
    public void log(final String str) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: lf0
            @Override // java.lang.Runnable
            public final void run() {
                CrashlyticsCore crashlyticsCore = this.a;
                crashlyticsCore.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: jf0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.a.controller.writeToLog(j, str);
                    }
                });
            }
        });
    ...
    public void logException(@NonNull final Throwable th, @NonNull final Map<String, String> map) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: if0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.controller.writeNonFatalException(Thread.currentThread(), th, map);
            }
        });
    }
    ...
    public void logFatalException(final Throwable th) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: ef0
            @Override // java.lang.Runnable
            public final void run() {
                CrashlyticsCore.c(this.a, th);
            }
        });
    }
    ...
    public void setCustomKey(final String str, final String str2) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: gf0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.controller.setCustomKey(str, str2);
            }
        });
    }
    ...
    public void setCustomKeys(final Map<String, String> map) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: bf0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.controller.setCustomKeys(map);
            }
        });
    }

    public void setInternalKey(final String str, final String str2) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: hf0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.controller.setInternalKey(str, str2);
            }
        });
    }

    public void setUserId(final String str) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: ff0
            @Override // java.lang.Runnable
            public final void run() {
                this.a.controller.setUserId(str);
            }
        });
    }
}
