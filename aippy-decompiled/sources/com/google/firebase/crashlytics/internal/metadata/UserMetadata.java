...
public class UserMetadata {
    ...
    public class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            ...
            if (bj2.a(this.queuedSerializer, null, runnable)) {
    ...
    public void setNewSession(final String str) {
        synchronized (this.sessionIdentifier) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: r25
                @Override // java.lang.Runnable
                public final void run() throws Throwable {
                    UserMetadata.c(this.a, str, keys, rolloutAssignmentList);
                }
            });
        }
    }
    ...
    public void setUserId(String str) {
        ...
        synchronized (this.userId) {
            try {
                ...
                this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: s25
                    @Override // java.lang.Runnable
                    public final void run() throws Throwable {
                        this.a.serializeUserDataIfNeeded();
                    }
                });
            } catch (Throwable th) {
                throw th;
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            try {
                ...
                final List<RolloutAssignment> rolloutAssignmentList = this.rolloutsState.getRolloutAssignmentList();
                this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: q25
                    @Override // java.lang.Runnable
                    public final void run() throws Throwable {
