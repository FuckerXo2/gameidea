...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(@NonNull final String str, @NonNull AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        ...
        if (zzc.zzd(str) && !zzc(str)) {
            ...
            com.google.firebase.analytics.connector.internal.zza zzeVar = FirebaseABTesting.OriginService.INAPP_MESSAGING.equals(str) ? new zze(appMeasurementSdk, analyticsConnectorListener) : "clx".equals(str) ? new zzg(appMeasurementSdk, analyticsConnectorListener) : null;
            if (zzeVar != null) {
                ...
                return new AnalyticsConnector.AnalyticsConnectorHandle(this) { // from class: com.google.firebase.analytics.connector.AnalyticsConnectorImpl.1
                    ...
                    public void registerEventNames(Set<String> set) {
                        ...
                        String str2 = str;
                        if (!analyticsConnectorImpl.zzc(str2) || !str2.equals(FirebaseABTesting.OriginService.INAPP_MESSAGING) || set == null || set.isEmpty()) {
                            return;
                        }
                    ...
                    public void unregisterEventNames() {
                        AnalyticsConnectorImpl analyticsConnectorImpl = this.zzb;
                        String str2 = str;
                        if (analyticsConnectorImpl.zzc(str2) && str2.equals(FirebaseABTesting.OriginService.INAPP_MESSAGING)) {
