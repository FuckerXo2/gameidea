...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public void log(@NotNull SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.of("json"), new Transformer() { // from class: f41
            @Override // com.google.android.datatransport.Transformer
            public final Object apply(Object obj) {
                return this.a.encode((SessionEvent) obj);
            }
