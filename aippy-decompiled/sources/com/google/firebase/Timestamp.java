...
public final class Timestamp implements Comparable<Timestamp>, Parcelable {
    ...
    public static final class Companion {
        ...
        public final Pair<Long, Integer> toPreciseTime(Date date) {
            ...
            return time2 < 0 ? fv4.to(Long.valueOf(time - 1), Integer.valueOf(time2 + Http2Connection.DEGRADED_PONG_TIMEOUT_NS)) : fv4.to(Long.valueOf(time), Integer.valueOf(time2));
        }
    ...
    public int compareTo(@NotNull Timestamp other) {
        ...
        return j80.compareValuesBy(this, other, (Function1<? super Timestamp, ? extends Comparable<?>>[]) new Function1[]{new PropertyReference1Impl() { // from class: com.google.firebase.Timestamp.compareTo.1
