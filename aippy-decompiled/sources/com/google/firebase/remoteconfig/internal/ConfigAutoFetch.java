...
public class ConfigAutoFetch {
    ...
    public static /* synthetic */ Task a(ConfigAutoFetch configAutoFetch, Task task, Task task2, long j, int i, Task task3) throws JSONException {
    ...
    public synchronized Task<Void> fetchLatestConfig(int i, final long j) throws Throwable {
        ...
        try {
            try {
                ...
                return Tasks.whenAllComplete((Task<?>[]) new Task[]{taskFetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: oa0
                    @Override // com.google.android.gms.tasks.Continuation
                    public final Object then(Task task2) {
                        return ConfigAutoFetch.a(this.a, taskFetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
                    }
                });
            } catch (Throwable th) {
                th = th;
