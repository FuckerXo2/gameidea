...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public void removeInternal(e eVar, boolean z) {
        int i;
        if (z) {
            e eVar2 = eVar.e;
            eVar2.d = eVar.d;
        ...
        e eVarLast = eVar3.i > eVar4.i ? eVar3.last() : eVar4.first();
        removeInternal(eVarLast, false);
        e eVar6 = eVar.b;
        if (eVar6 != null) {
            i = eVar6.i;
            eVarLast.b = eVar6;
        ...
        eVarLast.i = Math.max(i, i2) + 1;
        replaceInParent(eVar, eVarLast);
    }
