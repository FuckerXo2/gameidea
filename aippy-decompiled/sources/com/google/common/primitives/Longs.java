...
public final class Longs {
    ...
    public static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
        ...
        public Long set(int i, Long l) {
            ...
            int i2 = this.start;
            long j = jArr[i2 + i];
            jArr[i2 + i] = ((Long) tk3.checkNotNull(l)).longValue();
    ...
    public static long constrainToRange(long j, long j2, long j3) {
        tk3.checkArgument(j2 <= j3, "min (%s) must be less than or equal to max (%s)", j2, j3);
    ...
    public static long fromByteArray(byte[] bArr) {
        tk3.checkArgument(bArr.length >= 8, "array too small: %s < %s", bArr.length, 8);
    ...
    public static long max(long... jArr) {
        tk3.checkArgument(jArr.length > 0);
        long j = jArr[0];
        for (int i = 1; i < jArr.length; i++) {
            long j2 = jArr[i];
            if (j2 > j) {
    ...
    public static long[] toArray(Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < length; i++) {
            jArr[i] = ((Number) tk3.checkNotNull(array[i])).longValue();
        }
        return jArr;
    }
    ...
    public static Long tryParse(String str, int i) {
        if (((String) tk3.checkNotNull(str)).isEmpty()) {
            return null;
        }
        if (i < 2 || i > 36) {
    ...
    */
    public static int indexOf(long[] r7, long[] r8) {
        /*
            ...
            defpackage.tk3.checkNotNull(r7, r0)
            java.lang.String r0 = "target"
            defpackage.tk3.checkNotNull(r8, r0)
            int r0 = r8.length
            r1 = 0
            if (r0 != 0) goto Lf
            return r1
    ...
    public static void reverse(long[] jArr, int i, int i2) {
        tk3.checkNotNull(jArr);
        tk3.checkPositionIndexes(i, i2, jArr.length);
