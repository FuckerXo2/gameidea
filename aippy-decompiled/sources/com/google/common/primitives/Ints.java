...
public final class Ints extends a52 {
    ...
    public static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public Integer set(int i, Integer num) {
            ...
            int i2 = this.start;
            int i3 = iArr[i2 + i];
            iArr[i2 + i] = ((Integer) tk3.checkNotNull(num)).intValue();
    ...
    public static int checkedCast(long j) {
        int i = (int) j;
        tk3.checkArgument(((long) i) == j, "Out of range: %s", j);
        return i;
    }
    ...
    public static int constrainToRange(int i, int i2, int i3) {
        tk3.checkArgument(i2 <= i3, "min (%s) must be less than or equal to max (%s)", i2, i3);
    ...
    public static int[] ensureCapacity(int[] iArr, int i, int i2) {
        tk3.checkArgument(i >= 0, "Invalid minLength: %s", i);
        tk3.checkArgument(i2 >= 0, "Invalid padding: %s", i2);
        return iArr.length < i ? Arrays.copyOf(iArr, i + i2) : iArr;
    }

    public static int fromByteArray(byte[] bArr) {
        tk3.checkArgument(bArr.length >= 4, "array too small: %s < %s", bArr.length, 4);
    ...
    public static int max(int... iArr) {
        tk3.checkArgument(iArr.length > 0);
        int i = iArr[0];
    ...
    public static int[] toArray(Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < length; i++) {
            iArr[i] = ((Number) tk3.checkNotNull(array[i])).intValue();
        }
        return iArr;
    }
    ...
    */
    public static int indexOf(int[] r5, int[] r6) {
        /*
            ...
            defpackage.tk3.checkNotNull(r5, r0)
            java.lang.String r0 = "target"
            defpackage.tk3.checkNotNull(r6, r0)
            int r0 = r6.length
            r1 = 0
            if (r0 != 0) goto Lf
            return r1
    ...
    public static void reverse(int[] iArr, int i, int i2) {
        tk3.checkNotNull(iArr);
        tk3.checkPositionIndexes(i, i2, iArr.length);
