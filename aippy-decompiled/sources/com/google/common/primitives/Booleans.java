...
public final class Booleans {
    ...
    public static class BooleanArrayAsList extends AbstractList<Boolean> implements RandomAccess, Serializable {
        ...
        public Boolean set(int i, Boolean bool) {
            ...
            int i2 = this.start;
            boolean z = zArr[i2 + i];
            zArr[i2 + i] = ((Boolean) tk3.checkNotNull(bool)).booleanValue();
    ...
    public static boolean[] toArray(Collection<Boolean> collection) {
        ...
        for (int i = 0; i < length; i++) {
            zArr[i] = ((Boolean) tk3.checkNotNull(array[i])).booleanValue();
        }
        return zArr;
    }
    ...
    */
    ...
    public static void reverse(boolean[] zArr, int i, int i2) {
        tk3.checkNotNull(zArr);
        tk3.checkPositionIndexes(i, i2, zArr.length);
