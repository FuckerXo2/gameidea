...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, oj4 {
    ...
    public static final class a extends ImmutableSet.a {
        ...
        public a(Comparator<Object> comparator) {
            this.f = (Comparator) tk3.checkNotNull(comparator);
        }
        ...
        @Override // com.google.common.collect.ImmutableSet.a, com.google.common.collect.ImmutableCollection.a, com.google.common.collect.ImmutableCollection.b
        public /* bridge */ /* synthetic */ ImmutableSet.a addAll(Iterable iterable) {
            return addAll((Iterable<Object>) iterable);
        }

        @Override // com.google.common.collect.ImmutableSet.a, com.google.common.collect.ImmutableCollection.b
        public ImmutableSortedSet<Object> build() {
            ImmutableSortedSet<Object> immutableSortedSetConstruct = ImmutableSortedSet.construct(this.f, this.b, this.a);
        ...
        @Override // com.google.common.collect.ImmutableSet.a, com.google.common.collect.ImmutableCollection.b
        public /* bridge */ /* synthetic */ ImmutableSet.a addAll(Iterator it2) {
            return addAll((Iterator<Object>) it2);
        }
    ...
    public static <E> ImmutableSortedSet<E> copyOfSorted(SortedSet<E> sortedSet) {
        Comparator comparator = pj4.comparator(sortedSet);
    ...
    public E ceiling(E e) {
        return (E) k52.getFirst(tailSet((Object) e, true), null);
    }

    @Override // java.util.SortedSet, defpackage.oj4
    ...
    @Override // java.util.NavigableSet
    public abstract s05 descendingIterator();
    ...
    @Override // java.util.NavigableSet
    public E higher(E e) {
        return (E) k52.getFirst(tailSet((Object) e, false), null);
    }
    ...
    public ImmutableSortedSet<E> headSet(E e, boolean z) {
        return headSetImpl(tk3.checkNotNull(e), z);
    }
    ...
    public ImmutableSortedSet<E> subSet(E e, boolean z, E e2, boolean z2) {
        tk3.checkNotNull(e);
        tk3.checkNotNull(e2);
        tk3.checkArgument(this.comparator.compare(e, e2) <= 0);
    ...
    public ImmutableSortedSet<E> tailSet(E e, boolean z) {
        return tailSetImpl(tk3.checkNotNull(e), z);
    }
    ...
    public static <E> ImmutableSortedSet<E> copyOf(Comparator<? super E> comparator, Iterator<? extends E> it2) {
        return (ImmutableSortedSet<E>) new a(comparator).addAll((Iterator<Object>) it2).build();
    }

    public static <E> ImmutableSortedSet<E> copyOf(Comparator<? super E> comparator, Iterable<? extends E> iterable) {
        tk3.checkNotNull(comparator);
        if (pj4.hasSameComparator(comparator, iterable) && (iterable instanceof ImmutableSortedSet)) {
        ...
        return construct(comparator, objArrB.length, objArrB);
    }
