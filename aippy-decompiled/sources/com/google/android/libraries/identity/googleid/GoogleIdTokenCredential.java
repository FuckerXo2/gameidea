...
public final class GoogleIdTokenCredential extends CustomCredential {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final GoogleIdTokenCredential createFrom(@NonNull Bundle data) throws GoogleIdTokenParsingException {
    ...
    public GoogleIdTokenCredential(@NonNull String id, @NonNull String idToken, String str, String str2, String str3, Uri uri, String str4) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(idToken, "idToken");
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(idToken, "idToken");
