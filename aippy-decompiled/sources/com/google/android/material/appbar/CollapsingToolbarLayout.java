...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.extraMultilineHeightEnabled || this.collapsingTextHelper.getMaxLines() <= 1) {
            ...
            int lineCount = collapsingToolbarLayout.collapsingTextHelper.getLineCount();
            if (lineCount > 1) {
                collapsingToolbarLayout.extraMultilineHeight = Math.round(collapsingToolbarLayout.collapsingTextHelper.getExpandedTextFullHeight()) * (lineCount - 1);
