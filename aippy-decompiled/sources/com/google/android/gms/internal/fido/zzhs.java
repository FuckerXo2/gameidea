...
public final class zzhs implements Closeable {
    ...
    public final long zza() throws IOException {
        ...
        long jZzh = zzh();
        if (jZzh < 0) {
            throw new UnsupportedOperationException(String.format("the maximum supported array length is %s", Long.valueOf(LocationRequestCompat.PASSIVE_INTERVAL)));
        }
        if (jZzh > 0) {
            this.zzd.zzg(jZzh);
        }
    ...
    public final long zzb() throws IOException {
        ...
        throw new UnsupportedOperationException(String.format("the maximum supported unsigned/negative integer is %s", Long.valueOf(LocationRequestCompat.PASSIVE_INTERVAL)));
    }
