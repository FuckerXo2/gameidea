...
final class zzom {
    public static /* bridge */ /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzmm {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zzmm {
        if (b < -62 || zze(b2)) {
            throw new zzmm("Protocol message had invalid UTF-8.");
        }
