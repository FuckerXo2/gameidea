...
public final class zzb {
    ...
    public static c zze(Intent intent, String str) {
        if (intent != null) {
            c.a aVarNewBuilder = c.newBuilder();
            aVarNewBuilder.setResponseCode(zzb(intent.getExtras(), str));
            aVarNewBuilder.setDebugMessage(zzg(intent.getExtras(), str));
            return aVarNewBuilder.build();
        }
        zzk("BillingHelper", "Got null intent!");
        c.a aVarNewBuilder2 = c.newBuilder();
        aVarNewBuilder2.setResponseCode(6);
        aVarNewBuilder2.setDebugMessage("An internal error occurred.");
        return aVarNewBuilder2.build();
    }

    public static d02 zzf(Bundle bundle, String str) {
        return bundle == null ? new d02(0, null) : new d02(zzm(bundle, "BillingClient"), bundle.getString("IN_APP_MESSAGE_PURCHASE_TOKEN"));
    }
