...
final class aw implements y {
    ...
    /* JADX WARN: Type inference failed for: r5v0, types: [com.google.android.play.core.assetpacks.aa] */
    /* JADX WARN: Type inference failed for: r7v0, types: [com.google.android.play.core.assetpacks.aa] */
    public aw(Context context, co coVar, ea eaVar) {
        ...
        if (com.google.android.play.core.assetpacks.internal.ai.b(context)) {
            ...
            Intent intent = b;
            this.f = new com.google.android.play.core.assetpacks.internal.z(contextA, oVar, "AssetPackService", intent, new Object() { // from class: com.google.android.play.core.assetpacks.aa
            }, null);
            this.g = new com.google.android.play.core.assetpacks.internal.z(com.google.android.play.core.assetpacks.internal.ag.a(context), oVar, "AssetPackService-keepAlive", intent, new Object() { // from class: com.google.android.play.core.assetpacks.aa
            }, null);
        }
    ...
    public static /* bridge */ /* synthetic */ List w(aw awVar, List list) {
        ...
        while (it2.hasNext()) {
            AssetPackState next = AssetPackStates.a((Bundle) it2.next(), awVar.d, awVar.e).packStates().values().iterator().next();
            if (next == null) {
