...
public final class BatchRequest {
    ...
    public void execute() throws IOException {
        ...
        do {
            ...
            int i = 1;
            while (it2.hasNext()) {
                multipartContent.addPart(new MultipartContent.Part(new HttpHeaders().setAcceptEncoding(null).set("Content-ID", (Object) Integer.valueOf(i)), new HttpRequestContent(it2.next().request)));
                i++;
            }
