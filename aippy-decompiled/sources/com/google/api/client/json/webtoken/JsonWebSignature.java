...
public class JsonWebSignature extends JsonWebToken {
    ...
    public static String signUsingRsaSha256(PrivateKey privateKey, JsonFactory jsonFactory, Header header, JsonWebToken.Payload payload) throws GeneralSecurityException, IOException {
        String strValueOf = String.valueOf(Base64.encodeBase64URLSafeString(jsonFactory.toByteArray(header)));
        String strValueOf2 = String.valueOf(Base64.encodeBase64URLSafeString(jsonFactory.toByteArray(payload)));
        ...
        String strValueOf4 = String.valueOf(Base64.encodeBase64URLSafeString(bArrSign));
        StringBuilder sb2 = new StringBuilder(strValueOf3.length() + 1 + strValueOf4.length());
