...
public class Credential implements HttpExecuteInterceptor, HttpRequestInitializer, HttpUnsuccessfulResponseHandler {
    ...
    */
    public void intercept(com.google.api.client.http.HttpRequest r5) throws java.io.IOException {
        /*
            r4 = this;
        ...
        try {
            try {
                ...
                if (tokenResponseExecuteRefreshToken != null) {
                    ...
                    while (it2.hasNext()) {
                        it2.next().onTokenResponse(this, tokenResponseExecuteRefreshToken);
                    }
                    return true;
                }
                ...
                Iterator<CredentialRefreshListener> it3 = this.refreshListeners.iterator();
                while (it3.hasNext()) {
