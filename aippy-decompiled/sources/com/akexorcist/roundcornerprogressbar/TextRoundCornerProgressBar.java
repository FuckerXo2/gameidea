...
public class TextRoundCornerProgressBar extends AnimatedRoundCornerProgressBar implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void initStyleable(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.TextRoundCornerProgressBar);
        this.colorTextProgress = typedArrayObtainStyledAttributes.getColor(R$styleable.TextRoundCornerProgressBar_rcTextProgressColor, -1);
        this.textProgressSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.TextRoundCornerProgressBar_rcTextProgressSize, dp2px(16.0f));
        this.textProgressMargin = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.TextRoundCornerProgressBar_rcTextProgressMargin, dp2px(10.0f));
        this.textProgress = typedArrayObtainStyledAttributes.getString(R$styleable.TextRoundCornerProgressBar_rcTextProgress);
        this.textInsideGravity = typedArrayObtainStyledAttributes.getInt(R$styleable.TextRoundCornerProgressBar_rcTextInsideGravity, 0);
        this.textOutsideGravity = typedArrayObtainStyledAttributes.getInt(R$styleable.TextRoundCornerProgressBar_rcTextOutsideGravity, 0);
        this.textPositionPriority = typedArrayObtainStyledAttributes.getInt(R$styleable.TextRoundCornerProgressBar_rcTextPositionPriority, 0);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.colorTextProgress = savedState.a;
        this.textProgressSize = savedState.b;
        this.textProgressMargin = savedState.c;
        this.textProgress = savedState.d;
        this.textInsideGravity = savedState.e;
        this.textOutsideGravity = savedState.f;
        this.textPositionPriority = savedState.g;
    }

    @Override // com.akexorcist.roundcornerprogressbar.common.AnimatedRoundCornerProgressBar, com.akexorcist.roundcornerprogressbar.common.BaseRoundCornerProgressBar, android.view.View
    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.a = this.colorTextProgress;
        savedState.b = this.textProgressSize;
        savedState.c = this.textProgressMargin;
        savedState.d = this.textProgress;
        savedState.e = this.textInsideGravity;
        savedState.f = this.textOutsideGravity;
        savedState.g = this.textPositionPriority;
        return savedState;
    }
