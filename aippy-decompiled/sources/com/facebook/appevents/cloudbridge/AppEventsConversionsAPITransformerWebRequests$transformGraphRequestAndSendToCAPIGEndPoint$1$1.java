...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"<anonymous>", "", "<anonymous parameter 0>", "", "responseCode", "", "invoke", "(Ljava/lang/String;Ljava/lang/Integer;)V"}, k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
public final class AppEventsConversionsAPITransformerWebRequests$transformGraphRequestAndSendToCAPIGEndPoint$1$1 extends Lambda implements Function2<String, Integer, Unit> {
    ...
    public static final void invoke$lambda$0(Integer num, List processedEvents) {
        ...
        if (y30.contains(AppEventsConversionsAPITransformerWebRequests.b, num)) {
            return;
        }
        AppEventsConversionsAPITransformerWebRequests.a.handleError$facebook_core_release(num, processedEvents, 5);
    }
    ...
    public final void invoke2(String str, final Integer num) {
        ...
        e.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.cloudbridge.a
