...
public class RecyclableBufferedInputStream extends FilterInputStream {
    ...
    public RecyclableBufferedInputStream(@NonNull InputStream inputStream, @NonNull yd ydVar) {
        this(inputStream, ydVar, 65536);
    }
    ...
    public RecyclableBufferedInputStream(InputStream inputStream, yd ydVar, int i) {
        super(inputStream);
        this.d = -1;
        this.f = ydVar;
        this.a = (byte[]) ydVar.get(i, byte[].class);
    }
