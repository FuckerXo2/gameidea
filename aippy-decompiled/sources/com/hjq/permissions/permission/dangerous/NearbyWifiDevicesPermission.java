...
public final class NearbyWifiDevicesPermission extends DangerousPermission {
    ...
    public class a implements Parcelable.Creator {
        ...
        @Override // android.os.Parcelable.Creator
        public NearbyWifiDevicesPermission[] newArray(int i) {
            return new NearbyWifiDevicesPermission[i];
        }
    }

    public /* synthetic */ NearbyWifiDevicesPermission(Parcel parcel, a aVar) {
        this(parcel);
    }
    ...
    public void e(Activity activity, List list, v8 v8Var, List list2, ch3 ch3Var) {
        ...
        if (getFromAndroidVersion(activity) > BasePermission.l(activity, v8Var)) {
            BasePermission.d(list2, "android.permission.ACCESS_FINE_LOCATION", 32);
        }
    ...
    public String getPermissionGroup(@NonNull Context context) {
        return oh3.isAndroid13() ? "nearby_devices_group" : "location_group";
    }
