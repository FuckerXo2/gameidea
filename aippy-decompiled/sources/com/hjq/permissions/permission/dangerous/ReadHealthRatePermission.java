...
public final class ReadHealthRatePermission extends HealthDataBasePermission {
    ...
    public class a implements Parcelable.Creator {
        ...
        @Override // android.os.Parcelable.Creator
        public ReadHealthRatePermission[] newArray(int i) {
            return new ReadHealthRatePermission[i];
        }
    }

    public /* synthetic */ ReadHealthRatePermission(Parcel parcel, a aVar) {
        this(parcel);
    }
    ...
    public void e(Activity activity, List list, v8 v8Var, List list2, ch3 ch3Var) {
        ...
        if (getFromAndroidVersion(activity) > BasePermission.l(activity, v8Var)) {
            BasePermission.d(list2, "android.permission.BODY_SENSORS", 33);
        }
    }
