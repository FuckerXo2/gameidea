...
public final class RequestInstallPackagesPermission extends SpecialPermission {
    ...
    public class a implements Parcelable.Creator {
        ...
        @Override // android.os.Parcelable.Creator
        public RequestInstallPackagesPermission[] newArray(int i) {
            return new RequestInstallPackagesPermission[i];
        }
    }

    public /* synthetic */ RequestInstallPackagesPermission(Parcel parcel, a aVar) {
        this(parcel);
    }
