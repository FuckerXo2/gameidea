...
import com.nadaai.aippy.databinding.FragmentFollowingBinding;
...
public class FollowingFragment extends CommonMvvmFragment<FragmentFollowingBinding, FollowListViewModel> {
    ...
    public class a implements p53 {
        ...
        public void onItemClick(BaseQuickAdapter<?, ?> baseQuickAdapter, View view, int i) {
            Friend item = FollowingFragment.this.mAdapter.getItem(i);
            if (item == null || item.getUid() <= 0) {
                return;
            }
            Bundle bundle = new Bundle();
            bundle.putLong("uid", item.getUid());
            bundle.putInt("profile_from", 41);
            FollowingFragment.this.startContainerActivity(ProfileFragment.class.getCanonicalName(), bundle);
        }
    }
    ...
    public class b implements v53 {
        ...
        public void onLoadMore() {
            pf2.d("FollowingFragment", "onLoadMore triggered");
            if (((BaseMvvmFragment) FollowingFragment.this).mViewModel != null) {
                ((FollowListViewModel) ((BaseMvvmFragment) FollowingFragment.this).mViewModel).loadMore();
            } else {
                pf2.e("FollowingFragment", "onLoadMore: mViewModel is null");
            }
        }
    }
    ...
    public class c implements FollowListViewModel.d {
        ...
        public void onError(String str) {
            ...
            FollowingFragment.this.showShortToast(str);
        }
        ...
        public void onSuccess(boolean z) {
            ...
            if (FollowingFragment.this.mAdapter != null) {
                FollowingFragment.this.mAdapter.notifyItemChanged(this.b);
            }
        }
    }
    ...
    public /* synthetic */ void lambda$observeData$3(List list) {
        ...
        boolean z = friendListAdapter == null || friendListAdapter.getData().isEmpty();
        updateData(list);
        if (this.mAdapter == null || list == null || list.isEmpty() || this.mAdapter.getLoadMoreModule() == null) {
            return;
        }
        this.mAdapter.getLoadMoreModule().setEnableLoadMore(true);
        if (z || this.mAdapter.getData().size() == list.size()) {
    ...
    public /* synthetic */ void lambda$observeData$4(Boolean bool) {
        ...
        ((FragmentFollowingBinding) this.mBinding).c.setRefreshing(false);
    }
    ...
    public /* synthetic */ void lambda$setupRecyclerView$1(final Friend friend, final int i) {
        ...
        unfollowConfirmDialogNewInstance.setOnConfirmListener(new UnfollowConfirmDialog.b() { // from class: ef1
    ...
    public static FollowingFragment newInstance(long j) {
    ...
    private void observeData() {
        ...
        ((FollowListViewModel) vm).f.observe(this, new Observer() { // from class: gf1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                this.a.lambda$observeData$3((List) obj);
            }
        });
        ((FollowListViewModel) this.mViewModel).g.observe(this, new Observer() { // from class: hf1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                this.a.lambda$observeData$4((Boolean) obj);
            }
        });
        ((FollowListViewModel) this.mViewModel).h.observe(this, new Observer() { // from class: if1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                this.a.lambda$observeData$5((Boolean) obj);
            }
        });
        ((FollowListViewModel) this.mViewModel).i.observe(this, new Observer() { // from class: jf1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                this.a.lambda$observeData$6((Boolean) obj);
            }
        });
        ((FollowListViewModel) this.mViewModel).j.observe(this, new Observer() { // from class: kf1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
    ...
    private void reportProjectFollowClick(Friend friend) {
        ...
        try {
            ...
            pf2.e("FollowingFragment", "上报 project_follow_click 埋点失败: " + e.getMessage());
        }
    }

    private void setupRecyclerView() {
        this.mAdapter = new FriendListAdapter();
        ((FragmentFollowingBinding) this.mBinding).b.setLayoutManager(new LinearLayoutManager(getContext()));
        this.mAdapter.setOnItemClickListener(new a());
        this.mAdapter.setOnFollowClickListener(new FriendListAdapter.a() { // from class: df1
        ...
        ((FragmentFollowingBinding) this.mBinding).b.setAdapter(this.mAdapter);
    }

    private void setupSwipeRefresh() {
        ((FragmentFollowingBinding) this.mBinding).c.setEnabled(true);
        ((FragmentFollowingBinding) this.mBinding).c.setProgressBackgroundColorSchemeColor(Color.parseColor("#000000"));
        ((FragmentFollowingBinding) this.mBinding).c.setColorSchemeColors(Color.parseColor("#FFFFFF"));
        ((FragmentFollowingBinding) this.mBinding).c.setNestedScrollingEnabled(true);
        ((FragmentFollowingBinding) this.mBinding).c.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: ff1
    ...
    private void updateEmptyViewState() {
        if (this.mAdapter.getData().isEmpty()) {
            ((FragmentFollowingBinding) this.mBinding).a.setVisibility(0);
        } else {
            ((FragmentFollowingBinding) this.mBinding).a.setVisibility(8);
        }
    }
    ...
    public void initView() {
        super.initView();
        ew2.getDefault().register(this, p25.class, new gr() { // from class: cf1
        ...
        VM vm = this.mViewModel;
        if (vm != 0) {
            ((FollowListViewModel) vm).setListType(1);
