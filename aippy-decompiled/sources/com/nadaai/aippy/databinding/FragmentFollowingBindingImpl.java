...
public class FragmentFollowingBindingImpl extends FragmentFollowingBinding {
    ...
    public FragmentFollowingBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    @Override // com.nadaai.aippy.databinding.FragmentFollowingBinding
    public void setVm(@Nullable FollowListViewModel followListViewModel) {
        this.e = followListViewModel;
    }

    private FragmentFollowingBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
