...
public abstract class ItemMessageCommentBinding extends ViewDataBinding {
    ...
    @Deprecated
    public static ItemMessageCommentBinding bind(@NonNull View view, @Nullable Object obj) {
        return (ItemMessageCommentBinding) ViewDataBinding.bind(obj, view, R.layout.item_message_comment);
    }

    @NonNull
    @Deprecated
    public static ItemMessageCommentBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable Object obj) {
    ...
    @NonNull
    @Deprecated
    public static ItemMessageCommentBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable Object obj) {
