...
public abstract class FragmentFollowersBinding extends ViewDataBinding {
    ...
    public FragmentFollowersBinding(Object obj, View view, int i, LinearLayout linearLayout, RecyclerView recyclerView, SwipeRefreshLayout swipeRefreshLayout, AppCompatTextView appCompatTextView) {
        super(obj, view, i);
        this.a = linearLayout;
        this.b = recyclerView;
