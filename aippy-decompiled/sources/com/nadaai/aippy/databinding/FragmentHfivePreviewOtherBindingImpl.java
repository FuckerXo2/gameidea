...
public class FragmentHfivePreviewOtherBindingImpl extends FragmentHfivePreviewOtherBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.divider_report, 28);
        sparseIntArray.put(R.id.menu_report, 29);
        sparseIntArray.put(R.id.divider_edit, 30);
        sparseIntArray.put(R.id.menu_edit, 31);
        sparseIntArray.put(R.id.btn_back, 32);
    }

    public FragmentHfivePreviewOtherBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    */
    public void executeBindings() {
        /*
            ...
            r1 = r20
            monitor-enter(r20)
            long r2 = r1.O     // Catch: java.lang.Throwable -> La6
            r4 = 0
            r1.O = r4     // Catch: java.lang.Throwable -> La6
            monitor-exit(r20)     // Catch: java.lang.Throwable -> La6
            com.nadaai.aippy.module.main.HFivePreviewOtherViewModel r0 = r1.M
            r6 = 31
            long r6 = r6 & r2
        ...
        L81:
            ...
            if (r5 == 0) goto L90
            androidx.appcompat.widget.AppCompatTextView r5 = r1.D
            androidx.databinding.adapters.TextViewBindingAdapter.setText(r5, r13)
            androidx.appcompat.widget.AppCompatTextView r5 = r1.G
        ...
        L9b:
            ...
            if (r2 == 0) goto La5
            androidx.appcompat.widget.AppCompatTextView r2 = r1.H
        ...
        La6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nadaai.aippy.databinding.FragmentHfivePreviewOtherBindingImpl.executeBindings():void");
    }
    ...
    public boolean setVariable(int i, @Nullable Object obj) {
        ...
        setVm((HFivePreviewOtherViewModel) obj);
        return true;
    }

    @Override // com.nadaai.aippy.databinding.FragmentHfivePreviewOtherBinding
    public void setVm(@Nullable HFivePreviewOtherViewModel hFivePreviewOtherViewModel) {
        this.M = hFivePreviewOtherViewModel;
        synchronized (this) {
            this.O |= 8;
        }
    ...
    private FragmentHfivePreviewOtherBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 3, (ImageView) objArr[32], (ImageView) objArr[19], (ImageView) objArr[18], (ImageView) objArr[12], (View) objArr[30], (View) objArr[28], (ImageView) objArr[20], (ImageView) objArr[21], (ImageView) objArr[15], (AppCompatImageView) objArr[24], (LinearLayout) objArr[13], (ConstraintLayout) objArr[9], (LinearLayout) objArr[14], (LinearLayout) objArr[10], (LinearLayout) objArr[11], (LinearLayout) objArr[23], (LottieAnimationView) objArr[22], (LottieAnimationView) objArr[16], (LinearLayout) objArr[31], (CardView) objArr[26], (LinearLayout) objArr[27], (LinearLayout) objArr[29], (View) objArr[25], (AppCompatTextView) objArr[4], (AppCompatTextView) objArr[2], (AppCompatTextView) objArr[17], (AppCompatTextView) objArr[3], (AppCompatTextView) objArr[1], (View) objArr[8], (View) objArr[5], (NoScrollWebView) objArr[7], (FrameLayout) objArr[6]);
        this.O = -1L;
