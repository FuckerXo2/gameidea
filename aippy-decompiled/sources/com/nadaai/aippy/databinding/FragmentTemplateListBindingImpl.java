...
public class FragmentTemplateListBindingImpl extends FragmentTemplateListBinding {
    ...
    public boolean setVariable(int i2, @Nullable Object obj) {
        ...
        setVm((TemplateListViewModel) obj);
        return true;
    }

    @Override // com.nadaai.aippy.databinding.FragmentTemplateListBinding
    public void setVm(@Nullable TemplateListViewModel templateListViewModel) {
        this.e = templateListViewModel;
    }

    private FragmentTemplateListBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
