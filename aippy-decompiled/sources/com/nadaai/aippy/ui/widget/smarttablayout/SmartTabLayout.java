...
public class SmartTabLayout extends HorizontalScrollView {
            ...
            for (int i = 0; i < SmartTabLayout.this.a.getChildCount(); i++) {
                if (view == SmartTabLayout.this.a.getChildAt(i)) {
                    if (SmartTabLayout.this.p != null) {
                        SmartTabLayout.this.p.onTabClicked(i);
                    }
    ...
    public static class e implements g {
        ...
        @Override // com.nadaai.aippy.ui.widget.smarttablayout.SmartTabLayout.g
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            g gVar = this.k;
            View viewD = gVar == null ? d(adapter.getPageTitle(i)) : gVar.createTabView(this.a, i, adapter);
            if (viewD == null) {
    ...
    public SmartTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.nadaai.aippy.R.styleable.stl_SmartTabLayout, i, 0);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabBackground, -1);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabTextAllCaps, true);
        ColorStateList colorStateList = typedArrayObtainStyledAttributes.getColorStateList(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabTextColor);
        float dimension = typedArrayObtainStyledAttributes.getDimension(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabTextSize, fApplyDimension);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalPadding, (int) (16.0f * f2));
        int dimensionPixelSize2 = typedArrayObtainStyledAttributes.getDimensionPixelSize(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth, (int) (0.0f * f2));
        int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId, -1);
        int resourceId3 = typedArrayObtainStyledAttributes.getResourceId(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_customTabTextViewId, -1);
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_distributeEvenly, false);
        boolean z3 = typedArrayObtainStyledAttributes.getBoolean(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_clickable, true);
        int layoutDimension = typedArrayObtainStyledAttributes.getLayoutDimension(com.nadaai.aippy.R.styleable.stl_SmartTabLayout_stl_titleOffset, (int) (f2 * 24.0f));
