    ...
    */
    ...
    public void smoothScroll(final int i, final boolean z) {
        post(new Runnable() { // from class: com.lxj.xpopup.widget.SmartDragLayout.3
            ...
            public void run() {
                SmartDragLayout smartDragLayout = SmartDragLayout.this;
                smartDragLayout.scroller.startScroll(smartDragLayout.getScrollX(), SmartDragLayout.this.getScrollY(), 0, i, (int) (z ? SmartDragLayout.this.duration : SmartDragLayout.this.duration * 0.8f));
    ...
    public SmartDragLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.duration = HttpStatusCodes.STATUS_CODE_BAD_REQUEST;
