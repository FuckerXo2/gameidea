...
public abstract class o {
    public static qg5 a(Bundle bundle, String str, String str2) {
        c cVar = h.j;
        if (bundle == null) {
            zzb.zzk("BillingClient", String.format("%s got null owned items list", str2));
            return new qg5(cVar, 54);
        }
