...
public class SimpleArrayMap<K, V> {
    ...
    public V put(K key, V value) {
        ...
        if (i3 < i) {
            ...
            int i5 = i3 + 1;
            ee.copyInto(iArr2, iArr2, i5, i3, i);
            Object[] objArr2 = this.array;
            ee.copyInto(objArr2, objArr2, i5 << 1, i3 << 1, this.size << 1);
        }
        int i6 = this.size;
        if (i == i6) {
    ...
    public void putAll(SimpleArrayMap<? extends K, ? extends V> map) {
        ...
        if (this.size != 0) {
            ...
            ee.copyInto(map.hashes, this.hashes, 0, 0, i);
            ee.copyInto(map.array, this.array, 0, 0, i << 1);
            this.size = i;
        }
    }
    ...
    public V removeAt(int index) {
        ...
        if (iArr.length <= 8 || i >= iArr.length / 3) {
            if (index < i3) {
                int i4 = index + 1;
                ee.copyInto(iArr, iArr, index, i4, i);
                Object[] objArr2 = this.array;
                ee.copyInto(objArr2, objArr2, i2, i4 << 1, i << 1);
            }
            Object[] objArr3 = this.array;
            int i5 = i3 << 1;
            objArr3[i5] = null;
            ...
            if (index > 0) {
                ee.copyInto(iArr, this.hashes, 0, 0, index);
                ee.copyInto(objArr, this.array, 0, 0, i2);
            }
            if (index < i3) {
                int i7 = index + 1;
                ee.copyInto(iArr, this.hashes, index, i7, i);
                ee.copyInto(objArr, this.array, i2, i7 << 1, i << 1);
            }
        }
        if (i != this.size) {
            throw new ConcurrentModificationException();
