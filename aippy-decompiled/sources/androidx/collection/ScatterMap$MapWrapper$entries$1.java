...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, rf2 {
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return d84.iterator(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
    }
