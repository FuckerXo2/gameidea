...
@jp0(c = "androidx.collection.ScatterSet$SetWrapper$iterator$1", f = "ScatterSet.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {495}, m = "invokeSuspend", n = {"$this$iterator", "k$iv", "m$iv$iv", "lastIndex$iv$iv", "i$iv$iv", "slot$iv$iv", "bitCount$iv$iv", "j$iv$iv"}, s = {"L$0", "L$1", "L$2", "I$0", "I$1", "J$0", "I$2", "I$3"})
public final class ScatterSet$SetWrapper$iterator$1 extends RestrictedSuspendLambda implements Function2<c84, kd0<? super Unit>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterSet$SetWrapper$iterator$1(ScatterSet<E> scatterSet, kd0<? super ScatterSet$SetWrapper$iterator$1> kd0Var) {
        super(2, kd0Var);
    ...
    public final kd0<Unit> create(Object obj, kd0<?> kd0Var) {
        ScatterSet$SetWrapper$iterator$1 scatterSet$SetWrapper$iterator$1 = new ScatterSet$SetWrapper$iterator$1(this.this$0, kd0Var);
    ...
    public final Object invoke(c84 c84Var, kd0<? super Unit> kd0Var) {
        return ((ScatterSet$SetWrapper$iterator$1) create(c84Var, kd0Var)).invokeSuspend(Unit.a);
    }
