...
public final class ArraySet<E> implements Collection<E>, Set<E>, sf2, cg2 {
    private int _size;
    ...
    public boolean add(E element) {
        ...
        if (i2 >= getHashes().length) {
            ...
            if (!(getHashes().length == 0)) {
                ee.copyInto$default(hashes, getHashes(), 0, 0, hashes.length, 6, (Object) null);
                ee.copyInto$default(array, getArray(), 0, 0, array.length, 6, (Object) null);
            }
        }
        if (i3 < i2) {
            int i5 = i3 + 1;
            ee.copyInto(getHashes(), getHashes(), i5, i3, i2);
            ee.copyInto(getArray(), getArray(), i5, i3, i2);
        }
    ...
    public final void addAll(ArraySet<? extends E> array) {
        ...
        if (i > 0) {
            ee.copyInto$default(array.getHashes(), getHashes(), 0, 0, i, 6, (Object) null);
            ee.copyInto$default(array.getArray(), getArray(), 0, 0, i, 6, (Object) null);
            if (get_size$collection() != 0) {
                throw new ConcurrentModificationException();
            }
    ...
    public final void ensureCapacity(int minimumCapacity) {
        ...
        if (getHashes().length < minimumCapacity) {
            ...
            if (get_size$collection() > 0) {
                ee.copyInto$default(hashes, getHashes(), 0, 0, get_size$collection(), 6, (Object) null);
                ee.copyInto$default(array, getArray(), 0, 0, get_size$collection(), 6, (Object) null);
            }
        }
    ...
    public final E removeAt(int index) {
        ...
        if (getHashes().length <= 8 || get_size$collection() >= getHashes().length / 3) {
            if (index < i3) {
                int i4 = index + 1;
                ee.copyInto(getHashes(), getHashes(), index, i4, i2);
                ee.copyInto(getArray(), getArray(), index, i4, i2);
            }
            getArray()[i3] = null;
        } else {
            ...
            if (index > 0) {
                ee.copyInto$default(hashes, getHashes(), 0, 0, index, 6, (Object) null);
                objArr = array;
                ee.copyInto$default(objArr, getArray(), 0, 0, index, 6, (Object) null);
                i = index;
            } else {
                i = index;
                objArr = array;
            ...
            if (i < i3) {
                int i6 = i + 1;
                ee.copyInto(hashes, getHashes(), i, i6, i2);
                ee.copyInto(objArr, getArray(), i, i6, i2);
            }
        }
        if (i2 != get_size$collection()) {
            throw new ConcurrentModificationException();
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        for (int i = get_size$collection() - 1; -1 < i; i--) {
            if (!y30.contains(elements, getArray()[i])) {
                removeAt(i);
                z = true;
            }
        }
    ...
    public final Object[] toArray() {
        return ee.copyOfRange(this.array, 0, this._size);
    }
    ...
    public final <T> T[] toArray(T[] array) {
        ...
        ee.copyInto(this.array, result, 0, 0, this._size);
