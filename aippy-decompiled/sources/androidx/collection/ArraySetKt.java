...
public final class ArraySetKt {
    ...
    public static final <E> void addAllInternal(ArraySet<E> arraySet, ArraySet<? extends E> array) {
        ...
        if (i > 0) {
            ee.copyInto$default(array.getHashes(), arraySet.getHashes(), 0, 0, i, 6, (Object) null);
            ee.copyInto$default(array.getArray(), arraySet.getArray(), 0, 0, i, 6, (Object) null);
            if (arraySet.get_size$collection() != 0) {
    ...
    public static final <E> boolean addInternal(ArraySet<E> arraySet, E e) {
        ...
        if (i2 >= arraySet.getHashes().length) {
            ...
            if (!(arraySet.getHashes().length == 0)) {
                ee.copyInto$default(hashes, arraySet.getHashes(), 0, 0, hashes.length, 6, (Object) null);
                ee.copyInto$default(array, arraySet.getArray(), 0, 0, array.length, 6, (Object) null);
            }
        }
        if (i3 < i2) {
            int i5 = i3 + 1;
            ee.copyInto(arraySet.getHashes(), arraySet.getHashes(), i5, i3, i2);
            ee.copyInto(arraySet.getArray(), arraySet.getArray(), i5, i3, i2);
        }
    ...
    public static final <E> void ensureCapacityInternal(ArraySet<E> arraySet, int i) {
        ...
        if (arraySet.getHashes().length < i) {
            ...
            if (arraySet.get_size$collection() > 0) {
                ee.copyInto$default(hashes, arraySet.getHashes(), 0, 0, arraySet.get_size$collection(), 6, (Object) null);
                ee.copyInto$default(array, arraySet.getArray(), 0, 0, arraySet.get_size$collection(), 6, (Object) null);
            }
        }
    ...
    public static final <E> E removeAtInternal(ArraySet<E> arraySet, int i) {
        ...
        if (arraySet.getHashes().length <= 8 || arraySet.get_size$collection() >= arraySet.getHashes().length / 3) {
            if (i < i4) {
                int i5 = i + 1;
                ee.copyInto(arraySet.getHashes(), arraySet.getHashes(), i, i5, i3);
                ee.copyInto(arraySet.getArray(), arraySet.getArray(), i, i5, i3);
            }
            ...
            if (i > 0) {
                ee.copyInto$default(hashes, arraySet.getHashes(), 0, 0, i, 6, (Object) null);
                objArr = array;
                ee.copyInto$default(objArr, arraySet.getArray(), 0, 0, i, 6, (Object) null);
                i2 = i;
            } else {
                i2 = i;
                objArr = array;
            ...
            if (i2 < i4) {
                int i7 = i2 + 1;
                ee.copyInto(hashes, arraySet.getHashes(), i2, i7, i3);
                ee.copyInto(objArr, arraySet.getArray(), i2, i7, i3);
            }
        }
    ...
    public static final <E> boolean retainAllInternal(ArraySet<E> arraySet, Collection<? extends E> elements) {
        ...
        for (int i = arraySet.get_size$collection() - 1; -1 < i; i--) {
            if (!y30.contains(elements, arraySet.getArray()[i])) {
                arraySet.removeAt(i);
                z = true;
            }
        }
