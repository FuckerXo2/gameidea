...
@jp0(c = "androidx.collection.ScatterMap$MapWrapper$keys$1$iterator$1", f = "ScatterMap.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {726}, m = "invokeSuspend", n = {"$this$iterator", "k$iv", "m$iv$iv", "lastIndex$iv$iv", "i$iv$iv", "slot$iv$iv", "bitCount$iv$iv", "j$iv$iv"}, s = {"L$0", "L$1", "L$2", "I$0", "I$1", "J$0", "I$2", "I$3"})
public final class ScatterMap$MapWrapper$keys$1$iterator$1 extends RestrictedSuspendLambda implements Function2<c84, kd0<? super Unit>, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterMap$MapWrapper$keys$1$iterator$1(ScatterMap<K, V> scatterMap, kd0<? super ScatterMap$MapWrapper$keys$1$iterator$1> kd0Var) {
        super(2, kd0Var);
    ...
    public final kd0<Unit> create(Object obj, kd0<?> kd0Var) {
        ScatterMap$MapWrapper$keys$1$iterator$1 scatterMap$MapWrapper$keys$1$iterator$1 = new ScatterMap$MapWrapper$keys$1$iterator$1(this.this$0, kd0Var);
    ...
    public final Object invoke(c84 c84Var, kd0<? super Unit> kd0Var) {
        return ((ScatterMap$MapWrapper$keys$1$iterator$1) create(c84Var, kd0Var)).invokeSuspend(Unit.a);
    }
