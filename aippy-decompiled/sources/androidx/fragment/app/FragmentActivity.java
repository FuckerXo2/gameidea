...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: ng1
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return FragmentActivity.f(this.a);
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: og1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.a.mFragments.noteStateNotSaved();
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: pg1
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.a.mFragments.noteStateNotSaved();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: qg1
