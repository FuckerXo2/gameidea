...
public class ShortcutManagerCompat {
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!eg4.a(context.getSystemService(tf4.a())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? eg4.a(context.getSystemService(tf4.a())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            eg4.a(context.getSystemService(tf4.a())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            eg4.a(context.getSystemService(tf4.a())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it3 = getShortcutInfoListeners(context).iterator();
        while (it3.hasNext()) {
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        ...
        List dynamicShortcuts = eg4.a(context.getSystemService(tf4.a())).getDynamicShortcuts();
        ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
        Iterator it2 = dynamicShortcuts.iterator();
        while (it2.hasNext()) {
            arrayList.add(new ShortcutInfoCompat.Builder(context, me4.a(it2.next())).build());
        }
        return arrayList;
    }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? eg4.a(context.getSystemService(tf4.a())).getIconMaxHeight() : getIconDimensionInternal(context, false);
    }

    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? eg4.a(context.getSystemService(tf4.a())).getIconMaxWidth() : getIconDimensionInternal(context, true);
    }

    public static int getMaxShortcutCountPerActivity(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return eg4.a(context.getSystemService(tf4.a())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        ...
        if (i2 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, eg4.a(context.getSystemService(tf4.a())).getShortcuts(i));
        }
        if (i2 < 25) {
            if ((i & 2) != 0) {
                try {
        ...
        ShortcutManager shortcutManagerA = eg4.a(context.getSystemService(tf4.a()));
        ArrayList arrayList = new ArrayList();
        if ((i & 1) != 0) {
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? eg4.a(context.getSystemService(tf4.a())).isRateLimitingActive() : getShortcuts(context, 3).size() == getMaxShortcutCountPerActivity(context);
    }

    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return eg4.a(context.getSystemService(tf4.a())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i >= 30) {
            eg4.a(context.getSystemService(tf4.a())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (i >= 25) {
            ShortcutManager shortcutManagerA = eg4.a(context.getSystemService(tf4.a()));
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            eg4.a(context.getSystemService(tf4.a())).removeAllDynamicShortcuts();
        }
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            eg4.a(context.getSystemService(tf4.a())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        eg4.a(context.getSystemService(tf4.a())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
            it2.next().onShortcutRemoved(list);
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            eg4.a(context.getSystemService(tf4.a())).reportShortcutUsed(str);
        }
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (i >= 26) {
            return eg4.a(context.getSystemService(tf4.a())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!eg4.a(context.getSystemService(tf4.a())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!eg4.a(context.getSystemService(tf4.a())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
