...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    addPerson(Person.fromAndroidPerson(j23.a(it3.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
    ...
    public static class CallStyle extends Style {
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(j23.a(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            if (!l23.a().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(o23.a().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(l23.a().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(j23.a(it2.next())));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                while (it2.hasNext()) {
                    Api24Impl.addMessage(n23.a(messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it3 = this.mHistoricMessages.iterator();
                    while (it3.hasNext()) {
                        Api26Impl.addHistoricMessage(n23.a(messagingStyleCreateMessagingStyle), it3.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(n23.a(messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(n23.a(messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
