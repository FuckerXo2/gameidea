...
public final class ViewGroupCompat {
    ...
    public static WindowInsets dispatchApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: h55
    ...
    public static void installCompatInsetsDispatch(View view) {
        ...
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = new View.OnApplyWindowInsetsListener() { // from class: i55
            @Override // android.view.View.OnApplyWindowInsetsListener
