...
public final class AuthenticatorAttestationResponse implements AuthenticatorResponse {
    ...
    private final byte[] authData() throws NoSuchAlgorithmException {
        ...
        return ee.plus(ee.plus(ee.plus(ee.plus(ee.plus(ee.plus(rpHash, new byte[]{(byte) i}), new byte[]{0, 0, 0, 0}), bArr), bArr3), this.credentialId), this.credentialPublicKey);
    }
    ...
    public final byte[] defaultAttestationObject$credentials_release() {
        ...
        linkedHashMap.put("attStmt", a.emptyMap());
    ...
    public JSONObject json() throws JSONException {
        ...
        jSONObject.put("transports", new JSONArray((Collection) o30.listOf((Object[]) new String[]{"internal", "hybrid"})));
        return jSONObject;
    }
