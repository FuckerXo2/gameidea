...
public final class Cbor {
    ...
    public static final /* data */ class Arg {
        ...
        public int hashCode() {
            return (vd1.a(this.arg) * 31) + this.len;
        }
    ...
    private final Item parseItem(byte[] data, int offset) {
        ...
        if (type == this.TYPE_BYTE_STRING) {
            return new Item(oe.sliceArray(data, f.until(arg.getLen() + offset, offset + arg.getLen() + ((int) arg.getArg()))), arg.getLen() + ((int) arg.getArg()));
        }
        if (type == this.TYPE_TEXT_STRING) {
            return new Item(new String(oe.sliceArray(data, f.until(arg.getLen() + offset, offset + arg.getLen() + ((int) arg.getArg()))), Charsets.UTF_8), arg.getLen() + ((int) arg.getArg()));
        }
        int i = 0;
        if (type == this.TYPE_ARRAY) {
            ...
            return new Item(y30.toList(arrayList), len);
        }
        ...
        return new Item(a.toMap(linkedHashMap), len2);
    }
    ...
    public final byte[] encode(Object data) {
        ...
        if (data instanceof byte[]) {
            return ee.plus(createArg(this.TYPE_BYTE_STRING, r6.length), (byte[]) data);
        }
        if (data instanceof String) {
            return ee.plus(createArg(this.TYPE_TEXT_STRING, r6.length()), j.encodeToByteArray((String) data));
        }
        if (data instanceof List) {
            byte[] bArrCreateArg = createArg(this.TYPE_ARRAY, r6.size());
            for (Object obj : (List) data) {
                Intrinsics.checkNotNull(obj);
                bArrCreateArg = ee.plus(bArrCreateArg, encode(obj));
            }
        ...
        ArrayList<byte[]> arrayList = new ArrayList(((Map) ref$ObjectRef.element).keySet());
        y30.sortedWith(arrayList, new Comparator() { // from class: jy
            @Override // java.util.Comparator
            public final int compare(Object obj2, Object obj3) {
                return Cbor.encode$lambda$0(ref$ObjectRef, (byte[]) obj2, (byte[]) obj3);
            }
        });
        for (byte[] key2 : arrayList) {
            Intrinsics.checkNotNullExpressionValue(key2, "key");
            byte[] bArrPlus = ee.plus(bArrCreateArg2, key2);
            Object obj2 = ((Map) ref$ObjectRef.element).get(key2);
            Intrinsics.checkNotNull(obj2);
            bArrCreateArg2 = ee.plus(bArrPlus, (byte[]) obj2);
        }
