...
public final class BeginCreateCredentialUtil {
    ...
    public static final class Companion {
        ...
        private final void populateCreateEntries(BeginCreateCredentialResponse.Builder frameworkBuilder, List<CreateEntry> createEntries) {
            Iterator<T> it2 = createEntries.iterator();
            while (it2.hasNext()) {
                Slice slice = CreateEntry.INSTANCE.toSlice((CreateEntry) it2.next());
                if (slice != null) {
                    frameworkBuilder.addCreateEntry(pn.a(slice));
                }
            }
        }
        ...
        private final void populateRemoteEntry(BeginCreateCredentialResponse.Builder frameworkBuilder, RemoteEntry remoteEntry) {
            ...
            kn.a();
            frameworkBuilder.setRemoteCreateEntry(jn.a(RemoteEntry.INSTANCE.toSlice(remoteEntry)));
        }
        ...
        public final BeginCreateCredentialRequest convertToFrameworkRequest(androidx.credentials.provider.BeginCreateCredentialRequest request) {
            CallingAppInfo callingAppInfoA;
            Intrinsics.checkNotNullParameter(request, "request");
            if (request.getCallingAppInfo() != null) {
                nn.a();
                callingAppInfoA = ln.a(request.getCallingAppInfo().getPackageName(), request.getCallingAppInfo().getSigningInfo(), request.getCallingAppInfo().getOrigin());
            } else {
                callingAppInfoA = null;
            }
            on.a();
            return mn.a(request.getType(), request.getCandidateQueryData(), callingAppInfoA);
        }
        ...
        public final BeginCreateCredentialResponse convertToFrameworkResponse(androidx.credentials.provider.BeginCreateCredentialResponse response) {
            ...
            BeginCreateCredentialResponse.Builder builderA = qn.a();
            populateCreateEntries(builderA, response.getCreateEntries());
            ...
            try {
                ...
                if (iHashCode != -543568185) {
                    if (iHashCode == -95037569 && type.equals(PublicKeyCredential.TYPE_PUBLIC_KEY_CREDENTIAL)) {
                        ...
                        CallingAppInfo callingAppInfo5 = request.getCallingAppInfo();
                    ...
                    CallingAppInfo callingAppInfo6 = request.getCallingAppInfo();
                ...
                CallingAppInfo callingAppInfo7 = request.getCallingAppInfo();
                ...
                CallingAppInfo callingAppInfo8 = request.getCallingAppInfo();
        ...
        public final androidx.credentials.provider.BeginCreateCredentialResponse convertToJetpackResponse(BeginCreateCredentialResponse frameworkResponse) {
            ...
            final BeginCreateCredentialUtil$Companion$convertToJetpackResponse$1 beginCreateCredentialUtil$Companion$convertToJetpackResponse$1 = new Function1<android.service.credentials.CreateEntry, CreateEntry>() { // from class: androidx.credentials.provider.utils.BeginCreateCredentialUtil$Companion$convertToJetpackResponse$1
                ...
                public /* bridge */ /* synthetic */ CreateEntry invoke(android.service.credentials.CreateEntry createEntry) {
                    return invoke2(fo.a(createEntry));
                }
            };
            Stream map = stream.map(new Function() { // from class: ao
            ...
            Stream streamFilter = map.filter(new Predicate() { // from class: bo
            ...
            Object objCollect = streamFilter.map(new Function() { // from class: co
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
