    ...
    public static final class SignatureVerifierApi28 {
        ...
        private final Set<String> convertToFingerprints(Signature[] signatures) {
            ...
            for (Signature signature : signatures) {
                ...
                linkedHashSet.add(oe.joinToString$default(digest, (CharSequence) ":", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) new Function1<Byte, CharSequence>() { // from class: androidx.credentials.provider.CallingAppInfo$SignatureVerifierApi28$convertToFingerprints$1
        ...
        public final boolean verifySignatureFingerprints(Set<String> candidateSigFingerprints) {
            ...
            return this.signingInfo.hasMultipleSigners() ? candidateSigFingerprints.containsAll(signatureFingerprints) : !y30.intersect(candidateSigFingerprints, signatureFingerprints).isEmpty();
        }
    }
