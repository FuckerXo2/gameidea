...
public final class CustomCredentialEntry extends CredentialEntry {
    ...
    public static final class Api28Impl {
        ...
        public static final CustomCredentialEntry fromSlice(Slice slice) {
            ...
            while (it3.hasNext()) {
                SliceItem sliceItem = (SliceItem) it3.next();
        ...
        public static final Slice toSlice(CustomCredentialEntry entry) {
            ...
            Slice.Builder builderAddText = new Slice.Builder(Uri.EMPTY, new SliceSpec(type, 1)).addText(typeDisplayName, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)).addText(title, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_TITLE)).addText(subtitle, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_SUBTITLE)).addText(charSequence, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_AUTO_ALLOWED)).addText(beginGetCredentialOption.getId(), null, n30.listOf(CustomCredentialEntry.SLICE_HINT_OPTION_ID)).addText(entryGroupId, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_DEDUPLICATION_ID)).addText(affiliatedDomain, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_AFFILIATED_DOMAIN)).addIcon(icon, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_ICON)).addText(str, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_IS_DEFAULT_ICON_PREFERRED));
            try {
                if (entry.hasDefaultIcon()) {
                    builderAddText.addInt(1, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_DEFAULT_ICON_RES_ID));
                }
            } catch (IllegalStateException unused) {
            }
            if (entry.getIsAutoSelectAllowedFromOption()) {
                builderAddText.addInt(1, null, n30.listOf(CustomCredentialEntry.SLICE_HINT_AUTO_SELECT_FROM_OPTION));
            }
            if (lastUsedTime != null) {
                builderAddText.addLong(lastUsedTime.toEpochMilli(), null, n30.listOf(CustomCredentialEntry.SLICE_HINT_LAST_USED_TIME_MILLIS));
            }
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, d2 = {"Landroidx/credentials/provider/CustomCredentialEntry$Api34Impl;", "", "()V", "fromCredentialEntry", "Landroidx/credentials/provider/CustomCredentialEntry;", "credentialEntry", "Landroid/service/credentials/CredentialEntry;", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    /*  JADX ERROR: NullPointerException in pass: InitCodeVariables
        ...
        */
    public /* synthetic */ CustomCredentialEntry(java.lang.String r19, java.lang.CharSequence r20, android.app.PendingIntent r21, boolean r22, java.lang.CharSequence r23, java.lang.CharSequence r24, android.graphics.drawable.Icon r25, java.time.Instant r26, androidx.credentials.provider.BeginGetCredentialOption r27, boolean r28, java.lang.CharSequence r29, java.lang.CharSequence r30, boolean r31, boolean r32, boolean r33, int r34, kotlin.jvm.internal.DefaultConstructorMarker r35) {
        /*
            r18 = this;
            r0 = r34
