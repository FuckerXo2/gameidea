...
public final class BeginGetCredentialResponse {
    ...
    public static final class Builder {
        ...
        public final BeginGetCredentialResponse build() {
            return new BeginGetCredentialResponse(y30.toList(this.credentialEntries), y30.toList(this.actions), y30.toList(this.authenticationActions), this.remoteEntry);
        }

        public final Builder setActions(List<Action> actions) {
            Intrinsics.checkNotNullParameter(actions, "actions");
            this.actions = y30.toMutableList((Collection) actions);
            return this;
        }
        ...
        public final Builder setAuthenticationActions(List<AuthenticationAction> authenticationEntries) {
            ...
            this.authenticationActions = y30.toMutableList((Collection) authenticationEntries);
            return this;
        }

        public final Builder setCredentialEntries(List<? extends CredentialEntry> entries) {
            Intrinsics.checkNotNullParameter(entries, "entries");
            this.credentialEntries = y30.toMutableList((Collection) entries);
            return this;
        }
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\b\u001a\u00020\u0004H\u0007¨\u0006\t"}, d2 = {"Landroidx/credentials/provider/BeginGetCredentialResponse$Companion;", "", "()V", "asBundle", "Landroid/os/Bundle;", "response", "Landroidx/credentials/provider/BeginGetCredentialResponse;", "fromBundle", ContainerActivity.BUNDLE, "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public /* synthetic */ BeginGetCredentialResponse(List list, List list2, List list3, RemoteEntry remoteEntry, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? o30.emptyList() : list, (i & 2) != 0 ? o30.emptyList() : list2, (i & 4) != 0 ? o30.emptyList() : list3, (i & 8) != 0 ? null : remoteEntry);
    }
}
