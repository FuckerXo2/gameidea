...
public final class GetCredentialRequest {
    ...
    public static final class Builder {
        ...
        public final GetCredentialRequest build() {
            return new GetCredentialRequest(y30.toList(this.credentialOptions), this.origin, this.preferIdentityDocUi, this.preferUiBrandingComponentName, this.preferImmediatelyAvailableCredentials);
        }

        public final Builder setCredentialOptions(List<? extends CredentialOption> credentialOptions) {
            Intrinsics.checkNotNullParameter(credentialOptions, "credentialOptions");
            this.credentialOptions = y30.toMutableList((Collection) credentialOptions);
            return this;
        }
