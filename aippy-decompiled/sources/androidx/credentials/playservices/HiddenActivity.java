...
public class HiddenActivity extends Activity {
    ...
    private final void handleBeginSignIn() {
        ...
        if (beginSignInRequest != null) {
            ...
            taskAddOnFailureListener = taskBeginSignIn.addOnSuccessListener(new OnSuccessListener() { // from class: gu1
    ...
    private final void handleCreatePassword() {
        ...
        if (savePasswordRequest != null) {
            ...
            taskAddOnFailureListener = taskSavePassword.addOnSuccessListener(new OnSuccessListener() { // from class: cu1
                @Override // com.google.android.gms.tasks.OnSuccessListener
                public final void onSuccess(Object obj) {
                    HiddenActivity.handleCreatePassword$lambda$14$lambda$12(function1, obj);
                }
            }).addOnFailureListener(new OnFailureListener() { // from class: du1
                @Override // com.google.android.gms.tasks.OnFailureListener
                public final void onFailure(Exception exc) {
    ...
    private final void handleCreatePublicKeyCredential() {
        ...
        if (publicKeyCredentialCreationOptions != null) {
            ...
            taskAddOnFailureListener = registerPendingIntent.addOnSuccessListener(new OnSuccessListener() { // from class: au1
                @Override // com.google.android.gms.tasks.OnSuccessListener
                public final void onSuccess(Object obj) {
                    HiddenActivity.handleCreatePublicKeyCredential$lambda$2$lambda$0(function1, obj);
                }
            }).addOnFailureListener(new OnFailureListener() { // from class: bu1
                @Override // com.google.android.gms.tasks.OnFailureListener
                public final void onFailure(Exception exc) {
    ...
    private final void handleGetSignInIntent() {
        ...
        if (getSignInIntentRequest != null) {
            ...
            taskAddOnFailureListener = signInIntent.addOnSuccessListener(new OnSuccessListener() { // from class: eu1
                @Override // com.google.android.gms.tasks.OnSuccessListener
                public final void onSuccess(Object obj) {
                    HiddenActivity.handleGetSignInIntent$lambda$6$lambda$4(function1, obj);
                }
            }).addOnFailureListener(new OnFailureListener() { // from class: fu1
                @Override // com.google.android.gms.tasks.OnFailureListener
                public final void onFailure(Exception exc) {
