...
public class ConstraintTrackingWorker extends ListenableWorker implements WorkConstraintsCallback {
    ...
    public void setupAndRunConstraintTrackingWork() {
        ...
        try {
            final tk2 tk2VarStartWork = this.mDelegate.startWork();
            tk2VarStartWork.addListener(new Runnable() { // from class: androidx.work.impl.workers.ConstraintTrackingWorker.2
                    ...
                    synchronized (ConstraintTrackingWorker.this.mLock) {
                        try {
                            if (ConstraintTrackingWorker.this.mAreConstraintsUnmet) {
                                ...
                                ConstraintTrackingWorker.this.mFuture.setFuture(tk2VarStartWork);
                            }
                        } catch (Throwable th) {
                            throw th;
                        }
