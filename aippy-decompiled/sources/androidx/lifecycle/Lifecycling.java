...
public final class Lifecycling {
    ...
    public static final String getAdapterName(String className) {
        ...
        return j.replace$default(className, TRouterMap.DOT, "_", false, 4, (Object) null) + "_LifecycleAdapter";
    }
    ...
    private final int resolveObserverCallbackType(Class<?> klass) {
        ...
        if (constructorGeneratedConstructor != null) {
            classToAdapters.put(klass, n30.listOf(constructorGeneratedConstructor));
            return 2;
        }
