...
public final class PausingDispatcher extends pe0 {
    ...
    public boolean isDispatchNeeded(CoroutineContext context) {
        Intrinsics.checkNotNullParameter(context, "context");
        if (zw0.getMain().getImmediate().isDispatchNeeded(context)) {
            return true;
        }
