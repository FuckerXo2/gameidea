...
public class Transition implements TypedValues {
    ...
    private int mDuration = HttpStatusCodes.STATUS_CODE_BAD_REQUEST;
    ...
    public static class OnSwipe {
        ...
        private long mStart;
        public static final String[] SIDES = {"top", "left", "right", "bottom", "middle", SSECard.TYPE_START, SSECard.TYPE_END};
        private static final float[][] TOUCH_SIDES = {new float[]{0.5f, 0.0f}, new float[]{0.0f, 0.5f}, new float[]{1.0f, 0.5f}, new float[]{0.5f, 1.0f}, new float[]{0.5f, 0.5f}, new float[]{0.0f, 0.5f}, new float[]{1.0f, 0.5f}};
        public static final String[] DIRECTIONS = {"up", "down", "left", "right", SSECard.TYPE_START, SSECard.TYPE_END, "clockwise", "anticlockwise"};
    ...
    public static /* synthetic */ float d(String str, float f) {
    ...
    public static Interpolator getInterpolator(int i, final String str) {
        switch (i) {
            case -1:
                return new Interpolator() { // from class: hu4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
                        return Transition.d(str, f);
                    }
                };
            case 0:
                return new Interpolator() { // from class: iu4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
                        return Transition.a(f);
                    }
                };
            case 1:
                return new Interpolator() { // from class: ju4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 2:
                return new Interpolator() { // from class: ku4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 3:
                return new Interpolator() { // from class: lu4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 4:
                return new Interpolator() { // from class: ou4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 5:
                return new Interpolator() { // from class: nu4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
            ...
            case 6:
                return new Interpolator() { // from class: mu4
                    @Override // androidx.constraintlayout.core.state.Interpolator
                    public final float getInterpolation(float f) {
