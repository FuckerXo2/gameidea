                ...
                if (cLKey.getValue() instanceof CLArray) {
                    ...
                    if (size3 != size || size3 <= 0) {
                        ...
                        if (cLArray.get(i10) instanceof CLNumber) {
                            int i11 = i10;
                            while (i11 < size) {
                                customVariableArr[i11][i9] = new CustomVariable(strContent, TypedValues.Custom.TYPE_FLOAT, cLArray.get(i11).getFloat());
                                i11++;
                                cLObject3 = cLObject3;
                            }
                            cLObject2 = cLObject3;
                    ...
                    if (value instanceof CLNumber) {
                        ...
                        for (int i13 = 0; i13 < size; i13++) {
                            customVariableArr[i13][i9] = new CustomVariable(strContent, TypedValues.Custom.TYPE_FLOAT, f);
                        }
                    } else {
