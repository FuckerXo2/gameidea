...
public class MotionScene {
    ...
    private int mDefaultDuration = HttpStatusCodes.STATUS_CODE_BAD_REQUEST;
    ...
    public void addOnClickListeners(MotionLayout motionLayout, int i) {
        ...
        for (Transition transition3 : this.mTransitionList) {
            if (transition3.mOnClicks.size() > 0) {
                ...
                while (it4.hasNext()) {
                    ((Transition.TransitionOnClick) it4.next()).addOnClickListeners(motionLayout, i, transition3);
                }
            }
        }
        for (Transition transition4 : this.mAbstractTransitionList) {
            if (transition4.mOnClicks.size() > 0) {
                ...
                while (it5.hasNext()) {
                    ((Transition.TransitionOnClick) it5.next()).addOnClickListeners(motionLayout, i, transition4);
                }
            }
        }
    }
    ...
    */
    ...
    public static class Transition {
        ...
        public Transition(MotionScene motionScene, Transition transition) {
            ...
            this.mDuration = HttpStatusCodes.STATUS_CODE_BAD_REQUEST;
            this.mStagger = 0.0f;
