    ...
    public class WriteXmlEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", "bottom", SSECard.TYPE_START, SSECard.TYPE_END}, -1);
    ...
    private String sideToString(int i) {
        switch (i) {
            ...
            case 5:
                return "baseline";
            case 6:
                return SSECard.TYPE_START;
            case 7:
                return SSECard.TYPE_END;
            default:
                return "undefined";
        }
    }
