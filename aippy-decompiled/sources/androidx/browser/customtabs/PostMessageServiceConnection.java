...
public abstract class PostMessageServiceConnection implements ServiceConnection {
    ...
    private dy1 mService;
    private final mx1 mSessionBinder;

    public PostMessageServiceConnection(CustomTabsSessionToken customTabsSessionToken) {
        this.mSessionBinder = mx1.a.asInterface(customTabsSessionToken.getCallbackBinder());
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        this.mService = dy1.a.asInterface(iBinder);
