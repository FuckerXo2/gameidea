...
public class CustomTabsSessionToken {
    ...
    final mx1 mCallbackBinder;

    public static class MockCallback extends mx1.a {
        @Override // mx1.a, android.os.IInterface
    ...
    public CustomTabsSessionToken(mx1 mx1Var) {
        this.mCallbackBinder = mx1Var;
    }
    ...
    public static CustomTabsSessionToken getSessionTokenFromIntent(Intent intent) {
        ...
        return new CustomTabsSessionToken(mx1.a.asInterface(binder));
    }
