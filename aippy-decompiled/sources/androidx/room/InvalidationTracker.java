...
public class InvalidationTracker {
    ...
    private static final String[] TRIGGERS = {"UPDATE", HttpMethods.DELETE, "INSERT"};
    ...
    public void setAutoCloser(AutoCloser autoCloser) {
        ...
        autoCloser.setAutoCloseCallback(new Runnable() { // from class: c52
                ...
                try {
                    ...
                    synchronized (InvalidationTracker.this.mObserverMap) {
                        try {
                            ...
                            while (it2.hasNext()) {
                                it2.next().getValue().notifyByTableInvalidStatus(setCheckUpdatedTable);
                            }
                        } finally {
                        }
                    }
