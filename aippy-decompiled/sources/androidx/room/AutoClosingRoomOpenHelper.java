...
final class AutoClosingRoomOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    public static final class AutoClosingSupportSQLiteDatabase implements SupportSQLiteDatabase {
        ...
        public static /* synthetic */ Object b(int i, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        public static /* synthetic */ Object f(long j, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        public static /* synthetic */ Object j(boolean z, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        public static /* synthetic */ Object l(Locale locale, SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        public int delete(final String str, final String str2, final Object[] objArr) {
            return ((Integer) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.n
        ...
        public void execSQL(final String str) throws SQLException {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.a
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.i(str, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public List<Pair<String, String>> getAttachedDbs() {
            return (List) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: xh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long getMaximumSize() {
            return ((Long) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: uh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long getPageSize() {
            return ((Long) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: ai
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public String getPath() {
            return (String) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: zh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public int getVersion() {
            return ((Integer) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: yh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean inTransaction() {
            ...
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: di
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long insert(final String str, final int i, final ContentValues contentValues) throws SQLException {
            return ((Long) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.b
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isDatabaseIntegrityOk() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: vh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isDbLockedByCurrentThread() {
            ...
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: wh
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean isReadOnly() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: bi
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public boolean needUpgrade(final int i) {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.h
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public void pokeOpen() {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.j
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.n((SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void setForeignKeyConstraintsEnabled(final boolean z) {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.i
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.j(z, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void setLocale(final Locale locale) {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.f
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.l(locale, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void setMaxSqlCacheSize(final int i) {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.l
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.b(i, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void setPageSize(final long j) {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.m
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.f(j, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public void setVersion(final int i) {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.d
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.c(i, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public boolean yieldIfContendedSafely() {
            return ((Boolean) this.mAutoCloser.executeRefCountingFunction(new ci())).booleanValue();
        }
        ...
        public void execSQL(final String str, final Object[] objArr) throws SQLException {
            this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.c
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSQLiteDatabase.k(str, objArr, (SupportSQLiteDatabase) obj);
                }
            });
        }
    ...
    public static class AutoClosingSupportSqliteStatement implements SupportSQLiteStatement {
        ...
        public static /* synthetic */ Object a(AutoClosingSupportSqliteStatement autoClosingSupportSqliteStatement, Function function, SupportSQLiteDatabase supportSQLiteDatabase) {
            SupportSQLiteStatement supportSQLiteStatementCompileStatement = supportSQLiteDatabase.compileStatement(autoClosingSupportSqliteStatement.mSql);
            autoClosingSupportSqliteStatement.doBinds(supportSQLiteStatementCompileStatement);
        ...
        private <T> T executeSqliteStatementWithRefCount(final Function<SupportSQLiteStatement, T> function) {
            return (T) this.mAutoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.o
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return AutoClosingRoomOpenHelper.AutoClosingSupportSqliteStatement.a(this.a, function, (SupportSQLiteDatabase) obj);
                }
            });
        }
        ...
        public long executeInsert() {
            return ((Long) executeSqliteStatementWithRefCount(new Function() { // from class: fi
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public int executeUpdateDelete() {
            return ((Integer) executeSqliteStatementWithRefCount(new Function() { // from class: hi
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public long simpleQueryForLong() {
            return ((Long) executeSqliteStatementWithRefCount(new Function() { // from class: gi
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        public String simpleQueryForString() {
            return (String) executeSqliteStatementWithRefCount(new Function() { // from class: ei
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
