...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo50clone = transition.mo50clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo50clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo50clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo50clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo50clone = transition.mo50clone();
        sceneChangeSetup(viewGroup, transitionMo50clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo50clone);
    }
