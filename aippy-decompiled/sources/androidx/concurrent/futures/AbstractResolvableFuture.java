...
public abstract class AbstractResolvableFuture<V> implements tk2 {
    ...
    public static final class SafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return v1.a(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return v1.a(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return v1.a(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, tk2 tk2Var) {
    ...
    public static Object getFutureValue(tk2 tk2Var) {
        if (tk2Var instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) tk2Var).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        boolean zIsCancelled = tk2Var.isCancelled();
        if ((!GENERATE_CANCELLATION_CAUSES) && zIsCancelled) {
            return Cancellation.CAUSELESS_CANCELLED;
        }
        try {
            Object uninterruptibly = getUninterruptibly(tk2Var);
            return uninterruptibly == null ? NULL : uninterruptibly;
        } catch (CancellationException e) {
            if (zIsCancelled) {
                return new Cancellation(false, e);
            }
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + tk2Var, e));
        } catch (ExecutionException e2) {
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                tk2 tk2Var = ((SetFuture) obj).future;
                if (!(tk2Var instanceof AbstractResolvableFuture)) {
                    tk2Var.cancel(z);
                    break;
                }
                abstractResolvableFuture = (AbstractResolvableFuture) tk2Var;
    ...
    public boolean setFuture(tk2 tk2Var) {
        ...
        if (obj == null) {
            if (tk2Var.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(tk2Var))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, tk2Var);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    tk2Var.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            tk2Var.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
