...
public class TAPushUtils {
    ...
    public static void clearPushEvent(ThinkingAnalyticsSDK thinkingAnalyticsSDK) {
        ...
        Iterator<JSONObject> it2 = pushList.iterator();
        while (it2.hasNext()) {
            thinkingAnalyticsSDK.track(TA_PUSH_CLICK_EVENT, it2.next());
        }
        pushList.clear();
    }
    ...
    public static void handleMiPushData(Intent intent) {
        ...
        try {
            ...
            if (serializableExtra != null) {
                Object objInvoke = serializableExtra.getClass().getMethod("getExtra", null).invoke(serializableExtra, null);
    ...
    private static boolean trackPushClickEvent(String str) {
        ...
        try {
            ...
            JSONObject jSONObject = objOpt instanceof String ? new JSONObject((String) objOpt) : objOpt instanceof JSONObject ? (JSONObject) objOpt : null;
            if (jSONObject == null) {
                return false;
            }
