...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b) {
        return j.concatToString(new char[]{okio.internal.ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], okio.internal.ByteString.getHEX_DIGIT_CHARS()[b & 15]});
    }
    ...
    public static final String toHexString(int i) {
        ...
        return j.concatToString(cArr, i2, 8);
    }
    ...
    public static final String toHexString(long j) {
        ...
        return j.concatToString(cArr, i, 16);
    }
}
