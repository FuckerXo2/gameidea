...
public final class Segment {
    ...
    public final Segment split(int byteCount) {
        ...
        if (byteCount >= 1024) {
            ...
            int i = this.pos;
            ee.copyInto$default(bArr, bArr2, 0, i, i + byteCount, 2, (Object) null);
        }
    ...
    public final void writeTo(@NotNull Segment sink, int byteCount) {
        ...
        if (i + byteCount > 8192) {
            ...
            byte[] bArr = sink.data;
            ee.copyInto$default(bArr, bArr, 0, i2, i, 2, (Object) null);
            sink.limit -= sink.pos;
            sink.pos = 0;
        }
        ...
        int i3 = sink.limit;
        int i4 = this.pos;
        ee.copyInto(bArr2, bArr3, i3, i4, i4 + byteCount);
