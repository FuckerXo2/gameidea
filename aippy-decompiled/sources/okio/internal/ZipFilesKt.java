...
public final class ZipFilesKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        ...
        Map<Path, ZipEntry> mapMutableMapOf = a.mutableMapOf(fv4.to(path, new ZipEntry(path, true, null, 0L, 0L, 0L, 0, null, 0L, TypedValues.PositionType.TYPE_CURVE_FIT, null)));
        for (ZipEntry zipEntry : y30.sortedWith(list, new Comparator() { // from class: okio.internal.ZipFilesKt$buildIndex$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t, T t2) {
                return j80.compareValues(((ZipEntry) t).getCanonicalPath(), ((ZipEntry) t2).getCanonicalPath());
            }
        })) {
            ...
            try {
                if (bufferedSourceBuffer2.readIntLe() == END_OF_CENTRAL_DIRECTORY_SIGNATURE) {
                        ...
                        try {
                            if (bufferedSourceBuffer.readIntLe() == ZIP64_LOCATOR_SIGNATURE) {
                                ...
                                try {
                                    ...
                                    Unit unit = Unit.a;
                                    g20.closeFinally(bufferedSourceBuffer, null);
                                } finally {
                                }
                            }
                            Unit unit2 = Unit.a;
                    ...
                    try {
                        ...
                        g20.closeFinally(fileHandleOpenReadOnly, null);
    ...
    public static /* synthetic */ ZipFileSystem openZip$default(Path path, FileSystem fileSystem, Function1 function1, int i, Object obj) throws IOException {
        if ((i & 4) != 0) {
            function1 = new Function1<ZipEntry, Boolean>() { // from class: okio.internal.ZipFilesKt.openZip.1
                ...
                @NotNull
                public final Boolean invoke(@NotNull ZipEntry it2) {
    ...
    public static final ZipEntry readEntry(@NotNull final BufferedSource bufferedSource) throws IOException {
        ...
        ref$LongRef.element = ((long) bufferedSource.readIntLe()) & MAX_ZIP_ENTRY_AND_ARCHIVE_SIZE;
        ...
        if (wm4.contains$default((CharSequence) utf8, (char) 0, false, 2, (Object) null)) {
            throw new IOException("bad zip: filename contains 0x00");
        }
        final long j = ref$LongRef2.element == MAX_ZIP_ENTRY_AND_ARCHIVE_SIZE ? 8 : 0L;
        ...
        if (j <= 0 || ref$BooleanRef.element) {
            return new ZipEntry(Path.Companion.get$default(Path.INSTANCE, "/", false, 1, (Object) null).resolve(utf8), j.endsWith$default(utf8, "/", false, 2, null), bufferedSource.readUtf8(shortLe5), intLe2, ref$LongRef.element, ref$LongRef2.element, shortLe2, lDosDateTimeToEpochMillis, ref$LongRef3.element);
        }
