...
public final class ByteString {
    ...
    */
    ...
    public static final void commonCopyInto(@NotNull okio.ByteString byteString, int i, @NotNull byte[] target, int i2, int i3) {
        ...
        ee.copyInto(byteString.getData(), target, i2, i, i3 + i);
    }
    ...
    public static final boolean commonEquals(@NotNull okio.ByteString byteString, Object obj) {
        Intrinsics.checkNotNullParameter(byteString, "<this>");
        if (obj == byteString) {
            return true;
        }
    ...
    public static final okio.ByteString commonSubstring(@NotNull okio.ByteString byteString, int i, int i2) {
        ...
        if (iResolveDefaultParameter <= byteString.getData().length) {
            if (iResolveDefaultParameter - i >= 0) {
                return (i == 0 && iResolveDefaultParameter == byteString.getData().length) ? byteString : new okio.ByteString(ee.copyOfRange(byteString.getData(), i, iResolveDefaultParameter));
            }
    ...
    public static final okio.ByteString commonToByteString(@NotNull byte[] bArr, int i, int i2) {
        ...
        return new okio.ByteString(ee.copyOfRange(bArr, i, iResolveDefaultParameter + i));
    }
    ...
    public static final String commonToString(@NotNull okio.ByteString byteString) {
        ...
        if (iResolveDefaultParameter != byteString2.getData().length) {
            byteString2 = new okio.ByteString(ee.copyOfRange(byteString2.getData(), 0, iResolveDefaultParameter));
        }
