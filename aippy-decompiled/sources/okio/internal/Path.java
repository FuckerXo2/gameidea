...
public final class Path {
    ...
    static {
        ...
        DOT = companion.encodeUtf8(TRouterMap.DOT);
    ...
    public static final boolean commonEquals(@NotNull okio.Path path, Object obj) {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static final okio.Path commonRelativeTo(@NotNull okio.Path path, @NotNull okio.Path other) {
        ...
        if (i == iMin && path.getBytes().size() == other.getBytes().size()) {
            return Path.Companion.get$default(okio.Path.INSTANCE, TRouterMap.DOT, false, 1, (Object) null);
        }
        ...
        while (!buffer.exhausted()) {
            ...
            if (Intrinsics.areEqual(byteString2, byteString3)) {
                if (!z3 || !arrayList.isEmpty()) {
                    if (!z || (!z3 && (arrayList.isEmpty() || Intrinsics.areEqual(y30.last((List) arrayList), byteString3)))) {
                        arrayList.add(byteString2);
                    } else if (!z2 || arrayList.size() != 1) {
                        t30.removeLastOrNull(arrayList);
                    }
                }
