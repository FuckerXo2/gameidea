...
public final class RealBufferedSource {
    ...
    public static final long commonIndexOf(@NotNull buffer bufferVar, byte b, long j, long j2) {
        ...
        while (jMax < j2) {
            byte b2 = b;
            long j3 = j2;
            long jIndexOf = bufferVar.bufferField.indexOf(b2, jMax, j3);
            if (jIndexOf != -1) {
                return jIndexOf;
            }
    ...
    public static final String commonReadUtf8LineStrict(@NotNull buffer bufferVar, long j) throws EOFException {
        ...
        if (j2 < LocationRequestCompat.PASSIVE_INTERVAL && bufferVar.request(j2) && bufferVar.bufferField.getByte(j2 - 1) == 13 && bufferVar.request(j2 + 1) && bufferVar.bufferField.getByte(j2) == 10) {
