...
public final class C0344SegmentedByteString extends ByteString {
    ...
    public C0344SegmentedByteString(@NotNull byte[][] segments, @NotNull int[] directory) {
    ...
    public void copyInto(int offset, @NotNull byte[] target, int targetOffset, int byteCount) {
        ...
        while (offset < i) {
            ...
            int i5 = i4 + (offset - i2);
            ee.copyInto(getSegments()[iSegment], target, targetOffset, i5, i5 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iSegment++;
        }
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        byte[][] bArr = (byte[][]) ee.copyOfRange(getSegments(), iSegment, iSegment2 + 1);
    ...
    public byte[] toByteArray() {
        ...
        while (i < length) {
            ...
            int i5 = getDirectory()[i];
            int i6 = i5 - i2;
            ee.copyInto(getSegments()[i], bArr, i3, i4, i4 + i6);
            i3 += i6;
            i++;
            i2 = i5;
        }
