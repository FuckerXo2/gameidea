...
public class c {
    ...
    public static class b extends MediaController.Callback {
        ...
        public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
            this.a.onAudioInfoChanged(playbackInfo.getPlaybackType(), C0009c.getLegacyAudioStream(playbackInfo), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
        }
