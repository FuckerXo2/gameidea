...
.method private static zza(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;
    ...
    :sswitch_0
    const-string v3, "UNSUPPORTED_TENANT_OPERATION"
    ...
    :sswitch_1
    const-string v3, "EMAIL_CHANGE_NEEDS_VERIFICATION"
    ...
    :sswitch_2
    const-string v3, "MISSING_SESSION_INFO"
    ...
    :sswitch_3
    const-string v3, "MISSING_CONTINUE_URI"
    ...
    :sswitch_4
    const-string v3, "TOO_MANY_ATTEMPTS_TRY_LATER"
    ...
    :sswitch_5
    const-string v3, "INVALID_APP_CREDENTIAL"
    ...
    :sswitch_8
    const-string v3, "INVALID_IDENTIFIER"
    ...
    :sswitch_9
    const-string v3, "FEDERATED_USER_ID_ALREADY_LINKED"
    ...
    :sswitch_e
    const-string v3, "INVALID_CUSTOM_TOKEN"
    ...
    :sswitch_f
    const-string v3, "INVALID_PENDING_TOKEN"
    ...
    :sswitch_10
    const-string v3, "RESET_PASSWORD_EXCEED_LIMIT"
    ...
    :sswitch_11
    const-string v3, "INVALID_MESSAGE_PAYLOAD"
    ...
    :sswitch_14
    const-string v3, "WEB_CONTEXT_CANCELED"
    ...
    :sswitch_15
    const-string v3, "CREDENTIAL_MISMATCH"
    ...
    :sswitch_17
    const-string v3, "INVALID_VERIFICATION_PROOF"
    ...
    :sswitch_18
    const-string v3, "INVALID_MFA_PENDING_CREDENTIAL"
    ...
    :sswitch_19
    const-string v3, "REJECTED_CREDENTIAL"
    ...
    :sswitch_1a
    const-string v3, "UNVERIFIED_EMAIL"
    ...
    :sswitch_1b
    const-string v3, "PASSWORD_LOGIN_DISABLED"
    ...
    :sswitch_1d
    const-string v3, "INVALID_ID_TOKEN"
    ...
    :sswitch_1f
    const-string v3, "MISSING_MFA_PENDING_CREDENTIAL"
    ...
    :sswitch_20
    const-string v3, "INVALID_DYNAMIC_LINK_DOMAIN"
    ...
    :sswitch_21
    const-string v3, "MISSING_PHONE_NUMBER"
    ...
    :sswitch_23
    const-string v3, "UNSUPPORTED_FIRST_FACTOR"
    ...
    :sswitch_24
    const-string v3, "EMAIL_NOT_FOUND"
    ...
    :sswitch_27
    const-string v3, "MISSING_MFA_ENROLLMENT_ID"
    ...
    :sswitch_28
    const-string v3, "SECOND_FACTOR_LIMIT_EXCEEDED"
    ...
    :sswitch_2c
    const-string v3, "CREDENTIAL_TOO_OLD_LOGIN_AGAIN"
    ...
    :sswitch_2d
    const-string v3, "MISSING_PASSWORD"
    ...
    :sswitch_2e
    const-string v3, "MFA_ENROLLMENT_NOT_FOUND"
    ...
    :sswitch_31
    const-string v3, "MISSING_OR_INVALID_NONCE"
    ...
    :sswitch_32
    const-string v3, "ADMIN_ONLY_OPERATION"
    ...
    :sswitch_34
    const-string v3, "SECOND_FACTOR_EXISTS"
    ...
    :sswitch_35
    const-string v3, "INVALID_SESSION_INFO"
    ...
    :sswitch_36
    const-string v3, "INVALID_TENANT_ID"
    ...
    :sswitch_3a
    const-string v3, "INVALID_OOB_CODE"
    ...
    :sswitch_3b
    const-string v3, "EXPIRED_OOB_CODE"
    ...
    :sswitch_3e
    const-string v3, "DYNAMIC_LINK_NOT_ACTIVATED"
    ...
    :sswitch_3f
    const-string v3, "INVALID_IDP_RESPONSE"
    ...
    :sswitch_41
    const-string v3, "WEB_CONTEXT_ALREADY_PRESENTED"
    ...
    :sswitch_42
    const-string v3, "INVALID_RECIPIENT_EMAIL"
