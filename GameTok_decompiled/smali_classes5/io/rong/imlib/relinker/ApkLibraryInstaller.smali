...
.method private findAPKWithLibrary(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lio/rong/imlib/relinker/ReLinkerInstance;)Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;
    ...
    .line 91
    .line 92
    invoke-virtual {v15, v13, v14}, Lio/rong/imlib/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 102
    .line 103
    invoke-direct {v0, v5, v12}, Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;-><init>(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)V
...
.method private getSupportedABIs(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 47
    .line 48
    invoke-direct {p0, p1}, Lio/rong/imlib/relinker/ApkLibraryInstaller;->sourceDirectories(Landroid/content/Context;)[Ljava/lang/String;
...
.method public installLibrary(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lio/rong/imlib/relinker/ReLinkerInstance;)V
    ...
    .line 21
    invoke-virtual {p5, p2, v3}, Lio/rong/imlib/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    :cond_0
    :try_start_3
    iget-object p2, v1, Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;->zipFile:Ljava/util/zip/ZipFile;

    .line 43
    .line 44
    iget-object v3, v1, Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;->zipEntry:Ljava/util/zip/ZipEntry;
    ...
    .line 55
    :try_start_5
    invoke-direct {p0, p2, v3}, Lio/rong/imlib/relinker/ApkLibraryInstaller;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 74
    :try_start_6
    invoke-direct {p0, p2}, Lio/rong/imlib/relinker/ApkLibraryInstaller;->closeSilently(Ljava/io/Closeable;)V

    .line 75
    .line 76
    .line 77
    :goto_1
    invoke-direct {p0, v3}, Lio/rong/imlib/relinker/ApkLibraryInstaller;->closeSilently(Ljava/io/Closeable;)V
    ...
    .line 105
    .line 106
    const-string p1, "Change permission to rwxr-xr-x"

    .line 107
    .line 108
    invoke-virtual {p5, p1}, Lio/rong/imlib/relinker/ReLinkerInstance;->log(Ljava/lang/String;)V
    :try_end_6
    ...
    :cond_2
    :try_start_7
    iget-object p1, v1, Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;->zipFile:Ljava/util/zip/ZipFile;
    ...
    :cond_6
    :try_start_a
    invoke-direct {p0, p1, p3}, Lio/rong/imlib/relinker/ApkLibraryInstaller;->getSupportedABIs(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 183
    :goto_7
    new-instance p4, Lio/rong/imlib/relinker/MissingLibraryException;

    .line 184
    .line 185
    invoke-direct {p4, p3, p2, p1}, Lio/rong/imlib/relinker/MissingLibraryException;-><init>(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .line 192
    :try_start_c
    iget-object p2, v0, Lio/rong/imlib/relinker/ApkLibraryInstaller$ZipFileInZipEntry;->zipFile:Ljava/util/zip/ZipFile;
