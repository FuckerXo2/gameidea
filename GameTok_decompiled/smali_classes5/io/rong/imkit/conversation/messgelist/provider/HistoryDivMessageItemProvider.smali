.class public Lio/rong/imkit/conversation/messgelist/provider/HistoryDivMessageItemProvider;
.super Lio/rong/imkit/conversation/messgelist/provider/BaseNotificationMessageItemProvider;
.source "HistoryDivMessageItemProvider.java"
...
.method protected bridge synthetic bindMessageContentViewHolder(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imlib/model/MessageContent;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)V
    ...
    .line 1
    check-cast p3, Lio/rong/message/HistoryDividerMessage;

    invoke-virtual/range {p0 .. p7}, Lio/rong/imkit/conversation/messgelist/provider/HistoryDivMessageItemProvider;->bindMessageContentViewHolder(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/message/HistoryDividerMessage;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)V

    return-void
.end method

.method protected bindMessageContentViewHolder(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/message/HistoryDividerMessage;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    sget p2, Lio/rong/imkit/R$id;->tv_divider_message:I

    invoke-virtual {p3}, Lio/rong/message/HistoryDividerMessage;->getContent()Ljava/lang/String;
...
.method public bridge synthetic getSummarySpannable(Landroid/content/Context;Lio/rong/imlib/model/MessageContent;)Landroid/text/Spannable;
    ...
    .line 2
    check-cast p2, Lio/rong/message/HistoryDividerMessage;

    invoke-virtual {p0, p1, p2}, Lio/rong/imkit/conversation/messgelist/provider/HistoryDivMessageItemProvider;->getSummarySpannable(Landroid/content/Context;Lio/rong/message/HistoryDividerMessage;)Landroid/text/Spannable;
...
.method public getSummarySpannable(Landroid/content/Context;Lio/rong/message/HistoryDividerMessage;)Landroid/text/Spannable;
    .locals 0
...
.method protected isMessageViewType(Lio/rong/imlib/model/MessageContent;)Z
    ...
    .line 1
    instance-of p1, p1, Lio/rong/message/HistoryDividerMessage;
...
.method protected onCreateMessageContentViewHolder(Landroid/view/ViewGroup;I)Lio/rong/imkit/widget/adapter/ViewHolder;
    ...
    .line 9
    sget v0, Lio/rong/imkit/R$layout;->rc_item_new_message_divider:I
