.class public Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider;
.super Lio/rong/imkit/conversation/messgelist/provider/BaseMessageItemProvider;
.source "DestructGifMessageItemProvider.java"


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider$DestructListener;
    }
.end annotation
...
# static fields
.field private static final TAG:Ljava/lang/String; = "DestructGifMessageItemProvider"
...
.method protected bindMessageContentViewHolder(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/message/GIFMessage;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)V
    ...
    new-instance p7, Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider$DestructListener;

    invoke-direct {p7, p1, p4}, Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider$DestructListener;-><init>(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imkit/model/UiMessage;)V

    sget-object v0, Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider;->TAG:Ljava/lang/String;
...
.method public bridge synthetic getSummarySpannable(Landroid/content/Context;Lio/rong/imlib/model/MessageContent;)Landroid/text/Spannable;
    ...
    invoke-virtual {p0, p1, p2}, Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider;->getSummarySpannable(Landroid/content/Context;Lio/rong/message/GIFMessage;)Landroid/text/Spannable;
...
.method protected bridge synthetic onItemClick(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/imlib/model/MessageContent;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lio/rong/imkit/feature/destruct/provider/DestructGifMessageItemProvider;->onItemClick(Lio/rong/imkit/widget/adapter/ViewHolder;Lio/rong/message/GIFMessage;Lio/rong/imkit/model/UiMessage;ILjava/util/List;Lio/rong/imkit/widget/adapter/IViewProviderListener;)Z
