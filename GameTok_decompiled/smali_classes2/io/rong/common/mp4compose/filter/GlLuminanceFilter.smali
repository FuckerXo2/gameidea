.class public Lio/rong/common/mp4compose/filter/GlLuminanceFilter;
.super Lio/rong/common/mp4compose/filter/GlFilter;
.source "GlLuminanceFilter.java"


# static fields
.field private static final LUMINANCE_FRAGMENT_SHADER:Ljava/lang/String; = "precision mediump float;\n varying vec2 vTextureCoord;\n\n uniform lowp sampler2D sTexture;\n\n// Values from \"Graphics Shaders: Theory and Practice\" by Bailey and Cunningham\nconst highp vec3 W = vec3(0.2125, 0.7154, 0.0721);\n\nvoid main()\n{\n    lowp vec4 textureColor = texture2D(sTexture, vTextureCoord);\n    float luminance = dot(textureColor.rgb, W);\n    \n    gl_FragColor = vec4(vec3(luminance), textureColor.a);\n}"
