...
.method public constructor <init>(Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, LeQ;->b:Ljava/util/concurrent/ExecutorService;

    return-void
.end method

.method public static synthetic a(LeQ;Landroid/content/Context;)V
    .locals 0

    invoke-virtual {p0, p1}, LeQ;->h(Landroid/content/Context;)V

    return-void
.end method

.method public static declared-synchronized e()LeQ;
    .locals 3
    ...
    invoke-direct {v1, v2}, LeQ;-><init>(Ljava/util/concurrent/ExecutorService;)V
...
# virtual methods
.method public b(Ljava/lang/String;)Li31;
    .locals 2

    if-nez p1, :cond_0

    sget-object p1, LeQ;->c:LN4;
    ...
    :cond_0
    iget-object v0, p0, LeQ;->a:Landroid/content/SharedPreferences;

    if-nez v0, :cond_1

    invoke-virtual {p0}, LeQ;->d()Landroid/content/Context;

    move-result-object v0

    invoke-virtual {p0, v0}, LeQ;->i(Landroid/content/Context;)V
...
.method public c(Ljava/lang/String;)Li31;
    .locals 3
...
.method public f(Ljava/lang/String;)Li31;
    .locals 3
...
.method public g(Ljava/lang/String;)Li31;
    .locals 2
...
.method public final synthetic h(Landroid/content/Context;)V
    ...
    iput-object p1, p0, LeQ;->a:Landroid/content/SharedPreferences;
...
.method public declared-synchronized i(Landroid/content/Context;)V
    ...
    iget-object v0, p0, LeQ;->b:Ljava/util/concurrent/ExecutorService;

    new-instance v1, LdQ;

    invoke-direct {v1, p0, p1}, LdQ;-><init>(LeQ;Landroid/content/Context;)V
...
.method public j(Ljava/lang/String;D)Z
    ...
    :cond_0
    iget-object v1, p0, LeQ;->a:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v1}, LeQ;->i(Landroid/content/Context;)V
...
.method public l(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object p2, p0, LeQ;->a:Landroid/content/SharedPreferences;
