...
.method static constructor <clinit>()V
    ...
    sput-object v0, LQt;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2, p1, p3}, LQt;->f(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, LQt;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    :cond_1
    invoke-static {}, LQt;->g()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, LQt;->l(I)I
...
.method public static b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2}, LQt;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    invoke-static {p0, p1, p2}, LQt;->c(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)LQt$a;
    .locals 5
    ...
    invoke-direct {v3, p1, p3}, LI01$e;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p3}, LI01$e;->i(Ljava/lang/CharSequence;)LI01$e;

    new-instance v4, LI01$c;

    invoke-direct {v4}, LI01$c;-><init>()V

    invoke-virtual {v4, p3}, LI01$c;->h(Ljava/lang/CharSequence;)LI01$c;

    move-result-object p3

    invoke-virtual {v3, p3}, LI01$e;->y(LI01$g;)LI01$e;
    ...
    invoke-static {v2, v1, v0, p3, p4}, LQt;->m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I

    move-result p3

    invoke-virtual {v3, p3}, LI01$e;->w(I)LI01$e;

    invoke-static {v0, p2, v1}, LQt;->n(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v3, p3}, LI01$e;->x(Landroid/net/Uri;)LI01$e;

    :cond_2
    invoke-static {p0, p2, v0, v2}, LQt;->a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;

    move-result-object p3

    invoke-virtual {v3, p3}, LI01$e;->h(Landroid/app/PendingIntent;)LI01$e;

    invoke-static {p0, p1, p2}, LQt;->b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;

    move-result-object p0

    if-eqz p0, :cond_3

    invoke-virtual {v3, p0}, LI01$e;->m(Landroid/app/PendingIntent;)LI01$e;
    ...
    invoke-static {p1, p0, p4}, LQt;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {v3, p0}, LI01$e;->g(I)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->e(Z)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->s(Z)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->z(Ljava/lang/CharSequence;)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->u(I)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->B(I)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->t(I)LI01$e;
    ...
    invoke-virtual {v3, p1}, LI01$e;->v(Z)LI01$e;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v3, p3, p4}, LI01$e;->C(J)LI01$e;
    ...
    invoke-virtual {v3, p0}, LI01$e;->A([J)LI01$e;
    ...
    invoke-virtual {v3, p4, p1, p0}, LI01$e;->r(III)LI01$e;

    :cond_b
    invoke-static {p2}, LQt;->i(Lcom/google/firebase/messaging/c;)I

    move-result p0

    invoke-virtual {v3, p0}, LI01$e;->l(I)LI01$e;

    new-instance p0, LQt$a;

    invoke-static {p2}, LQt;->o(Lcom/google/firebase/messaging/c;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v3, p1, p3}, LQt$a;-><init>(LI01$e;Ljava/lang/String;I)V

    return-object p0
.end method

.method public static e(Landroid/content/Context;Lcom/google/firebase/messaging/c;)LQt$a;
    .locals 2
    ...
    invoke-static {v0, v1}, LQt;->j(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v1, v0}, LQt;->k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, p0, p1, v1, v0}, LQt;->d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)LQt$a;
...
.method public static g()I
    ...
    sget-object v0, LQt;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    :try_start_1
    invoke-static {p0, p1}, Lvz;->c(Landroid/content/Context;I)I
...
.method public static m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, LQt;->p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p1, p3}, LQt;->p(Landroid/content/res/Resources;I)Z
