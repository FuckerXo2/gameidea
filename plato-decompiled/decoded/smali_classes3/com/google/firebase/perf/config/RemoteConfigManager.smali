...
.field private final cache:LeQ;

.field private final executor:Ljava/util/concurrent/Executor;

.field private firebaseRemoteConfig:Lg60;

.field private firebaseRemoteConfigLastFetchTimestampMs:J

.field private firebaseRemoteConfigProvider:Ljr1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljr1;"
        }
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:LN4;
...
.method private constructor <init>()V
    ...
    .line 4
    invoke-direct/range {v0 .. v7}, Lcom/google/firebase/perf/config/RemoteConfigManager;-><init>(LeQ;Ljava/util/concurrent/Executor;Lg60;JJ)V

    return-void
.end method

.method public constructor <init>(LeQ;Ljava/util/concurrent/Executor;Lg60;JJ)V
    .locals 2
    ...
    .line 7
    iput-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->cache:LeQ;

    .line 8
    iput-object p2, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->executor:Ljava/util/concurrent/Executor;

    .line 9
    iput-object p3, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lg60;
    ...
    invoke-virtual {p3}, Lg60;->h()Ljava/util/Map;
...
.method private getRemoteConfigValue(Ljava/lang/String;)Lo60;
    .locals 3
    ...
    sget-object v1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:LN4;

    invoke-interface {v0}, Lo60;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, LN4;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0(Ljava/lang/Boolean;)V
    ...
    iget-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lg60;

    invoke-virtual {p1}, Lg60;->h()Ljava/util/Map;
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$1(Ljava/lang/Exception;)V
    ...
    sget-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:LN4;
...
.method private triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch()V
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lg60;

    invoke-virtual {v0}, Lg60;->g()LD12;
    ...
    invoke-direct {v2, p0}, LeA1;-><init>(Lcom/google/firebase/perf/config/RemoteConfigManager;)V
    ...
    invoke-direct {v2, p0}, LfA1;-><init>(Lcom/google/firebase/perf/config/RemoteConfigManager;)V
...
.method private triggerRemoteConfigFetchIfNecessary()V
    ...
    iget-object v1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lg60;

    invoke-virtual {v1}, Lg60;->h()Ljava/util/Map;
...
# virtual methods
.method public getBoolean(Ljava/lang/String;)Li31;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:LN4;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/config/RemoteConfigManager;->getRemoteConfigValue(Ljava/lang/String;)Lo60;
    ...
    invoke-static {v1}, Li31;->e(Ljava/lang/Object;)Li31;
...
.method public getDouble(Ljava/lang/String;)Li31;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lcom/playchat/ui/fragment/conversation/actionbar/SED/vzaHkcK;->MUSYuXKlRwZ:Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)Li31;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getRemoteConfigValueOrDefault(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v2, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:LN4;

    const/4 v3, 0x0

    sget-object v3, Landroidx/work/impl/background/systemjob/ve/pUYUlnjJea;->IgTzUoSzWwV:Ljava/lang/String;

    filled-new-array {p2}, [Ljava/lang/Object;

    move-result-object p2

    invoke-virtual {v2, v3, p2}, LN4;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
...
.method public getString(Ljava/lang/String;)Li31;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1}, Lo60;->d()Ljava/lang/String;
...
.method public isFirebaseRemoteConfigAvailable()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:Ljr1;
    ...
    invoke-virtual {v0, v1}, LbA1;->e(Ljava/lang/String;)Lg60;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfig:Lg60;
...
.method public isLastFetchFailed()Z
    ...
    invoke-virtual {v0}, Lg60;->i()Lk60;

    move-result-object v0

    invoke-interface {v0}, Lk60;->a()I
...
.method public setFirebaseRemoteConfigProvider(Ljr1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:Ljr1;
...
.method public syncConfigValues(Ljava/util/Map;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->cache:LeQ;

    invoke-virtual {p1}, LUw;->a()Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v0}, LeQ;->m(Ljava/lang/String;Z)Z
    :try_end_0
