...
.method public static a()Z
    ...
    invoke-virtual {v2}, LM40;->k()Landroid/content/Context;
...
.method public static b(LoU0$b;Landroid/content/Intent;)LoU0;
    .locals 4
    ...
    invoke-virtual {v0, v1}, LoU0$a;->m(I)LoU0$a;

    move-result-object v0

    invoke-virtual {v0, p0}, LoU0$a;->e(LoU0$b;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->f(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->i(Ljava/lang/String;)LoU0$a;

    move-result-object p0

    sget-object v0, LoU0$d;->p:LoU0$d;

    invoke-virtual {p0, v0}, LoU0$a;->k(LoU0$d;)LoU0$a;

    move-result-object p0

    invoke-static {p1}, Lcom/google/firebase/messaging/b;->k(Landroid/os/Bundle;)LoU0$c;

    move-result-object v0

    invoke-virtual {p0, v0}, LoU0$a;->h(LoU0$c;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->g(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->l(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->c(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->b(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0}, LoU0$a;->d(Ljava/lang/String;)LoU0$a;
    ...
    invoke-virtual {p0, v0, v1}, LoU0$a;->j(J)LoU0$a;

    :cond_7
    invoke-virtual {p0}, LoU0$a;->a()LoU0;
...
.method public static f(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lp50;->q(LM40;)Lp50;

    move-result-object p0

    invoke-virtual {p0}, Lp50;->getId()LD12;

    move-result-object p0

    invoke-static {p0}, LT12;->a(LD12;)Ljava/lang/Object;
...
.method public static k(Landroid/os/Bundle;)LoU0$c;
    .locals 0
    ...
    sget-object p0, LoU0$c;->r:LoU0$c;

    goto :goto_0

    :cond_0
    sget-object p0, LoU0$c;->p:LoU0$c;
...
.method public static n(Landroid/os/Bundle;)J
    ...
    invoke-virtual {p0}, LG50;->c()Ljava/lang/String;
    ...
    sget-object v0, Lcom/google/firebase/perf/metrics/Jypt/EMyvHaO;->mhKALSSHonvuseC:Ljava/lang/String;
...
.method public static v(Landroid/content/Intent;)V
    ...
    sget-object v0, LoU0$b;->p:LoU0$b;

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->s()LP62;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lcom/google/firebase/messaging/b;->w(LoU0$b;Landroid/content/Intent;LP62;)V

    :cond_1
    return-void
.end method

.method public static w(LoU0$b;Landroid/content/Intent;LP62;)V
    .locals 5
    ...
    :cond_0
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->b(LoU0$b;Landroid/content/Intent;)LoU0;
    ...
    invoke-static {p1}, LKo1;->b(Ljava/lang/Integer;)LKo1;
    ...
    invoke-interface {p2, v1, v2, v3, v4}, LP62;->a(Ljava/lang/String;Ljava/lang/Class;LqX;Ll62;)LH62;

    move-result-object p2

    invoke-static {}, LpU0;->b()LpU0$a;

    move-result-object v1

    invoke-virtual {v1, p0}, LpU0$a;->b(LoU0;)LpU0$a;

    move-result-object p0

    invoke-virtual {p0}, LpU0$a;->a()LpU0;

    move-result-object p0

    invoke-static {p0, p1}, LjY;->f(Ljava/lang/Object;LKo1;)LjY;

    move-result-object p0

    invoke-interface {p2, p0}, LH62;->b(LjY;)V
    :try_end_0
...
.method public static x(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, v2}, LM40;->j(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v0, p0, v1}, Lh4;->d(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static y(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v3}, LM40;->j(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    sget-object v2, Lorg/joda/time/base/vu/yTnfXwtQHEQ;->cYvbe:Ljava/lang/String;

    invoke-interface {v0, v2, v1, p0}, Lh4;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v2, p0, v1}, Lh4;->d(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
