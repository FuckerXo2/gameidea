...
.method public e(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, LAN1;->c()Landroid/content/Intent;
...
.method public final m(Landroid/content/Intent;)V
    ...
    invoke-static {}, Lx20;->e()Ljava/util/concurrent/ExecutorService;

    move-result-object v2

    new-instance v3, LaS;

    invoke-direct {v3, p0, v1, v2}, LaS;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->r(Lcom/google/firebase/messaging/d;)V
...
.method public final o(Landroid/content/Context;)LRF1;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->s:LRF1;
    ...
    invoke-direct {v0, p1}, LRF1;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->s:LRF1;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->s:LRF1;
...
.method public final p(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-virtual {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->o(Landroid/content/Context;)LRF1;

    move-result-object v0

    new-instance v1, Lus;

    invoke-direct {v1, p1}, Lus;-><init>(Landroid/content/Intent;)V

    invoke-virtual {v0, v1}, LRF1;->b(Lus;)LD12;
...
.method public final v(Landroid/content/Intent;)V
    ...
    sget-object v0, Lcom/playchat/ui/fragment/conversation/messagereactions/xc/FPwILAvsMI;->ayAlQdCTyJ:Ljava/lang/String;
    ...
    invoke-direct {v1, p1}, LPM1;-><init>(Ljava/lang/String;)V
