...
.method public static b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p0, v1}, LzN1;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static e(Ljava/lang/Class;Ljava/lang/Iterable;Ljava/lang/ClassLoader;LzN1$b;)Ljava/util/List;
    .locals 1

    invoke-static {p2}, LzN1;->d(Ljava/lang/ClassLoader;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, LzN1;->b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    :cond_0
    invoke-static {p0, p2}, LzN1;->c(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/lang/Iterable;
    ...
    invoke-interface {p3, p2}, LzN1$b;->a(Ljava/lang/Object;)Z
    ...
    :cond_2
    new-instance p0, LzN1$a;

    invoke-direct {p0, p3}, LzN1$a;-><init>(LzN1$b;)V
