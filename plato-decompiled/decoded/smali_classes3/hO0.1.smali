...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, LfO0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Llb1;)Ljava/util/HashMap;
    .locals 2
    ...
    invoke-static {v0, p0}, LhO0;->r(Ljava/util/Map;[Llb1;)V

    return-object v0
.end method

.method public static varargs k([Llb1;)Ljava/util/Map;
    .locals 2
    ...
    invoke-static {p0, v0}, LhO0;->v([Llb1;Ljava/util/Map;)Ljava/util/Map;
...
.method public static l(Ljava/util/Map;Ljava/lang/Object;)Ljava/util/Map;
    ...
    invoke-static {p0}, LhO0;->n(Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs m([Llb1;)Ljava/util/Map;
    .locals 2
...
.method public static final n(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, LgO0;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static o(Ljava/util/Map;Llb1;)Ljava/util/Map;
    .locals 1
...
.method public static final r(Ljava/util/Map;[Llb1;)V
    .locals 4
...
.method public static s(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, LhO0;->t(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, LgO0;->e(Llb1;)Ljava/util/Map;
...
.method public static t(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {p1, p0}, LhO0;->q(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final v([Llb1;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {p1, p0}, LhO0;->r(Ljava/util/Map;[Llb1;)V
