...
# virtual methods
.method public final a(Landroid/content/Context;LD80;)Landroidx/emoji2/text/c$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/e;-><init>(Landroid/content/Context;LD80;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/c$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/a$a;->h(Landroid/content/Context;)LD80;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Landroidx/emoji2/text/a$a;->a(Landroid/content/Context;LD80;)Landroidx/emoji2/text/c$c;
...
.method public final d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)LD80;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, LD80;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public final g(Landroid/content/pm/PackageManager;)Landroid/content/pm/ProviderInfo;
    ...
    sget-object v2, Lcom/playchat/ui/fragment/lobby/base/purchase/zXe/yLWfR;->nwQOTcmXyFFfN:Ljava/lang/String;
...
.method public h(Landroid/content/Context;)LD80;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, v0, p1}, Landroidx/emoji2/text/a$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)LD80;
