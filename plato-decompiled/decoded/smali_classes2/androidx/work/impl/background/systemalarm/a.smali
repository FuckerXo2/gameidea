...
.method public constructor <init>(Landroid/content/Context;LQr;LgW1;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->q:LQr;

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/a;->r:LgW1;
...
.method public static c(Landroid/content/Context;Lwi2;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/background/systemalarm/a;->q(Landroid/content/Intent;Lwi2;)Landroid/content/Intent;
...
.method public static d(Landroid/content/Context;Lwi2;Z)Landroid/content/Intent;
    .locals 2
...
.method public static e(Landroid/content/Context;Lwi2;)Landroid/content/Intent;
    .locals 2
...
.method public static f(Landroid/content/Context;Lwi2;)Landroid/content/Intent;
    .locals 2
...
.method public static p(Landroid/content/Intent;)Lwi2;
    .locals 4
...
.method public static q(Landroid/content/Intent;Lwi2;)Landroid/content/Intent;
    .locals 2
...
.method public b(Lwi2;Z)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->r:LgW1;

    invoke-virtual {v2, p1}, LgW1;->b(Lwi2;)LfW1;
...
.method public final g(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->q:LQr;

    invoke-direct {p1, v0, v1, p2, p3}, Landroidx/work/impl/background/systemalarm/b;-><init>(Landroid/content/Context;LQr;ILandroidx/work/impl/background/systemalarm/d;)V
...
.method public final h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/work/impl/background/systemalarm/a;->p(Landroid/content/Intent;)Lwi2;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/a;->r:LgW1;

    invoke-virtual {v3, p1}, LgW1;->d(Lwi2;)LfW1;

    move-result-object v3

    invoke-direct {v1, v2, p2, p3, v3}, Landroidx/work/impl/background/systemalarm/c;-><init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;LfW1;)V
    ...
    invoke-virtual {p2, v2, p1}, LOK0;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final i(Landroid/content/Intent;I)V
    ...
    sget-object v5, Lcom/google/android/gms/common/api/internal/LJ/SzuMyrJEWCE;->cMITO:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, p1}, LOK0;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/a;->b(Lwi2;Z)V
...
.method public final k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-interface {v2, v3}, LWi2;->q(Ljava/lang/String;)LVi2;
    ...
    invoke-virtual {p2, v1, p1}, LOK0;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, LVi2;->b:Lxi2;

    invoke-virtual {v4}, Lxi2;->g()Z
    ...
    invoke-virtual {p2, v1, p3}, LOK0;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->n:Landroid/content/Context;

    invoke-static {p2, v0, p1, v3, v4}, LT3;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lwi2;J)V
    ...
    invoke-virtual {v2, v1, v5}, LOK0;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->n:Landroid/content/Context;

    invoke-static {v1, v0, p1, v3, v4}, LT3;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lwi2;J)V
...
.method public final l(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-direct {v3, v0, p1}, Lwi2;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v2, v3}, LgW1;->b(Lwi2;)LfW1;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->r:LgW1;

    invoke-virtual {p1, v0}, LgW1;->c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/d;->i()LCi2;

    move-result-object v2

    invoke-interface {v2, v1}, LCi2;->b(LfW1;)V

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->n:Landroid/content/Context;

    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/d;->g()LFi2;

    move-result-object v3

    invoke-virtual {v3}, LFi2;->r()Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {v2, v3, v4}, LT3;->a(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Lwi2;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/d;->b(Lwi2;Z)V
...
.method public o(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p1, p2, p3}, LOK0;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p3, p1}, LOK0;->k(Ljava/lang/String;Ljava/lang/String;)V
