...
.method static constructor <clinit>()V
    ...
    sput-object v0, LIm0;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, LIm0;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, LCm0;->h(Landroid/content/Context;I)I
    ...
    invoke-virtual {v1, p0, p1, v0}, LCm0;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v0, p1, v1, p0}, LGm0;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static c(I)Ljava/lang/String;
    ...
    invoke-static {p0}, LJx;->R(I)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lqj2;->a(Landroid/content/Context;)Lhb1;
    ...
    invoke-static {p0}, LJm0;->a(Landroid/content/Context;)LJm0;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, LJm0;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, LJm0;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, LIm0;->c:Z
    ...
    :cond_0
    sput-boolean v1, LIm0;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, LIm0;->d:Z
    ...
    :cond_1
    :goto_3
    sget-boolean p0, LIm0;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, LiQ;->b()Z
...
.method public static g(Landroid/content/Context;I)I
    ...
    sget-object v1, LIm0;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Luo2;->a(Landroid/content/Context;)I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, LiQ;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, LiQ;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, LJm0;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, LJm0;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, LAn2;->a(I)I

    move-result p0

    invoke-static {p1}, LAn2;->a(I)I
    ...
    sget-object v1, Lcom/playchat/ui/recyclerview/wDM/AyqmZSxztjTq;->jiKFXVUrchexRh:Ljava/lang/String;
...
.method public static h(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, LIm0;->l(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static k(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, LM82;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method public static l(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, LIm0;->i(Landroid/content/Context;)Z
