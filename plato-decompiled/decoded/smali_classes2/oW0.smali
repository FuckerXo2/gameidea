...
.field public final r:Ljava/nio/channels/FileChannel;

.field public final s:Ljava/nio/channels/FileLock;
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    sget-object v1, Lorg/joda/time/base/vu/yTnfXwtQHEQ;->CLXKMckpf:Ljava/lang/String;
    ...
    iput-object p1, p0, LoW0;->n:Ljava/io/File;

    iput-object p2, p0, LoW0;->p:Ljava/io/File;

    invoke-static {p1}, LoW0;->q(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, LoW0;->o:J
    ...
    iput-object p2, p0, LoW0;->q:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, LoW0;->r:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, LoW0;->s:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, LoW0;->r:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, LoW0;->b(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, LoW0;->q:Ljava/io/RandomAccessFile;
...
.method public static c0(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2

    invoke-static {p0}, LoW0;->o(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static g(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, LoW0;->b(Ljava/io/Closeable;)V
...
.method public static q(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lqk2;->c(Ljava/io/File;)J
...
.method public static r(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, LoW0;->p(Ljava/io/File;)J
...
.method public final J(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, LoW0;->n:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, LoW0;->o(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    sget-object v8, Lcom/google/android/material/sidesheet/Nam/fAifudAiCAyGf;->mBfx:Ljava/lang/String;
    ...
    new-instance v8, LoW0$b;

    iget-object v9, v0, LoW0;->p:Ljava/io/File;

    invoke-direct {v8, v9, v7}, LoW0$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, LoW0;->q(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, LoW0$b;->n:J
...
.method public final Q()Ljava/util/List;
    ...
    iget-object v6, v1, LoW0;->n:Ljava/io/File;
    ...
    invoke-virtual/range {p0 .. p0}, LoW0;->a()V
    ...
    iget-object v0, v1, LoW0;->n:Ljava/io/File;
    ...
    iget-object v12, v1, LoW0;->p:Ljava/io/File;

    invoke-direct {v11, v12, v0}, LoW0$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v11, v6}, LoW0;->g(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, LoW0;->q(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, LoW0$b;->n:J
    :try_end_1
...
.method public final a()V
    ...
    iget-object v0, p0, LoW0;->p:Ljava/io/File;
    ...
    iget-object v2, p0, LoW0;->p:Ljava/io/File;
...
.method public close()V
    ...
    iget-object v0, p0, LoW0;->s:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, LoW0;->r:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/spi/AbstractInterruptibleChannel;->close()V

    iget-object v0, p0, LoW0;->q:Ljava/io/RandomAccessFile;
...
.method public u(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, LoW0;->n:Ljava/io/File;
    ...
    iget-object v0, p0, LoW0;->n:Ljava/io/File;

    iget-wide v2, p0, LoW0;->o:J

    invoke-static {p1, v0, v2, v3, p2}, LoW0;->r(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2}, LoW0;->J(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0}, LoW0;->Q()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, LoW0;->n:Ljava/io/File;

    invoke-static {v0}, LoW0;->p(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, LoW0;->o:J
    ...
    invoke-static/range {v2 .. v8}, LoW0;->c0(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
