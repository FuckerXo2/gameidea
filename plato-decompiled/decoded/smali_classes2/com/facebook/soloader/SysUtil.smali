...
# direct methods
.method public static a(Ljava/io/DataOutput;Ljava/io/InputStream;I[B)I
    .locals 4
...
.method public static i(Ljava/io/File;Z)LV30;
    .locals 0

    if-eqz p1, :cond_0

    invoke-static {p0}, LV30;->b(Ljava/io/File;)LV30;
    ...
    :cond_0
    invoke-static {p0}, LV30;->g(Ljava/io/File;)LV30;
...
.method public static j(Ljava/io/File;Ljava/io/File;Z)LV30;
    .locals 7

    const/4 v0, 0x0

    sget-object v0, Lorg/mediasoup/droid/lib/lv/DN/XHYck;->uvrheRRZokqOKm:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p1, p2}, Lcom/facebook/soloader/SysUtil;->i(Ljava/io/File;Z)LV30;
