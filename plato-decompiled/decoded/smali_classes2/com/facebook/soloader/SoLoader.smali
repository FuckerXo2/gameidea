...
.field public static b:LdU1;

.field public static final c:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

.field public static volatile d:[LeU1;

.field public static final e:Ljava/util/concurrent/atomic/AtomicInteger;

.field public static f:[Ly92;

.field public static g:Lp9;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
...
.method public static a(Landroid/content/Context;Ljava/util/ArrayList;I)V
    ...
    sput-object p1, Lcom/facebook/soloader/SoLoader;->f:[Ly92;

    invoke-static {p0, v1}, Ly92;->r(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {v4, p0, v0, v1, p2}, LM6;-><init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;I)V
    ...
    sput-object p0, Lcom/facebook/soloader/SoLoader;->f:[Ly92;
...
.method public static b(Ljava/util/ArrayList;[Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3, p1}, Lcom/facebook/soloader/b;-><init>(Ljava/io/File;I[Ljava/lang/String;)V
...
.method public static c(Landroid/content/Context;Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, p0, p2}, Lp9;-><init>(Landroid/content/Context;I)V

    sput-object v0, Lcom/facebook/soloader/SoLoader;->g:Lp9;
    ...
    sget-object v0, Lcom/facebook/soloader/SoLoader;->g:Lp9;

    invoke-virtual {v0}, Lp9;->toString()Ljava/lang/String;
    ...
    sget-object p2, Lcom/facebook/soloader/SoLoader;->g:Lp9;
...
.method public static d(Landroid/content/Context;ILjava/util/ArrayList;)V
    .locals 10
    ...
    invoke-direct {v7, p0, v8, v5, p1}, LM6;-><init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;I)V
...
.method public static e(Landroid/content/Context;Ljava/util/ArrayList;)V
    ...
    invoke-direct {v7, v8}, Lcom/facebook/soloader/a;-><init>(Ljava/io/File;)V
    ...
    :cond_0
    invoke-virtual {v7}, Lcom/facebook/soloader/a;->g()Z
    ...
    invoke-direct {v0, p0}, Lcom/facebook/soloader/a;-><init>(Landroid/content/Context;)V
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/facebook/soloader/a;->g()Z
...
.method public static f()V
    ...
    invoke-static {}, Lcom/facebook/soloader/SoLoader;->p()Z
...
.method public static g(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)V
    .locals 12
    ...
    :try_start_0
    sget-object v2, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    :try_end_0
    ...
    :try_start_2
    sget-object v9, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    ...
    invoke-virtual {v9, p0, p1, p2}, LeU1;->a(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)I

    move-result v1

    if-ne v1, v7, :cond_4

    sget-object v9, Lcom/facebook/soloader/SoLoader;->f:[Ly92;
    ...
    :cond_2
    :goto_2
    sget-object v8, Lcom/facebook/soloader/SoLoader;->f:[Ly92;
    ...
    invoke-virtual {v11, p0}, Ly92;->t(Ljava/lang/String;)V

    invoke-virtual {v11, p0, p1, p2}, Ly92;->a(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)I
    ...
    :goto_6
    sget-object p0, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    ...
    invoke-virtual {p0}, LeU1;->toString()Ljava/lang/String;
    ...
    :cond_9
    sget-object p0, Lcom/facebook/soloader/SoLoader;->g:Lp9;

    if-eqz p0, :cond_a

    invoke-virtual {p0}, Lp9;->e()Landroid/content/Context;

    move-result-object p0

    invoke-static {p0}, Lp9;->d(Landroid/content/Context;)Ljava/io/File;
...
.method public static init(Landroid/content/Context;I)V
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/facebook/soloader/SoLoader;->k(Landroid/content/Context;ILdU1;[Ljava/lang/String;)V
...
.method public static k(Landroid/content/Context;ILdU1;[Ljava/lang/String;)V
    .locals 4
    ...
    :try_start_0
    invoke-static {p0}, Lcom/facebook/soloader/SoLoader;->m(Landroid/content/Context;)Z
    ...
    :cond_1
    :goto_0
    invoke-static {p2}, Lcom/facebook/soloader/SoLoader;->n(LdU1;)V

    invoke-static {p0, p1, p3}, Lcom/facebook/soloader/SoLoader;->o(Landroid/content/Context;I[Ljava/lang/String;)V
    ...
    invoke-static {p0}, LCX0;->b(LDX0;)V

    goto :goto_1

    :cond_2
    invoke-static {}, Lcom/facebook/soloader/SoLoader;->l()V
...
.method public static l()V
    ...
    sget-object v0, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    ...
    :try_start_0
    sget-object v1, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-object v1, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static declared-synchronized n(LdU1;)V
    .locals 7
    ...
    :try_start_0
    sget-object v1, Lcom/facebook/soloader/SoLoader;->b:LdU1;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    sput-object p0, Lcom/facebook/soloader/SoLoader;->b:LdU1;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_3
    invoke-static {v3}, Lcom/facebook/soloader/SoLoader;->v(Ljava/lang/String;)Ljava/lang/String;
...
.method public static o(Landroid/content/Context;I[Ljava/lang/String;)V
    .locals 5
    ...
    invoke-direct {p1, p0, v2}, LM00;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/facebook/soloader/SoLoader;->w()I
    ...
    invoke-virtual {v3, p1}, LeU1;->b(I)V
    ...
    :cond_9
    sput-object p0, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
    ...
    sget-object p1, Lcom/facebook/soloader/SoLoader;->d:[LeU1;
...
.method public static q(Ljava/lang/String;I)Z
    ...
    invoke-static {p0}, Lcom/facebook/soloader/SoLoader;->u(Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, LCX0;->d(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p0}, LZS0;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p0, v0, p1, v2}, Lcom/facebook/soloader/SoLoader;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z
...
.method public static r(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)V
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0, v0, p1, p2}, Lcom/facebook/soloader/SoLoader;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z

    return-void
.end method

.method public static s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z
    .locals 7
    ...
    :cond_0
    :try_start_0
    invoke-static {p0, p1, p2, p3, p4}, Lcom/facebook/soloader/SoLoader;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z
    ...
    :try_start_1
    sget-object v4, Lcom/facebook/soloader/SoLoader;->g:Lp9;

    if-eqz v4, :cond_1

    sget-object v4, Lcom/facebook/soloader/SoLoader;->g:Lp9;

    invoke-virtual {v4}, Lp9;->c()Z
...
.method public static t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z
    .locals 10
    ...
    :cond_c
    :goto_6
    invoke-static {p1}, LZS0;->a(Ljava/lang/String;)V
    ...
    sget-object p0, Lcom/playchat/domain/chips/welcomebonus/exception/qNr/LwpYUvfroS;->ZboMUNlvGGFNJQ:Ljava/lang/String;
...
.method public static v(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/google/android/material/button/Be/tPsZknCpn;->TSHsNCmmMLONokp:Ljava/lang/String;
