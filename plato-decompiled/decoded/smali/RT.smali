...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0, v0}, LRT;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, LRT;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0, p1}, LRT;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
...
.method public static c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, LRT;->e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method public static e(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, LyT;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p2}, LyT;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static g(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0}, LHT;->a(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, LJT;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;

    move-result-object p0

    invoke-static {p0}, LLT;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static l(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    invoke-static {p0, p1}, LRT$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, LRT$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
...
.method public static m(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p0, p1}, LyT;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    :goto_1
    return-void
.end method

.method public static n(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    .locals 1
