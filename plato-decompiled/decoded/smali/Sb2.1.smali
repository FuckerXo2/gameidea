...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, LSb2$a;-><init>()V

    sput-object v0, LSb2;->a:Ljava/lang/ThreadLocal;

    new-instance v0, LSb2$b;

    invoke-direct {v0}, LSb2$b;-><init>()V

    sput-object v0, LSb2;->b:Ljava/lang/ThreadLocal;

    new-instance v0, LSb2$c;

    invoke-direct {v0}, LSb2$c;-><init>()V

    sput-object v0, LSb2;->c:Ljava/lang/ThreadLocal;

    new-instance v0, LSb2$d;

    invoke-direct {v0}, LSb2$d;-><init>()V

    sput-object v0, LSb2;->d:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    :cond_0
    sget-object v0, LSb2;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, LSb2;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, LSb2;->c:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, LmV0;->f(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, LmV0;->f(FF)I
...
.method public static b(Landroid/graphics/Path;Lp72;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lp72;->l()Z
    ...
    invoke-virtual {p1}, Lp72;->g()Lxg;

    move-result-object v1

    check-cast v1, Lg70;

    invoke-virtual {v1}, Lg70;->q()F

    move-result v1

    invoke-virtual {p1}, Lp72;->h()Lxg;

    move-result-object p1

    check-cast p1, Lg70;

    invoke-virtual {p1}, Lg70;->q()F
    ...
    invoke-static {p0, v0, v1, p1}, LSb2;->a(Landroid/graphics/Path;FFF)V
...
.method public static g(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, LSb2;->d:Ljava/lang/ThreadLocal;
...
.method public static m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, LSb2;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
