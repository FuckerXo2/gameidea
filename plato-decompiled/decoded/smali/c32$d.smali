...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Lc32$d;->a:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, Lc32$d;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lc32$d;->f:Z
...
.method public final b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lc32$d;->a()Landroid/content/Intent;

    move-result-object v0

    invoke-virtual {p0, p2}, Lc32$d;->e(Landroid/widget/TextView;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-virtual {p0, v1, p1}, Lc32$d;->f(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public d()Landroid/view/ActionMode$Callback;
    ...
    iget-object v0, p0, Lc32$d;->a:Landroid/view/ActionMode$Callback;
...
.method public final g(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Lc32$d;->b:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lc32$d;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Lc32$d;->d:Ljava/lang/reflect/Method;

    iput-boolean v5, p0, Lc32$d;->e:Z
    :try_end_0
    ...
    iput-boolean v4, p0, Lc32$d;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Lc32$d;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Lc32$d;->c:Ljava/lang/Class;
    ...
    iget-object v2, p0, Lc32$d;->d:Ljava/lang/reflect/Method;
    ...
    :cond_3
    invoke-virtual {p0, v0, v1}, Lc32$d;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Lc32$d;->b:Landroid/widget/TextView;

    invoke-virtual {p0, v3, v7}, Lc32$d;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-virtual {p0, p2}, Lc32$d;->g(Landroid/view/Menu;)V
