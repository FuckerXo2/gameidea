...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, LBE$a;-><init>(LrM;)V

    sput-object v0, LBE;->g:LBE$a;

    return-void
.end method

.method public constructor <init>(LRu;LBE$b;)V
    .locals 4
    ...
    iput-object p1, p0, LBE;->a:LRu;

    iput-object p2, p0, LBE;->b:LBE$b;
    ...
    iput-object p2, p0, LBE;->d:Ljava/util/List;

    new-instance p2, Lc3;

    invoke-direct {p2}, Lc3;-><init>()V

    new-instance v0, LAE;

    invoke-direct {v0, p0}, LAE;-><init>(LBE;)V

    invoke-virtual {p1, p2, v0}, LRu;->P0(LZ2;LY2;)Lf3;
    ...
    iput-object p1, p0, LBE;->f:Lf3;

    return-void
.end method

.method public static synthetic a(LBE;LX2;)V
    .locals 0

    invoke-static {p0, p1}, LBE;->e(LBE;LX2;)V

    return-void
.end method

.method public static final e(LBE;LX2;)V
    .locals 2
    ...
    :cond_0
    iget-object p1, p0, LBE;->e:Landroid/net/Uri;

    :cond_1
    iget-object p0, p0, LBE;->b:LBE$b;

    invoke-interface {p0, p1}, LBE$b;->a(Landroid/net/Uri;)V
...
.method public final b(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-static {v2, v3}, LyE;->a(J)Landroid/content/pm/PackageManager$ResolveInfoFlags;

    move-result-object v2

    invoke-static {p2, v1, v2}, LzE;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Ljava/util/List;
    ...
    iget-object v4, p0, LBE;->e:Landroid/net/Uri;
...
.method public final c(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v4, v5}, LyE;->a(J)Landroid/content/pm/PackageManager$ResolveInfoFlags;

    move-result-object p2

    invoke-static {p1, v1, p2}, LzE;->a(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/pm/PackageManager$ResolveInfoFlags;)Ljava/util/List;
    ...
    iget-object p2, p0, LBE;->d:Ljava/util/List;
...
.method public final d(Landroid/content/Context;)Z
    ...
    invoke-static {v2, v3}, LwE;->a(J)Landroid/content/pm/PackageManager$PackageInfoFlags;

    move-result-object v2

    invoke-static {p1, v0, v2}, LxE;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;Landroid/content/pm/PackageManager$PackageInfoFlags;)Landroid/content/pm/PackageInfo;
...
.method public final f(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, LBE;->d(Landroid/content/Context;)Z
...
.method public final g(Ljava/lang/String;)LBE;
    .locals 1
...
.method public final h(Ljava/util/List;)LBE;
    .locals 1
    ...
    iput-object p1, p0, LBE;->d:Ljava/util/List;
...
.method public final i(ZZLandroid/net/Uri;)V
    ...
    iput-object p3, p0, LBE;->e:Landroid/net/Uri;

    new-instance p3, Ljava/util/ArrayList;

    invoke-direct {p3}, Ljava/util/ArrayList;-><init>()V

    iget-object v0, p0, LBE;->a:LRu;

    invoke-virtual {v0}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iget-object v1, p0, LBE;->a:LRu;

    invoke-virtual {p0, v1}, LBE;->f(Landroid/content/Context;)Z
    ...
    iget-object p1, p0, LBE;->a:LRu;

    invoke-static {v0, v2}, LJz0;->e(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {p0, p1, v0}, LBE;->b(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0, v1}, LBE;->c(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0, p1}, LBE;->c(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_0
    iget-object p2, p0, LBE;->c:Ljava/lang/String;
    ...
    iget-object p2, p0, LBE;->f:Lf3;

    invoke-virtual {p2, p1}, Lf3;->a(Ljava/lang/Object;)V
