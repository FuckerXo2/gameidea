...
.method public static b(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, Lvz$c;->a(Landroid/content/Context;)Landroid/content/Context;
...
.method public static c(Landroid/content/Context;I)I
    ...
    invoke-static {p0, p1}, Lvz$b;->a(Landroid/content/Context;I)I
...
.method public static d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, p0}, LpC1;->e(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static e(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {p0}, LpK0;->a(Landroid/content/Context;)LmK0;
    ...
    invoke-static {v1, v0}, LRw;->b(Landroid/content/res/Configuration;LmK0;)V
...
.method public static f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Lvz$a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static i(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0}, Lvz$a;->c(Landroid/content/Context;)Ljava/io/File;
...
.method public static j(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lvz;->e(Landroid/content/Context;)Landroid/content/Context;
...
.method public static k(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lvz$b;->b(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static l(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, LBc1;->b(Landroid/content/Context;Ljava/lang/String;)I
...
.method public static m(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lvz;->n(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
...
.method public static n(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lvz$e;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    invoke-static/range {v0 .. v5}, Lvz$d;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
...
.method public static q(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lvz$d;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
