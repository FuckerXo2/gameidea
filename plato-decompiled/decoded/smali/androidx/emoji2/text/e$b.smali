...
# direct methods
.method public constructor <init>(Landroid/content/Context;LD80;Landroidx/emoji2/text/e$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, LTj1;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/e$b;->b:LD80;
...
.method public c()V
    ...
    :try_start_1
    invoke-virtual {p0}, Landroidx/emoji2/text/e$b;->e()LH80$b;

    move-result-object v0

    invoke-virtual {v0}, LH80$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/e$a;->a(Landroid/content/Context;LH80$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/e$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, LH80$b;->d()Landroid/net/Uri;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v2, v3, v0}, Lj82;->e(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method public d()V
    ...
    invoke-static {v1}, LPv;->b(Ljava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct {v2, p0}, LE80;-><init>(Landroidx/emoji2/text/e$b;)V
...
.method public final e()LH80$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/e$b;->b:LD80;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/e$a;->b(Landroid/content/Context;LD80;)LH80$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, LH80$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, LH80$a;->b()[LH80$b;
