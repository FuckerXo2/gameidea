...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/k;->I:I
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/e;Landroid/view/View;IIZ)V
    ...
    sget v2, Landroidx/appcompat/view/menu/k;->I:I
    ...
    invoke-direct {p3, p1, p6, p4, p5}, LTS0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;
...
.method public j()Landroid/widget/ListView;
    ...
    invoke-virtual {v0}, LMF0;->j()Landroid/widget/ListView;
...
.method public k(Landroidx/appcompat/view/menu/l;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;

    invoke-virtual {v2}, LMF0;->b()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;

    invoke-virtual {v3}, LMF0;->o()I
    ...
    invoke-static {v5}, Lsd2;->z(Landroid/view/View;)I
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, LMF0;->d(I)V
...
.method public w(I)V
    ...
    invoke-virtual {v0, p1}, LMF0;->l(I)V
...
.method public final z()Z
    ...
    invoke-virtual {v3, v0}, LMF0;->D(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;

    iget v3, p0, Landroidx/appcompat/view/menu/k;->G:I

    invoke-virtual {v0, v3}, LMF0;->G(I)V
    ...
    invoke-static {v0, v3, v4, v5}, LSS0;->o(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v0

    iput v0, p0, Landroidx/appcompat/view/menu/k;->F:I

    iput-boolean v1, p0, Landroidx/appcompat/view/menu/k;->E:Z
    ...
    invoke-virtual {v0, v4}, LMF0;->F(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/k;->v:LTS0;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, LMF0;->I(I)V
    ...
    invoke-virtual {v0, v4}, LMF0;->H(Landroid/graphics/Rect;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/k;->q:Landroidx/appcompat/view/menu/d;

    invoke-virtual {v0, v2}, LMF0;->p(Landroid/widget/ListAdapter;)V
