...
.method public final a()LSS0;
    ...
    invoke-virtual {v0, v1}, LSS0;->l(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, LSS0;->u(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, LSS0;->p(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LSS0;->r(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/h;->g:I

    invoke-virtual {v0, v1}, LSS0;->s(I)V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/h;->j:LSS0;
...
.method public c()LSS0;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->a()LSS0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/h;->j:LSS0;
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, LSS0;->r(Z)V
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->c()LSS0;

    move-result-object v0

    invoke-virtual {v0, p4}, LSS0;->v(Z)V
    ...
    invoke-static {p4}, Lsd2;->z(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, LXm0;->b(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, LSS0;->t(I)V

    invoke-virtual {v0, p2}, LSS0;->w(I)V
    ...
    invoke-virtual {v0, p4}, LSS0;->q(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, LuS1;->h()V
