...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Luh2;->b:Luh2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->H:Luh2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Luh2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Luh2;
    ...
    invoke-direct {p1, p0}, LWX0;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R:LWX0;
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LmJ;

    invoke-interface {v0, p1, p2}, LmJ;->a(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->R:LWX0;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, LmJ;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LmJ;

    invoke-interface {p1}, LmJ;->s()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Luh2;->w(Landroid/view/WindowInsets;Landroid/view/View;)Luh2;
    ...
    invoke-static {p0, p1, v1}, Lsd2;->f(Landroid/view/View;Luh2;Landroid/graphics/Rect;)Luh2;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Luh2;->l(IIII)Luh2;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->H:Luh2;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Luh2;

    invoke-virtual {v2, v1}, Luh2;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->H:Luh2;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Luh2;
    ...
    :cond_2
    invoke-virtual {p1}, Luh2;->a()Luh2;

    move-result-object p1

    invoke-virtual {p1}, Luh2;->c()Luh2;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, Lsd2;->K(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->H:Luh2;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, Luh2;->l(IIII)Luh2;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    invoke-virtual {v4}, Luh2;->k()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    invoke-virtual {v5}, Luh2;->j()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    invoke-virtual {v6}, Luh2;->h()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, Lhy0;->b(IIII)Lhy0;

    move-result-object v2

    new-instance v4, Luh2$b;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    invoke-direct {v4, v5}, Luh2$b;-><init>(Luh2;)V

    invoke-virtual {v4, v2}, Luh2$b;->d(Lhy0;)Luh2$b;

    move-result-object v2

    invoke-virtual {v2}, Luh2$b;->a()Luh2;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Luh2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    invoke-virtual {v2, v4}, Luh2;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Luh2;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Luh2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->p:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Lsd2;->g(Landroid/view/View;Luh2;)Luh2;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LWX0;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, LmJ;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, LmJ;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, LmJ;->l(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, LmJ;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public final t(Landroid/view/View;)LmJ;
    .locals 3
...
.method public z()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t(Landroid/view/View;)LmJ;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->r:LmJ;
