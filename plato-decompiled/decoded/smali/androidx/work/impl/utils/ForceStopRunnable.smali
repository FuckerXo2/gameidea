...
.field public final o:LFi2;

.field public final p:Lgk1;
...
.method public constructor <init>(Landroid/content/Context;LFi2;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {p2}, LFi2;->n()Lgk1;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->p:Lgk1;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {v1}, LFi2;->r()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    invoke-static {v0, v1}, Lm12;->i(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;)Z
    ...
    :try_start_0
    invoke-interface {v2}, LWi2;->l()Ljava/util/List;
    ...
    sget-object v9, Lxi2;->n:Lxi2;

    iget-object v10, v8, LVi2;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, LWi2;->h(Lxi2;Ljava/lang/String;)I

    iget-object v9, v8, LVi2;->a:Ljava/lang/String;

    const/16 v10, -0x200

    invoke-interface {v2, v9, v10}, LWi2;->g(Ljava/lang/String;I)V

    iget-object v8, v8, LVi2;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, LWi2;->c(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, LNi2;->b()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {v0}, LFi2;->u()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {v0}, LFi2;->n()Lgk1;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lgk1;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->p:Lgk1;

    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {v1}, LFi2;->k()Landroidx/work/a;
    ...
    invoke-virtual {v0, v1, v2}, Lgk1;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->o:LFi2;

    invoke-virtual {v2}, LFi2;->p()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, LL80;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->p:Lgk1;
    ...
    invoke-static {v6}, LM80;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, LN80;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, LO80;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, LOK0;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    invoke-static {v1, v0}, LXn1;->b(Landroid/content/Context;Landroidx/work/a;)Z
...
.method public run()V
    ...
    invoke-static {v0}, Lli2;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-static {v1}, Ldb2;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v1, v0}, LOK0;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()LVy;
    ...
    invoke-virtual {v1, v3, v4, v2}, LOK0;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-interface {v0, v2}, LVy;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, LOK0;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, LOK0;->c(Ljava/lang/String;Ljava/lang/String;)V
