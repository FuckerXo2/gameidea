...
# virtual methods
.method public a(LVP0$a;)LVP0;
    .locals 5

    const/4 v0, 0x0

    :try_start_0
    invoke-virtual {p0, p1}, LP02$b;->b(LVP0$a;)Landroid/media/MediaCodec;
    ...
    iget-object v2, p1, LVP0$a;->b:Landroid/media/MediaFormat;

    iget-object v3, p1, LVP0$a;->d:Landroid/view/Surface;

    iget-object v4, p1, LVP0$a;->e:Landroid/media/MediaCrypto;

    iget p1, p1, LVP0$a;->f:I
    ...
    invoke-direct {p1, v1, v0}, LP02;-><init>(Landroid/media/MediaCodec;LP02$a;)V
    :try_end_1
...
.method public b(LVP0$a;)Landroid/media/MediaCodec;
    .locals 2
    ...
    iget-object p1, p1, LVP0$a;->a:LZP0;
