...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1}, LyT$a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
...
.method public static b(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p0}, LyT$a;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method public static e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
    ...
    invoke-static {p0}, LyT$a;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/ColorFilter;
...
.method public static f(Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-static {p0}, LyT$b;->a(Landroid/graphics/drawable/Drawable;)I
...
.method public static g(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, LyT$a;->d(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method public static k(Landroid/graphics/drawable/Drawable;FF)V
    ...
    invoke-static {p0, p1, p2}, LyT$a;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public static l(Landroid/graphics/drawable/Drawable;IIII)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, LyT$a;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public static m(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0, p1}, LyT$b;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public static n(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p0, p1}, LyT$a;->g(Landroid/graphics/drawable/Drawable;I)V
...
.method public static o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p0, p1}, LyT$a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method public static p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1}, LyT$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static q(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {p0}, Lkj2;->b()Landroid/graphics/drawable/Drawable;
