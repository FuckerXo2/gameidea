...
.method public g(Landroid/view/View;Lc2;)V
    ...
    invoke-static {v7}, Lcom/google/android/material/textfield/TextInputLayout;->g(Lcom/google/android/material/textfield/TextInputLayout;)LcW1;

    move-result-object v7

    invoke-virtual {v7, p2}, LcW1;->A(Lc2;)V

    if-nez v6, :cond_4

    invoke-virtual {p2, v0}, Lc2;->C0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Lc2;->C0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v3}, Lc2;->C0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Lc2;->p0(Ljava/lang/CharSequence;)V

    invoke-virtual {p2, v6}, Lc2;->z0(Z)V
    ...
    :goto_5
    invoke-virtual {p2, v4}, Lc2;->r0(I)V
    ...
    :goto_6
    invoke-virtual {p2, v2}, Lc2;->l0(Ljava/lang/CharSequence;)V

    :cond_a
    iget-object v0, p0, Lcom/google/android/material/textfield/TextInputLayout$d;->d:Lcom/google/android/material/textfield/TextInputLayout;

    invoke-static {v0}, Lcom/google/android/material/textfield/TextInputLayout;->h(Lcom/google/android/material/textfield/TextInputLayout;)LAx0;

    move-result-object v0

    invoke-virtual {v0}, LAx0;->t()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_b

    invoke-virtual {p2, v0}, Lc2;->q0(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, LyX;->o(Landroid/view/View;Lc2;)V
...
.method public h(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1, p2}, LJ1;->h(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {v0, p1, p2}, LyX;->p(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
