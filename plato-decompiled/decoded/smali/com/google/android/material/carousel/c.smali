...
.method public static f(Lgo;Lcom/google/android/material/carousel/b;FFF)Lcom/google/android/material/carousel/c;
    .locals 1

    new-instance v0, Lcom/google/android/material/carousel/c;

    invoke-static {p0, p1, p2, p3}, Lcom/google/android/material/carousel/c;->p(Lgo;Lcom/google/android/material/carousel/b;FF)Ljava/util/List;

    move-result-object p3

    invoke-static {p0, p1, p2, p4}, Lcom/google/android/material/carousel/c;->n(Lgo;Lcom/google/android/material/carousel/b;FF)Ljava/util/List;
...
.method public static n(Lgo;Lcom/google/android/material/carousel/b;FF)Ljava/util/List;
    .locals 18
    ...
    invoke-interface/range {p0 .. p0}, Lgo;->n()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-interface/range {p0 .. p0}, Lgo;->a()I
    ...
    :cond_0
    invoke-interface/range {p0 .. p0}, Lgo;->b()I
    ...
    :goto_1
    invoke-static/range {p0 .. p1}, Lcom/google/android/material/carousel/c;->r(Lgo;Lcom/google/android/material/carousel/b;)Z
...
.method public static o(Ljava/util/List;F[F)[F
    ...
    invoke-static {v5, p2, v2, v6, p1}, Ll6;->b(FFFFF)F
...
.method public static p(Lgo;Lcom/google/android/material/carousel/b;FF)Ljava/util/List;
    .locals 18
...
.method public static r(Lgo;Lcom/google/android/material/carousel/b;)Z
    .locals 3

    invoke-interface {p0}, Lgo;->b()I

    move-result v0

    invoke-interface {p0}, Lgo;->n()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {p0}, Lgo;->a()I
...
.method public static u(Lcom/google/android/material/carousel/b;FFZF)Lcom/google/android/material/carousel/b;
    ...
    invoke-static {v10, v3, v9}, Lko;->b(FFF)F
...
.method public i(IIIZ)Ljava/util/Map;
    ...
    invoke-static {v4, v2, v8}, LZO0;->b(III)I
    ...
    invoke-static {v3, v2, v8}, LZO0;->b(III)I
...
.method public k(FFFZ)Lcom/google/android/material/carousel/b;
    ...
    invoke-static {v4, v3, p2, v0, p1}, Ll6;->b(FFFFF)F
    ...
    invoke-static {v3, v4, v1, p3, p1}, Ll6;->b(FFFFF)F
