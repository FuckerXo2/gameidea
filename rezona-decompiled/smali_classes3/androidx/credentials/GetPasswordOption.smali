...
.method public constructor <init>(Ljava/util/Set;ZLjava/util/Set;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/credentials/GetPasswordOption$Companion;->toBundle$credentials(Ljava/util/Set;)Landroid/os/Bundle;
...
.method public static final createFrom$credentials(Landroid/os/Bundle;Ljava/util/Set;Landroid/os/Bundle;)Landroidx/credentials/GetPasswordOption;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroidx/credentials/GetPasswordOption$Companion;->createFrom$credentials(Landroid/os/Bundle;Ljava/util/Set;Landroid/os/Bundle;)Landroidx/credentials/GetPasswordOption;
...
.method public static final toBundle$credentials(Ljava/util/Set;)Landroid/os/Bundle;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p0}, Landroidx/credentials/GetPasswordOption$Companion;->toBundle$credentials(Ljava/util/Set;)Landroid/os/Bundle;
