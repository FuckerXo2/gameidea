...
.method private final checkAutoLogAppEventsEnabled()Z
    ...
    .line 332
    const-string/jumbo v3, "auto_log_app_events_default"
...
.method private final loadAutoLogAppEventsSettingFromManifest()Ljava/lang/Boolean;
    ...
    const-string/jumbo v2, "ctx.packageManager.getApplicationInfo(ctx.packageName, PackageManager.GET_META_DATA)"
...
.method private final loadSettingFromManifest(Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    const-string/jumbo v1, "ctx.packageManager.getApplicationInfo(ctx.packageName, PackageManager.GET_META_DATA)"
...
.method public static final logIfAutoAppLinkEnabled()V
    ...
    const-string/jumbo v4, "ctx.packageManager.getApplicationInfo(ctx.packageName, PackageManager.GET_META_DATA)"
    ...
    const-string/jumbo v4, "com.facebook.sdk.AutoAppLinkEnabled"
    ...
    .line 274
    :cond_1
    const-string/jumbo v0, "fb_auto_applink"
...
.method private final logIfSDKSettingsChanged()V
    ...
    const-string/jumbo v8, "ctx.packageManager.getApplicationInfo(ctx.packageName, PackageManager.GET_META_DATA)"
    ...
    .line 239
    const-string/jumbo v4, "com.facebook.sdk.AdvertiserIDCollectionEnabled"

    aput-object v4, v9, v6

    .line 240
    const-string/jumbo v4, "com.facebook.sdk.MonitorEnabled"
