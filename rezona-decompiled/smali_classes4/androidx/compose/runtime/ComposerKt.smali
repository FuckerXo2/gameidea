...
.method public static final extractMovableContentAtCurrent(Landroidx/compose/runtime/ControlledComposition;Landroidx/compose/runtime/MovableContentStateReference;Landroidx/compose/runtime/SlotWriter;Landroidx/compose/runtime/Applier;)Landroidx/compose/runtime/MovableContentState;
    ...
    .line 1530
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/runtime/SlotWriter;->getCollectingSourceInformation()Z
    ...
    .line 1533
    :cond_0
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/runtime/SlotWriter;->getCollectingCalledInformation()Z
    ...
    .line 1540
    :cond_1
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/runtime/SlotWriter;->getCurrentGroup()I
    ...
    .line 1546
    invoke-virtual/range {p2 .. p2}, Landroidx/compose/runtime/SlotWriter;->getParent()I
    ...
    .line 1574
    invoke-interface/range {p3 .. p3}, Landroidx/compose/runtime/Applier;->up()V
    ...
    iget-object v9, v5, Landroidx/collection/MutableScatterMap;->values:[Ljava/lang/Object;

    aget-object v9, v9, v7

    .line 1736
    const-string/jumbo v0, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.ScopeMap"

    invoke-static {v15, v0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    .line 1738
    instance-of v0, v9, Landroidx/collection/MutableScatterSet;
    ...
    .line 1584
    invoke-virtual {v2, v3, v5}, Landroidx/compose/runtime/SlotWriter;->inGroup(Landroidx/compose/runtime/Anchor;Landroidx/compose/runtime/Anchor;)Z
    ...
    .line 1770
    invoke-virtual {v9, v4}, Landroidx/collection/MutableScatterSet;->removeElementAt(I)V
    ...
    .line 1799
    :goto_12
    invoke-virtual/range {v25 .. v25}, Landroidx/compose/runtime/SlotTable;->openWriter()Landroidx/compose/runtime/SlotWriter;
    ...
    .line 1598
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/runtime/MovableContentStateReference;->getContent$runtime()Landroidx/compose/runtime/MovableContent;

    move-result-object v0

    const v4, 0x78cc281

    invoke-virtual {v3, v4, v0}, Landroidx/compose/runtime/SlotWriter;->startGroup(ILjava/lang/Object;)V
    ...
    .line 1599
    invoke-static {v3, v4, v5, v0}, Landroidx/compose/runtime/SlotWriter;->markGroup$default(Landroidx/compose/runtime/SlotWriter;IILjava/lang/Object;)V

    .line 1600
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/runtime/MovableContentStateReference;->getParameter$runtime()Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0, v5, v3}, Landroidx/compose/runtime/SlotWriter;->moveTo(Landroidx/compose/runtime/Anchor;ILandroidx/compose/runtime/SlotWriter;)Ljava/util/List;
    ...
    invoke-virtual {v4, v3, v0}, Landroidx/compose/runtime/RecomposeScopeImpl$Companion;->hasAnchoredRecomposeScopes$runtime(Landroidx/compose/runtime/SlotTable;Ljava/util/List;)Z
    ...
    .line 1655
    invoke-virtual {v3, v1, v0, v4}, Landroidx/compose/runtime/RecomposeScopeImpl$Companion;->adoptAnchoredScopes$runtime(Landroidx/compose/runtime/SlotWriter;Ljava/util/List;Landroidx/compose/runtime/RecomposeScopeOwner;)V
