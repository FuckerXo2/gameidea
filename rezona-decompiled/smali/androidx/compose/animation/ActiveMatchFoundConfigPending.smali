...
.method public configureActiveMatch-38uP1EE(Landroidx/compose/animation/SharedElement;Landroidx/compose/animation/BoundsProvider;JJJ)Landroidx/compose/animation/SharedTransitionStateMachine$State;
    ...
    .line 397
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/animation/ActiveMatchFoundConfigPending;->getTargetData()Landroidx/compose/animation/TargetData;
    ...
    .line 399
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/animation/ActiveMatchFoundConfigPending;->getCurrentBounds()Landroidx/compose/ui/geometry/Rect;
    ...
    .line 401
    iget-object v1, v2, Landroidx/compose/animation/ActiveMatchFoundConfigPending;->targetBoundsProviderBeforeConfig:Landroidx/compose/animation/BoundsProvider;

    if-nez v1, :cond_4

    .line 402
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/animation/SharedElement;->getAllEntries()Ljava/util/List;
    ...
    .line 403
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/animation/SharedElement;->getEnabledEntries()Ljava/util/List;
    ...
    .line 400
    :goto_3
    invoke-static {v3, v1}, Landroidx/compose/animation/SharedTransitionStateMachineKt;->access$obtainBoundsFromLastTarget(Landroidx/compose/animation/SharedElement;Landroidx/compose/animation/BoundsProvider;)Landroidx/compose/ui/geometry/Rect;
    ...
    .line 407
    invoke-static/range {v9 .. v16}, Landroidx/compose/animation/SharedTransitionStateMachineKt;->access$updateTargetData-BGTQxF0(Landroidx/compose/animation/TargetData;JJJZ)V

    .line 415
    new-instance v3, Landroidx/compose/animation/ActiveMatchConfigured;

    move-object/from16 v4, p2

    invoke-direct {v3, v0, v4, v1}, Landroidx/compose/animation/ActiveMatchConfigured;-><init>(Landroidx/compose/animation/TargetData;Landroidx/compose/animation/BoundsProvider;Landroidx/compose/ui/geometry/Rect;)V

    check-cast v3, Landroidx/compose/animation/SharedTransitionStateMachine$State;
...
.method public onMatchFound(Landroidx/compose/animation/BoundsProvider;)Landroidx/compose/animation/SharedTransitionStateMachine$State;
    ...
    check-cast p1, Landroidx/compose/animation/SharedTransitionStateMachine$State;
