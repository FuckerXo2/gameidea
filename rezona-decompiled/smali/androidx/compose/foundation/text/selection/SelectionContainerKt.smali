...
.method public static final SelectionContainer(Landroidx/compose/ui/Modifier;Landroidx/compose/foundation/text/selection/Selection;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string/jumbo v9, "androidx.compose.foundation.text.selection.SelectionContainer (SelectionContainer.kt:93)"
    ...
    new-instance v8, Landroidx/compose/foundation/text/selection/SelectionContainerKt$$ExternalSyntheticLambda9;
...
.method public static final SelectionContainer(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    const-string v1, "C(SelectionContainer)N(modifier,content)57@2606L45,61@2764L18,58@2656L161:SelectionContainer.kt#eksfi3"
    ...
    const-string/jumbo v4, "androidx.compose.foundation.text.selection.SelectionContainer (SelectionContainer.kt:56)"
    ...
    .line 62
    new-instance v1, Landroidx/compose/foundation/text/selection/SelectionContainerKt$$ExternalSyntheticLambda10;

    invoke-direct {v1, v0}, Landroidx/compose/foundation/text/selection/SelectionContainerKt$$ExternalSyntheticLambda10;-><init>(Landroidx/compose/runtime/MutableState;)V
    ...
    new-instance v0, Landroidx/compose/foundation/text/selection/SelectionContainerKt$$ExternalSyntheticLambda11;

    invoke-direct {v0, p0, p1, p3, p4}, Landroidx/compose/foundation/text/selection/SelectionContainerKt$$ExternalSyntheticLambda11;-><init>(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;II)V
...
.method private static final SelectionContainer$lambda$9$0$0(Lkotlin/jvm/functions/Function2;Landroidx/compose/foundation/text/selection/SelectionManager;Landroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    ...
    const-string/jumbo v6, "androidx.compose.foundation.text.selection.SelectionContainer.<anonymous>.<anonymous>.<anonymous> (SelectionContainer.kt:137)"
    ...
    .line 140
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->isInTouchMode()Z
    ...
    .line 141
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->getHasFocus()Z
    ...
    .line 142
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->isTriviallyCollapsedSelection$foundation()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->getSelection()Landroidx/compose/foundation/text/selection/Selection;
    ...
    .line 169
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->getStartHandleLineHeight()F
    ...
    .line 171
    :cond_9
    invoke-virtual/range {p1 .. p1}, Landroidx/compose/foundation/text/selection/SelectionManager;->getEndHandleLineHeight()F
    ...
    invoke-static {v8, v4, v9}, Landroidx/compose/ui/input/pointer/SuspendingPointerInputFilterKt;->pointerInput(Landroidx/compose/ui/Modifier;Ljava/lang/Object;Landroidx/compose/ui/input/pointer/PointerInputEventHandler;)Landroidx/compose/ui/Modifier;
