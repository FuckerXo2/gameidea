...
.method public static final CommonContextMenuArea(Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;ZLkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "C(CommonContextMenuArea)N(selectionState,enabled,content):CommonContextMenuArea.kt#423gt5"
    ...
    const-string/jumbo v4, "androidx.compose.foundation.text.CommonContextMenuArea (CommonContextMenuArea.kt:75)"
    ...
    const-string v4, "CC(remember):CommonContextMenuArea.kt#9igjgp"
    ...
    invoke-direct {v2, p0, v3}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$CommonContextMenuArea$modifier$1$1;-><init>(Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;Lkotlin/coroutines/Continuation;)V
    ...
    .line 80
    invoke-static {v0, v4}, Landroidx/compose/foundation/text/contextmenu/modifier/TextContextMenuGesturesModifierKt;->showTextContextMenuOnSecondaryClick(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;)Landroidx/compose/ui/Modifier;
    ...
    .line 93
    invoke-static {v0, p2, p3, v1, v5}, Landroidx/compose/foundation/text/contextmenu/internal/PlatformDefaultTextContextMenuProviders_androidKt;->ProvideDefaultPlatformTextContextMenuProviders(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct {v0, v3, v6, v3}, Landroidx/compose/foundation/contextmenu/ContextMenuState;-><init>(Landroidx/compose/foundation/contextmenu/ContextMenuState$Status;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-static {v5, p3}, Landroidx/compose/runtime/EffectsKt;->createCompositionCoroutineScope(Lkotlin/coroutines/CoroutineContext;Landroidx/compose/runtime/Composer;)Lkotlinx/coroutines/CoroutineScope;
    ...
    .line 97
    invoke-static {p3, v6, v4}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerStart(Landroidx/compose/runtime/Composer;ILjava/lang/String;)V
    ...
    .line 97
    sget-object v6, Landroidx/compose/foundation/text/MenuItemsAvailability;->Companion:Landroidx/compose/foundation/text/MenuItemsAvailability$Companion;

    invoke-virtual {v6}, Landroidx/compose/foundation/text/MenuItemsAvailability$Companion;->getNone-JKCFgKw()I

    move-result v6

    invoke-static {v6}, Landroidx/compose/foundation/text/MenuItemsAvailability;->box-impl(I)Landroidx/compose/foundation/text/MenuItemsAvailability;
    ...
    .line 102
    :cond_f
    new-instance v7, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda5;

    invoke-direct {v7, v5}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda5;-><init>(Lkotlinx/coroutines/CoroutineScope;)V
    ...
    .line 99
    invoke-static {p0, v0, v2, v7}, Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionStateKt;->contextMenuBuilder(Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;Landroidx/compose/foundation/contextmenu/ContextMenuState;Landroidx/compose/runtime/State;Lkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function1;
    ...
    .line 120
    invoke-static {p3, v7, v4}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerStart(Landroidx/compose/runtime/Composer;ILjava/lang/String;)V
    ...
    .line 120
    :cond_12
    new-instance v7, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda7;

    invoke-direct {v7, v5, v6, p0}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda7;-><init>(Lkotlinx/coroutines/CoroutineScope;Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;)V
    ...
    new-instance v0, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda8;

    invoke-direct {v0, p0, p1, p2, p4}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda8;-><init>(Landroidx/compose/foundation/text/input/internal/selection/TextFieldSelectionState;ZLkotlin/jvm/functions/Function2;I)V
...
.method public static final CommonContextMenuArea(Landroidx/compose/foundation/text/selection/SelectionManager;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string v1, "C(CommonContextMenuArea)N(manager,content):CommonContextMenuArea.kt#423gt5"
    ...
    const-string/jumbo v3, "androidx.compose.foundation.text.CommonContextMenuArea (CommonContextMenuArea.kt:131)"
    ...
    invoke-static {v0, p1, p2, v1, v4}, Landroidx/compose/foundation/text/contextmenu/internal/PlatformDefaultTextContextMenuProviders_androidKt;->ProvideDefaultPlatformTextContextMenuProviders(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct {v0, v3, v5, v3}, Landroidx/compose/foundation/contextmenu/ContextMenuState;-><init>(Landroidx/compose/foundation/contextmenu/ContextMenuState$Status;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 139
    new-instance v2, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda3;

    invoke-direct {v2, v0}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda3;-><init>(Landroidx/compose/foundation/contextmenu/ContextMenuState;)V
    ...
    new-instance v0, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p1, p3}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda4;-><init>(Landroidx/compose/foundation/text/selection/SelectionManager;Lkotlin/jvm/functions/Function2;I)V
...
.method public static final CommonContextMenuArea(Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string/jumbo v4, "androidx.compose.foundation.text.CommonContextMenuArea (CommonContextMenuArea.kt:46)"
    ...
    invoke-static {v0, p1, p2, v1, v5}, Landroidx/compose/foundation/text/contextmenu/internal/PlatformDefaultTextContextMenuProviders_androidKt;->ProvideDefaultPlatformTextContextMenuProviders(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V
    ...
    invoke-direct {v0, v5, v6, v5}, Landroidx/compose/foundation/contextmenu/ContextMenuState;-><init>(Landroidx/compose/foundation/contextmenu/ContextMenuState$Status;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 53
    invoke-static {p2, v6, v3}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerStart(Landroidx/compose/runtime/Composer;ILjava/lang/String;)V
    ...
    .line 57
    new-instance v2, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda0;

    invoke-direct {v2, v0}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/foundation/contextmenu/ContextMenuState;)V
    ...
    .line 60
    invoke-static {p2, v8, v3}, Landroidx/compose/runtime/ComposerKt;->sourceInformationMarkerStart(Landroidx/compose/runtime/Composer;ILjava/lang/String;)V
    ...
    .line 60
    :cond_b
    new-instance v8, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda1;

    invoke-direct {v8, v4, v6, p0}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda1;-><init>(Lkotlinx/coroutines/CoroutineScope;Landroidx/compose/runtime/MutableState;Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;)V
    ...
    new-instance v0, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1, p3}, Landroidx/compose/foundation/text/CommonContextMenuAreaKt$$ExternalSyntheticLambda2;-><init>(Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Lkotlin/jvm/functions/Function2;I)V
