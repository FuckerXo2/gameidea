...
.method public headers(ZIILjava/util/List;)V
    ...
    invoke-virtual {v3, v8}, Lokhttp3/internal/http2/Http2Connection;->pushedStream$okhttp(I)Z
    ...
    invoke-virtual {v3, v8, v2, v0}, Lokhttp3/internal/http2/Http2Connection;->pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    check-cast v10, Lokhttp3/internal/concurrent/Lockable;
    ...
    .line 679
    :try_start_0
    invoke-virtual {v9, v8}, Lokhttp3/internal/http2/Http2Connection;->getStream(I)Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 683
    invoke-static {v9}, Lokhttp3/internal/http2/Http2Connection;->access$isShutdown$p(Lokhttp3/internal/http2/Http2Connection;)Z
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v9}, Lokhttp3/internal/http2/Http2Connection;->getLastGoodStreamId$okhttp()I
    ...
    invoke-virtual {v9}, Lokhttp3/internal/http2/Http2Connection;->getNextStreamId$okhttp()I
    ...
    .line 693
    new-instance v11, Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 694
    invoke-virtual {v9, v8}, Lokhttp3/internal/http2/Http2Connection;->setLastGoodStreamId$okhttp(I)V

    .line 695
    invoke-virtual {v9}, Lokhttp3/internal/http2/Http2Connection;->getStreams$okhttp()Ljava/util/Map;
    ...
    .line 698
    invoke-static {v9}, Lokhttp3/internal/http2/Http2Connection;->access$getTaskRunner$p(Lokhttp3/internal/http2/Http2Connection;)Lokhttp3/internal/concurrent/TaskRunner;
    ...
    invoke-virtual {v9}, Lokhttp3/internal/http2/Http2Connection;->getConnectionName$okhttp()Ljava/lang/String;
    ...
    new-instance v0, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable$$ExternalSyntheticLambda1;

    invoke-direct {v0, v9, v11}, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable$$ExternalSyntheticLambda1;-><init>(Lokhttp3/internal/http2/Http2Connection;Lokhttp3/internal/http2/Http2Stream;)V
    ...
    invoke-virtual {v3, v2, v0}, Lokhttp3/internal/http2/Http2Stream;->receiveHeaders(Lokhttp3/Headers;Z)V
